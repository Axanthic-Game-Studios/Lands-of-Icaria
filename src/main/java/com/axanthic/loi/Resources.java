...
public class Resources {
	...
	public static ItemBlockMeta adobe = new ItemBlockMetaMaterial(new BlockRockAdobe("adobe"));
	...
	public static ToolSet vanadiumsteel = new ToolSet(new CompleteToolMaterial("vanadiumsteel", -1.0F, 3, 424, 4.0F, 3.0F, 11, new ItemStack(Resources.ingot, 1, 5)));
	public static ToolSet sideros = new ToolSet(new CompleteToolMaterial("sideros", -1.1F, 4, 528, 7.0F, 2.5F, 14, new ItemStack(Resources.ingot, 1, 6)));
	public static ToolSet molybdenumsteel = new ToolSet(new CompleteToolMaterial("molybdenumsteel", -1.2F, 5, 673, 7.5F, 2.0F, 12, new ItemStack(Resources.ingot, 1, 8)));
	...
	public static StairSlabPair yellowstoneAdobe = new StairSlabPair(adobe, 0, "yellowstone_adobe", true);
	public static StairSlabPair silkstoneAdobe = new StairSlabPair(adobe, 1, "silkstone_adobe", true);
	public static StairSlabPair sunstoneAdobe = new StairSlabPair(adobe, 2, "sunstone_adobe", true);
	public static StairSlabPair voidshaleAdobe = new StairSlabPair(adobe, 3, "voidshale_adobe", true);
	public static StairSlabPair baetylAdobe = new StairSlabPair(adobe, 4, "baetyl_adobe", true);
	public static StairSlabPair grainelAdobe = new StairSlabPair(adobe, 5, "grainel_adobe", true);
	public static StairSlabPair marlAdobe = new StairSlabPair(adobe, 6, "marl_adobe", true);
	public static StairSlabPair dolomiteAdobe = new StairSlabPair(adobe, 7, "dolomite_adobe", true);
	...
	public static void registerBlocks() {
		...
		Resources.registerBlock(Resources.adobe);
		...
		Resources.yellowstoneAdobe.register();
		Resources.silkstoneAdobe.register();
		Resources.sunstoneAdobe.register();
		Resources.voidshaleAdobe.register();
		Resources.baetylAdobe.register();
		Resources.grainelAdobe.register();
		Resources.marlAdobe.register();
		Resources.dolomiteAdobe.register();
	...
	public static class WoodSet {
		...
		public ItemBlockMaterial stumpLog;
		public ItemBlockMaterial strippedStumpLog;
		...
		public WoodSet(final BlockPlanks.WoodTypes type, WorldGenLOITree generator, Class forestHag) {
			this.type = type;
			this.strippedStumpLog = new ItemBlockMaterial(new BlockLogStump(type, type.mapColor, null));
			this.stumpLog = new ItemBlockMaterial(new BlockLogStump(type, type.logColor, strippedStumpLog));
		...
		public void register() {
			...
			Resources.registerBlock(stumpLog);
			Resources.registerBlock(strippedStumpLog);
