...
public class CellNoise
{
	...
	private double getDistance(final double xDist, final double yDist, final double zDist)
	{
		...
		{
		case 0:
			return Math.sqrt((xDist * xDist) + (yDist * yDist) + (zDist * zDist)) / CellNoise.SQRT_3; //Approximation (for speed) of elucidean (regular) distance
		case 1:
