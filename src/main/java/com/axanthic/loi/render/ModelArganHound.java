...
public class ModelArganHound extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		this.muscle_front_right.rotateAngleX = -MathHelper.cos(limbSwing * 0.5F) * 0.6F * limbSwingAmount + 0.091106186954104F;
		this.muscle_front_left.rotateAngleX = -MathHelper.cos(limbSwing * 0.5F + (float) Math.PI) * 0.6F * limbSwingAmount + 0.091106186954104F;
		this.muscle_rear_right.rotateAngleX = MathHelper.cos(limbSwing * 0.5F + (float) Math.PI * 1.5F) * 1.2F * limbSwingAmount - 0.091106186954104F;
		this.muscle_rear_left.rotateAngleX = MathHelper.cos(limbSwing * 0.5F + (float) Math.PI * 0.5F) * 1.2F * limbSwingAmount - 0.091106186954104F;

		this.leg_front_right.rotateAngleX = MathHelper.sin((limbSwing + MathHelper.sin(limbSwing)) * 0.5F) * kneebend * limbSwingAmount - kneebend * limbSwingAmount - 0.36425021489121656F;
		this.leg_front_left.rotateAngleX = MathHelper.sin((limbSwing + MathHelper.sin(limbSwing + (float) Math.PI * 0.5F)) * 0.5F + (float) Math.PI) * kneebend * limbSwingAmount - kneebend * limbSwingAmount - 0.36425021489121656F;
		this.leg_rear_right.rotateAngleX = MathHelper.sin((limbSwing + MathHelper.sin(limbSwing + (float) Math.PI * 0.75F)) * 0.5F + (float) Math.PI * 1.5F) * kneebend * limbSwingAmount + kneebend * limbSwingAmount + 0.27314402793711257F;
		this.leg_rear_left.rotateAngleX = MathHelper.sin((limbSwing + MathHelper.sin(limbSwing + (float) Math.PI * 0.25F)) * 0.5F + (float) Math.PI * 0.5F) * kneebend * limbSwingAmount + kneebend * limbSwingAmount + 0.27314402793711257F;
	}
}