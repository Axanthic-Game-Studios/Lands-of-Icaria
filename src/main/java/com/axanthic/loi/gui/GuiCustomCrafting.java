...
public class GuiCustomCrafting extends GuiContainer implements IRecipeShownListener {
	private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation(ModInformation.ID, "textures/gui/crafting_table_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		this.fontRenderer.drawString(I18n.format("container.crafting"), 28, 6, 0x504537);
		this.fontRenderer.drawString(I18n.format("container.inventory"), 8, this.ySize - 96 + 2, 0x504537);
	}
