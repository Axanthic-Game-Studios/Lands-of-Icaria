...
public class GuiInventoryKiln extends GuiContainer {

	private static final ResourceLocation texture = new ResourceLocation(ModInformation.ID, "textures/gui/crafting_kiln_gui.png");
	private final InventoryPlayer playerInventory;
	private TileEntityKiln tileEntity;

	public GuiInventoryKiln(InventoryPlayer invPlayer, TileEntityKiln tile) {
