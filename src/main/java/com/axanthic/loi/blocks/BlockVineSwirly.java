...
public class BlockVineSwirly extends BlockVine
{
    public BlockVineSwirly(String name)
    {
        ...
        if(!worldIn.isRemote)
        {
            if(rand.nextInt(4) == 0 && worldIn.isAreaLoaded(pos, 4))
            {
                ...
                if(rand.nextBoolean())
                {
                    ...
                    {
                        worldIn.setBlockState(pos.down(), LOIVines.vineSwirlyGrowing.getDefaultState()
