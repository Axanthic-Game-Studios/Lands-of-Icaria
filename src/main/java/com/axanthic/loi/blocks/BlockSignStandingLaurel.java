...
public class BlockSignStandingLaurel extends BlockSign
{
    public static final PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);

    public BlockSignStandingLaurel()
    {
        this.setRegistryName("sign_standing_laurel");
    ...
    {
        return new TESignLaurel();
    }

    public ItemStack getItem(World world, BlockPos pos, IBlockState state)
    {
        return new ItemStack(Resources.signLaurel);
    }

    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return Resources.signLaurel;
    }
}