...
public class BlockCustomLadder extends BlockLadder implements IBlockMaterial{

	public String name;
	public Block modelBlock;
	public IBlockState modelState;

	public BlockCustomLadder(IBlockState modelState, String name) {
		super();
		this.name = name;
		...
		if (modelState instanceof IBlockMaterial)
			this.setRegistryName(ModInformation.ID, "ladder_" + modelState.getBlock().getRegistryName().getResourcePath() + "_" + ((IBlockMaterial) modelBlock).getName());
		else if (modelBlock instanceof IBlockMeta)
			this.setRegistryName(ModInformation.ID, "ladder_" + modelState.getBlock().getRegistryName().getResourcePath() + "_" + ((IBlockMeta) modelBlock).getNameForMeta(modelBlock.getMetaFromState(modelState)));
		else
			this.setRegistryName(ModInformation.ID, "ladder_" + modelState.getBlock().getRegistryName().getResourcePath());
	}
