...
public class BiomeForest extends BiomeLOI {
	...
	public BiomeForest() {
		...
		spawnableCreatureList.add(new Biome.SpawnListEntry(EntityForestHagFir.class, 5, 1, 1));
		spawnableCreatureList.add(new Biome.SpawnListEntry(EntityForestHagPopulus.class, 5, 1, 1));
