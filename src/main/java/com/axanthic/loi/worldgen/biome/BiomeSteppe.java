...
public class BiomeSteppe extends BiomeLOI {
	...
	public BiomeSteppe() {
		...
		spawnableCreatureList.add(new Biome.SpawnListEntry(EntityForestHagCypress.class, 5, 1, 1));
		spawnableCreatureList.add(new Biome.SpawnListEntry(EntityForestHagOlive.class, 5, 1, 1));
