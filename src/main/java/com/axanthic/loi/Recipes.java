...
public class Recipes {
	...
	public static void registerRecipes() {
		...
		addKettleRecipe("healing", new ItemStack(Resources.healSpell.spellItem), new ItemStack(Resources.healSpell.concoction), 0xCE4A4A, new ItemStack(Resources.herb, 1, 1), new ItemStack(Resources.herb, 1, 2), new ItemStack(Resources.food, 1, ItemFoods.FoodType.LAUREL_CHERRY.toMeta()));
		addKettleRecipe("anti_gravity", new ItemStack(Resources.antiGravitySpell.spellItem), new ItemStack(Resources.antiGravitySpell.concoction), 0x1062A7, new ItemStack(Resources.ingot, 1, 2), new ItemStack(Resources.herb, 1, 5), new ItemStack(Resources.herb, 1, 1), new ItemStack(Resources.food, 1, ItemFoods.FoodType.LAUREL_CHERRY.toMeta()));
		addKettleRecipe("freezing", new ItemStack(Resources.freezingSpell.spellItem), null, 0xD7D7D7, new ItemStack(Resources.herb, 1, 7), new ItemStack(Resources.herb, 1, 7), new ItemStack(Resources.resource, 1, ItemResources.ResourceType.REMAINS.toMeta()));
		addKettleRecipe("magic_missile", new ItemStack(Resources.magicMissileSpell.spellItem), null, 0x8F50D9, new ItemStack(Resources.ingot, 1, 2), new ItemStack(Resources.herb, 1, 5), new ItemStack(Resources.herb, 1, 4), new ItemStack(Resources.resource, 1, ItemResources.ResourceType.REMAINS.toMeta()), new ItemStack(Resources.resource, 1, ItemResources.ResourceType.REMAINS.toMeta()));
		addKettleRecipe("bubble", new ItemStack(Resources.bubbleSpell.spellItem), null, 0x0094FF, new ItemStack(Resources.herb, 1, 5), new ItemStack(Resources.herb, 1, 3), new ItemStack(Resources.herb, 1, 6), new ItemStack(Resources.herb, 1, 8));
