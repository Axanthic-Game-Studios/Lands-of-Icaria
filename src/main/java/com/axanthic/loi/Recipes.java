...
public class Recipes {
	...
	public static void registerRecipes() {
		...
		GameRegistry.addSmelting(new ItemStack(Resources.food, 1, 7), new ItemStack(Resources.food, 1, 8), 0.35F);
		GameRegistry.addSmelting(new ItemStack(Resources.food, 1, 9), new ItemStack(Resources.food, 1, 10), 0.35F);
		...
		addShapelessRecipe(new ItemStack(Resources.seedsStrawberry, 1), "seed_strawberry", new Ingredient[]{Ingredient.fromStacks(new ItemStack(Resources.food, 1, 5))});
