...
public class ModelRevenantSoldier extends ModelRevenantCivilian {
	...
	public ModelRevenantSoldier() {
		...
		this.arm_right_armor.setRotationPoint(-0.1F, 7.0F, 0.4F);
		this.arm_right_armor.addBox(-2.0F, -1.0F, -2.0F, 3, 5, 3, 0.0F);
		this.setRotateAngle(arm_right_armor, -0.13962634015954636F, 0.8377580409572781F, -0.20943951023931953F);
		...
		this.arm_left_armor.setRotationPoint(0.1F, 7.0F, -0.4F);
		this.arm_left_armor.addBox(-1.6F, -1.0F, -0.4F, 3, 5, 3, 0.0F);
		this.setRotateAngle(arm_left_armor, -0.13962634015954636F, 0.7330382858376184F, 0.0F);
		...
		this.helmet_brushbase.addBox(-1.0F, -1.0F, -3.0F, 2, 6, 9, 0.0F);
		...
		this.brush.addBox(-1.0F, -3.0F, -6.0F, 1, 7, 10, 0.0F);
		...
		this.arm_right.addChild(this.arm_right_armor);
		...
		this.arm_left.addChild(this.arm_left_armor);
