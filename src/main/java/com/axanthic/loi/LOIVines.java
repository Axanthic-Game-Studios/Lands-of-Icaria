...
public class LOIVines
{
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event)
    {
        ...
        event.getRegistry().register(vineBloomyBerry);
        ...
        event.getRegistry().register(vineBrushySprout);
    ...
    public static void registerItemBlocks(RegistryEvent.Register<Item> event)
    {
        ...
        event.getRegistry().registerAll(new ItemBlock(vineBloomyBerry).setRegistryName(Objects.requireNonNull(vineBloomyBerry.getRegistryName())));
        ...
        event.getRegistry().registerAll(new ItemBlock(vineBrushySprout).setRegistryName(Objects.requireNonNull(vineBrushySprout.getRegistryName())));
    ...
    public static void registerRenders(ModelRegistryEvent event)
    {
        ...
        registerRender(Item.getItemFromBlock(vineBloomyBerry));
        ...
        registerRender(Item.getItemFromBlock(vineBrushySprout));
