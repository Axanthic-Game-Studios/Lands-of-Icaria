...
public class TESRSignFir extends TileEntitySpecialRenderer<TESignFir>
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModInformation.ID, "textures/blocks/wood_fir_sign.png");

    public static final ModelSign model = new ModelSign();

    @Override
    public void render(TESignFir tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == LOISigns.signStandingFir)
        {
