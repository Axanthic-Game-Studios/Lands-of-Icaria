...
public class TESRSignCypress extends TileEntitySpecialRenderer<TESignCypress>
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModInformation.ID, "textures/blocks/wood_cypress_sign.png");

    public static final ModelSign model = new ModelSign();

    @Override
    public void render(TESignCypress tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == LOISigns.signStandingCypress)
        {
