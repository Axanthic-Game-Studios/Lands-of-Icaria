...
public class TESRSignLaurel extends TileEntitySpecialRenderer<TESignLaurel>
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModInformation.ID, "textures/blocks/wood_laurel_sign.png");

    public static final ModelSign model = new ModelSign();

    @Override
    public void render(TESignLaurel tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == LOISigns.signStandingLaurel)
        {
