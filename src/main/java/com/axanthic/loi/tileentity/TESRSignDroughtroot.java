...
public class TESRSignDroughtroot extends TileEntitySpecialRenderer<TESignDroughtroot>
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModInformation.ID, "textures/blocks/wood_droughtroot_sign.png");

    public static final ModelSign model = new ModelSign();

    @Override
    public void render(TESignDroughtroot tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == LOISigns.signStandingDroughtroot)
        {
