...
public class TESRSignPlane extends TileEntitySpecialRenderer<TESignPlane>
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModInformation.ID, "textures/blocks/wood_plane_sign.png");

    public static final ModelSign model = new ModelSign();

    @Override
    public void render(TESignPlane tileEntity, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (block == LOISigns.signStandingPlane)
        {
