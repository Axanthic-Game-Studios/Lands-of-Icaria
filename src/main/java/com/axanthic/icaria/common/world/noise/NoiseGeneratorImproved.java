...
public class NoiseGeneratorImproved extends NoiseGenerator {
	...
	public void populateNoiseArray(final double[] noiseArray, final double xOffset, final double yOffset,
			final double zOffset, final int xSize, final int ySize, final int zSize, final double xScale,
			final double yScale, final double zScale, final double noiseScale) {
		if (ySize == 1) {
			int i5 = 0;
			int j5 = 0;
			int j = 0;
