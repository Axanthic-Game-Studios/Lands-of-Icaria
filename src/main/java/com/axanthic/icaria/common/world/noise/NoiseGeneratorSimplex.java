	...
	public void func_151606_a(final double[] p_151606_1_, final double p_151606_2_, final double p_151606_4_,
		...
		for (int j = 0; j < p_151606_7_; ++j) {
			...
			for (int k = 0; k < p_151606_6_; ++k) {
				final double d1 = (p_151606_2_ + k) * p_151606_8_ + this.field_151612_b;
				final double d5 = (d1 + d0) * field_151609_g;
				final int l = func_151607_a(d1 + d5);
				final int i1 = func_151607_a(d0 + d5);
				final double d6 = (l + i1) * field_151615_h;
				final double d7 = l - d6;
				final double d8 = i1 - d6;
				...
				final double d11 = d9 - j1 + field_151615_h;
				final double d12 = d10 - k1 + field_151615_h;
