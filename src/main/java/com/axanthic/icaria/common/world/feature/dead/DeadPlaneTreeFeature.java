...
public class DeadPlaneTreeFeature extends IcariaDeadTreeFeature {
	public DeadPlaneTreeFeature(Codec<NoneFeatureConfiguration> pCodec) {
		super(pCodec, IcariaBlocks.DEAD_PLANE_LOG.get(), IcariaBlocks.PLANE_LOG.get(), IcariaBlocks.SCRUBLAND_MOSS.get(), IcariaBlocks.TURKEY_TAIL_TREE_SHROOMS.get(), IcariaBlocks.PLANE_TWIGS.get(), Moss.SCRUBLAND);
	}
}
