...
public class DeadIcariaTreeFeature extends Feature<NoneFeatureConfiguration> {
	public int min;
	public int max;
	...
	public DeadIcariaTreeFeature(Codec<NoneFeatureConfiguration> pCodec, Block pDead, Block pLog, Block pMoss, Block pShrooms, Block pTwigs, Moss pProperty, int pMin, int pMax) {
		super(pCodec);
		this.dead = pDead;
		this.log = pLog;
		this.moss = pMoss;
