...
public class GrainiteSpikeFeature extends Feature<NoneFeatureConfiguration> {
	...
	public void placeUpperRing(WorldGenLevel pWorldGenLevel, BlockPos pBlockPos, int pX, int pY, int pZ, int pChanceSouthWest, int pChanceNorthEast) {
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pX).above(pY).east(pZ + 1), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ).above(pY).east(pZ + 1), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 1).above(pY).east(pX), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 1).above(pY).east(pZ), pChanceSouthWest);
	}

	public void placeInnerRing(WorldGenLevel pWorldGenLevel, BlockPos pBlockPos, int pX, int pY, int pZ, int pChanceSouthWest, int pChanceNorthEast) {
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pX).above(pY).east(pZ + 1), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pX).above(pY).east(pZ + 2), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ).above(pY).east(pZ + 1), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ).above(pY).east(pZ + 1), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 1).above(pY).east(pX), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 1).above(pY).east(pX), pChanceNorthEast);
	...
	public void placeLowerRing(WorldGenLevel pWorldGenLevel, BlockPos pBlockPos, int pX, int pY, int pZ, int pChanceSouthWest, int pChanceNorthEast) {
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pX).above(pY).east(pZ + 1), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pX).above(pY).east(pZ + 2), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pX).above(pY).east(pZ + 3), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ).above(pY).east(pZ + 1), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ).above(pY).east(pZ + 2), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ).above(pY).east(pZ + 3), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 1).above(pY).east(pX), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 2).above(pY).east(pX), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 3).above(pY).east(pX), pChanceNorthEast);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 1).above(pY).east(pZ), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 2).above(pY).east(pZ), pChanceSouthWest);
		this.placeGrainite(pWorldGenLevel, pBlockPos.below().north(pZ + 3).above(pY).east(pZ), pChanceSouthWest);
	}

	public void placeGrainite(WorldGenLevel pWorldGenLevel, BlockPos pBlockPos, int pChance) {
		if (pWorldGenLevel.getRandom().nextInt(pChance) == 0) {
			this.placeGrainite(pWorldGenLevel, pBlockPos);
		}
	}

	public void placeGrainite(WorldGenLevel pWorldGenLevel, BlockPos pBlockPos) {
		if (pWorldGenLevel.getBlockState(pBlockPos).isAir()) {
			this.setBlock(pWorldGenLevel, pBlockPos, IcariaBlocks.GRAINITE.get().defaultBlockState());
		}
	}
}
