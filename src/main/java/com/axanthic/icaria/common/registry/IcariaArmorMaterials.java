...
public class IcariaArmorMaterials extends ArmorMaterials {
	...
	}), 15, SoundEvents.ARMOR_EQUIP_LEATHER, Ingredient::of, List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(IcariaInfo.ID, "laurel"))), 0.0F, 0.0F));
	...
	}), 15, SoundEvents.ARMOR_EQUIP_LEATHER, () -> Ingredient.of(IcariaItems.AETERNAE_HIDE.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(IcariaInfo.ID, "aeternae_hide"))), 0.0F, 0.0F));
	...
	}), 15, SoundEvents.ARMOR_EQUIP_GENERIC, () -> Ingredient.of(IcariaItems.CHALKOS_INGOT.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(IcariaInfo.ID, "chalkos"))), 0.0F, 0.0F));
	...
	}), 15, SoundEvents.ARMOR_EQUIP_GENERIC, () -> Ingredient.of(IcariaItems.KASSITEROS_INGOT.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(IcariaInfo.ID, "kassiteros"))), 0.0F, 0.0F));
	...
	}), 19, SoundEvents.ARMOR_EQUIP_GENERIC, () -> Ingredient.of(IcariaItems.ORICHALCUM_INGOT.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(IcariaInfo.ID, "orichalcum"))), 1.0F, 0.0F));
	...
	}), 11, SoundEvents.ARMOR_EQUIP_GENERIC, () -> Ingredient.of(IcariaItems.VANADIUMSTEEL_INGOT.get()), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(IcariaInfo.ID, "vanadiumsteel"))), 1.5F, 0.0F));
}
