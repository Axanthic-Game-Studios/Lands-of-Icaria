...
public class IcariaSoundTypes {
	...
	public static final SoundType POTTERY = new DeferredSoundType(1.0F, 1.0F, () -> IcariaSoundEvents.POTTERY_BREAK, () -> SoundEvents.GLASS_STEP, () -> SoundEvents.GLASS_PLACE, () -> SoundEvents.GLASS_HIT, () -> SoundEvents.GLASS_FALL);
}
