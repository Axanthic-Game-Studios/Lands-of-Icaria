...
public class IcariaLevelStems {
    ...
    public static Pair<Climate.ParameterPoint, Holder<Biome>> aridDesertParameters(HolderGetter<Biome> pBiomes) {
        return new Pair<>(new Climate.ParameterPoint(IcariaLevelStems.VERY_WARM, IcariaLevelStems.ZERO, IcariaLevelStems.LAND, IcariaLevelStems.ZERO, IcariaLevelStems.LUSH, IcariaLevelStems.ZERO, 0L), pBiomes.getOrThrow(IcariaBiomes.ARID_DESERT));
    }
