...
public class IcariaRecipeSerializers {
	...
	public static final RegistryObject<RecipeSerializer<GrindingRecipe>> GRINDING_RECIPE = IcariaRecipeSerializers.RECIPE_SERIALIZERS.register("grinding", () -> GrindingRecipe.Serializer.INSTANCE);
}
