...
public class IcariaStructures {
	...
	public static ResourceKey<Structure> registerKey(String pName) {
		return ResourceKey.create(Registries.STRUCTURE, new ResourceLocation(IcariaInfo.ID, pName));
	}
}
