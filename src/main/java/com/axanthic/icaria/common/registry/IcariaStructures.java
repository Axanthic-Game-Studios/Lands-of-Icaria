...
public class IcariaStructures {
	public static final ResourceKey<Structure> FOREST_ERODED = IcariaStructures.createKey("villages/forest/eroded");
	public static final ResourceKey<Structure> FOREST_PRISTINE = IcariaStructures.createKey("villages/forest/pristine");
	public static final ResourceKey<Structure> FOREST_RUINED = IcariaStructures.createKey("villages/forest/ruined");

	public static final ResourceKey<Structure> SCRUBLAND_ERODED = IcariaStructures.createKey("villages/scrubland/eroded");
	public static final ResourceKey<Structure> SCRUBLAND_PRISTINE = IcariaStructures.createKey("villages/scrubland/pristine");
	public static final ResourceKey<Structure> SCRUBLAND_RUINED = IcariaStructures.createKey("villages/scrubland/ruined");

	public static final ResourceKey<Structure> STEPPE_ERODED = IcariaStructures.createKey("villages/steppe/eroded");
	public static final ResourceKey<Structure> STEPPE_PRISTINE = IcariaStructures.createKey("villages/steppe/pristine");
	public static final ResourceKey<Structure> STEPPE_RUINED = IcariaStructures.createKey("villages/steppe/ruined");

	public static final ResourceKey<Structure> DESERT_ERODED = IcariaStructures.createKey("villages/desert/eroded");
	public static final ResourceKey<Structure> DESERT_PRISTINE = IcariaStructures.createKey("villages/desert/pristine");
	public static final ResourceKey<Structure> DESERT_RUINED = IcariaStructures.createKey("villages/desert/ruined");
