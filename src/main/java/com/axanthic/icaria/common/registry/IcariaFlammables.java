...
public class IcariaFlammables {
	...
	public static void setup() {
		...
		IcariaFlammables.set(IcariaBlocks.GRAY_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.BLACK_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.BROWN_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.RED_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.ORANGE_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.YELLOW_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.LIME_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.GREEN_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.CYAN_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.LIGHT_BLUE_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.BLUE_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.PURPLE_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.MAGENTA_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.PINK_ARACHNE_STRING_BLOCK.get(), 30, 60);
		IcariaFlammables.set(IcariaBlocks.ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.WHITE_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.LIGHT_GRAY_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.GRAY_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.BLACK_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.BROWN_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.RED_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.ORANGE_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.YELLOW_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.LIME_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.GREEN_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.CYAN_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.LIGHT_BLUE_ARACHNE_STRING_CARPET.get(), 60, 20);
		IcariaFlammables.set(IcariaBlocks.BLUE_ARACHNE_STRING_CARPET.get(), 60, 20);
		...
		IcariaFlammables.set(IcariaBlocks.CYPRESS_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.CYPRESS_SHELF.get(), 30, 20);
		...
		IcariaFlammables.set(IcariaBlocks.DROUGHTROOT_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.DROUGHTROOT_SHELF.get(), 30, 20);
		...
		IcariaFlammables.set(IcariaBlocks.FIR_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.FIR_SHELF.get(), 30, 20);
		...
		IcariaFlammables.set(IcariaBlocks.LAUREL_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.LAUREL_SHELF.get(), 30, 20);
		...
		IcariaFlammables.set(IcariaBlocks.OLIVE_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.OLIVE_SHELF.get(), 30, 20);
		...
		IcariaFlammables.set(IcariaBlocks.PLANE_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.PLANE_SHELF.get(), 30, 20);
		...
		IcariaFlammables.set(IcariaBlocks.POPULUS_SCROLLSHELF.get(), 30, 20);
		IcariaFlammables.set(IcariaBlocks.POPULUS_SHELF.get(), 30, 20);
