...
public class IcariaFlammables {
	...
	public static void setup() {
		...
		flammableBlock(IcariaBlocks.DEAD_BLOOMY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_BLOOMY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.BLOOMY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.BLOOMING_BLOOMY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.RIPE_BLOOMY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DEAD_BRANCHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_BRANCHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.BRANCHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DEAD_BRUSHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_BRUSHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.RIPE_BRUSHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.BRUSHY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DEAD_DRY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_DRY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DRY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DEAD_REEDY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_REEDY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.REEDY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DEAD_SWIRLY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_SWIRLY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.SWIRLY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.DEAD_THORNY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.GROWING_THORNY_VINE.get(), 15, 100);
		flammableBlock(IcariaBlocks.THORNY_VINE.get(), 15, 100);
