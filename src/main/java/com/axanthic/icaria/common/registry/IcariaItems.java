...
public class IcariaItems {
	...
	public static final Supplier<Item> ARACHNE_STRING_BLOCK = IcariaItems.register("arachne_string_block", () -> new FuelBlockItem(IcariaBlocks.ARACHNE_STRING_BLOCK.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> LIGNITE_BLOCK = IcariaItems.register("lignite_block", () -> new FuelBlockItem(IcariaBlocks.LIGNITE_BLOCK.get(), IcariaItems.propertiesItem(), 7200));
	...
	public static final Supplier<Item> ANTHRACITE_BLOCK = IcariaItems.register("anthracite_block", () -> new FuelBlockItem(IcariaBlocks.ANTHRACITE_BLOCK.get(), IcariaItems.propertiesItem(), 28800));
	...
	public static final Supplier<Item> CYPRESS_SAPLING = IcariaItems.register("cypress_sapling", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> CYPRESS_TWIGS = IcariaItems.register("cypress_twigs", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> CYPRESS_WOOD = IcariaItems.register("cypress_wood", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_CYPRESS_WOOD = IcariaItems.register("stripped_cypress_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_CYPRESS_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> CYPRESS_LOG = IcariaItems.register("cypress_log", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_CYPRESS_LOG = IcariaItems.register("stripped_cypress_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_CYPRESS_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_CYPRESS_LOG = IcariaItems.register("dead_cypress_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_CYPRESS_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_CYPRESS_LOG = IcariaItems.register("stripped_dead_cypress_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_CYPRESS_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> CYPRESS_PLANKS = IcariaItems.register("cypress_planks", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> CYPRESS_CRAFTING_TABLE = IcariaItems.register("cypress_crafting_table", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> CYPRESS_LADDER = IcariaItems.registerSimple("cypress_ladder", () -> new FuelBlockItem(IcariaBlocks.CYPRESS_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> DROUGHTROOT_SAPLING = IcariaItems.register("droughtroot_sapling", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> DROUGHTROOT_TWIGS = IcariaItems.register("droughtroot_twigs", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> DROUGHTROOT_WOOD = IcariaItems.register("droughtroot_wood", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_DROUGHTROOT_WOOD = IcariaItems.register("stripped_droughtroot_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DROUGHTROOT_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DROUGHTROOT_LOG = IcariaItems.register("droughtroot_log", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_DROUGHTROOT_LOG = IcariaItems.register("stripped_droughtroot_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DROUGHTROOT_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_DROUGHTROOT_LOG = IcariaItems.register("dead_droughtroot_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_DROUGHTROOT_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_DROUGHTROOT_LOG = IcariaItems.register("stripped_dead_droughtroot_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_DROUGHTROOT_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> DROUGHTROOT_PLANKS = IcariaItems.register("droughtroot_planks", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> DROUGHTROOT_CRAFTING_TABLE = IcariaItems.register("droughtroot_crafting_table", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> DROUGHTROOT_LADDER = IcariaItems.registerSimple("droughtroot_ladder", () -> new FuelBlockItem(IcariaBlocks.DROUGHTROOT_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> FIR_SAPLING = IcariaItems.register("fir_sapling", () -> new FuelBlockItem(IcariaBlocks.FIR_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> FIR_TWIGS = IcariaItems.register("fir_twigs", () -> new FuelBlockItem(IcariaBlocks.FIR_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> FIR_WOOD = IcariaItems.register("fir_wood", () -> new FuelBlockItem(IcariaBlocks.FIR_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_FIR_WOOD = IcariaItems.register("stripped_fir_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_FIR_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> FIR_LOG = IcariaItems.register("fir_log", () -> new FuelBlockItem(IcariaBlocks.FIR_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_FIR_LOG = IcariaItems.register("stripped_fir_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_FIR_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_FIR_LOG = IcariaItems.register("dead_fir_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_FIR_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_FIR_LOG = IcariaItems.register("stripped_dead_fir_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_FIR_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> FIR_PLANKS = IcariaItems.register("fir_planks", () -> new FuelBlockItem(IcariaBlocks.FIR_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> FIR_CRAFTING_TABLE = IcariaItems.register("fir_crafting_table", () -> new FuelBlockItem(IcariaBlocks.FIR_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> FIR_LADDER = IcariaItems.registerSimple("fir_ladder", () -> new FuelBlockItem(IcariaBlocks.FIR_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> LAUREL_SAPLING = IcariaItems.register("laurel_sapling", () -> new FuelBlockItem(IcariaBlocks.LAUREL_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> LAUREL_TWIGS = IcariaItems.register("laurel_twigs", () -> new FuelBlockItem(IcariaBlocks.LAUREL_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> LAUREL_WOOD = IcariaItems.register("laurel_wood", () -> new FuelBlockItem(IcariaBlocks.LAUREL_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_LAUREL_WOOD = IcariaItems.register("stripped_laurel_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_LAUREL_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> LAUREL_LOG = IcariaItems.register("laurel_log", () -> new FuelBlockItem(IcariaBlocks.LAUREL_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_LAUREL_LOG = IcariaItems.register("stripped_laurel_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_LAUREL_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_LAUREL_LOG = IcariaItems.register("dead_laurel_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_LAUREL_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_LAUREL_LOG = IcariaItems.register("stripped_dead_laurel_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_LAUREL_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> LAUREL_PLANKS = IcariaItems.register("laurel_planks", () -> new FuelBlockItem(IcariaBlocks.LAUREL_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> LAUREL_CRAFTING_TABLE = IcariaItems.register("laurel_crafting_table", () -> new FuelBlockItem(IcariaBlocks.LAUREL_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> LAUREL_LADDER = IcariaItems.registerSimple("laurel_ladder", () -> new FuelBlockItem(IcariaBlocks.LAUREL_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> OLIVE_SAPLING = IcariaItems.register("olive_sapling", () -> new FuelBlockItem(IcariaBlocks.OLIVE_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> OLIVE_TWIGS = IcariaItems.register("olive_twigs", () -> new FuelBlockItem(IcariaBlocks.OLIVE_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> OLIVE_WOOD = IcariaItems.register("olive_wood", () -> new FuelBlockItem(IcariaBlocks.OLIVE_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_OLIVE_WOOD = IcariaItems.register("stripped_olive_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_OLIVE_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> OLIVE_LOG = IcariaItems.register("olive_log", () -> new FuelBlockItem(IcariaBlocks.OLIVE_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_OLIVE_LOG = IcariaItems.register("stripped_olive_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_OLIVE_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_OLIVE_LOG = IcariaItems.register("dead_olive_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_OLIVE_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_OLIVE_LOG = IcariaItems.register("stripped_dead_olive_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_OLIVE_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> OLIVE_PLANKS = IcariaItems.register("olive_planks", () -> new FuelBlockItem(IcariaBlocks.OLIVE_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> OLIVE_CRAFTING_TABLE = IcariaItems.register("olive_crafting_table", () -> new FuelBlockItem(IcariaBlocks.OLIVE_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> OLIVE_LADDER = IcariaItems.registerSimple("olive_ladder", () -> new FuelBlockItem(IcariaBlocks.OLIVE_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> PLANE_SAPLING = IcariaItems.register("plane_sapling", () -> new FuelBlockItem(IcariaBlocks.PLANE_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> PLANE_TWIGS = IcariaItems.register("plane_twigs", () -> new FuelBlockItem(IcariaBlocks.PLANE_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> PLANE_WOOD = IcariaItems.register("plane_wood", () -> new FuelBlockItem(IcariaBlocks.PLANE_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_PLANE_WOOD = IcariaItems.register("stripped_plane_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_PLANE_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> PLANE_LOG = IcariaItems.register("plane_log", () -> new FuelBlockItem(IcariaBlocks.PLANE_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_PLANE_LOG = IcariaItems.register("stripped_plane_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_PLANE_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_PLANE_LOG = IcariaItems.register("dead_plane_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_PLANE_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_PLANE_LOG = IcariaItems.register("stripped_dead_plane_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_PLANE_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> PLANE_PLANKS = IcariaItems.register("plane_planks", () -> new FuelBlockItem(IcariaBlocks.PLANE_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> PLANE_CRAFTING_TABLE = IcariaItems.register("plane_crafting_table", () -> new FuelBlockItem(IcariaBlocks.PLANE_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> PLANE_LADDER = IcariaItems.registerSimple("plane_ladder", () -> new FuelBlockItem(IcariaBlocks.PLANE_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> POPULUS_SAPLING = IcariaItems.register("populus_sapling", () -> new FuelBlockItem(IcariaBlocks.POPULUS_SAPLING.get(), IcariaItems.propertiesItem(), 100));
	...
	public static final Supplier<Item> POPULUS_TWIGS = IcariaItems.register("populus_twigs", () -> new FuelBlockItem(IcariaBlocks.POPULUS_TWIGS.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> POPULUS_WOOD = IcariaItems.register("populus_wood", () -> new FuelBlockItem(IcariaBlocks.POPULUS_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_POPULUS_WOOD = IcariaItems.register("stripped_populus_wood", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_POPULUS_WOOD.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> POPULUS_LOG = IcariaItems.register("populus_log", () -> new FuelBlockItem(IcariaBlocks.POPULUS_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> STRIPPED_POPULUS_LOG = IcariaItems.register("stripped_populus_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_POPULUS_LOG.get(), IcariaItems.propertiesItem(), 300));
	public static final Supplier<Item> DEAD_POPULUS_LOG = IcariaItems.register("dead_populus_log", () -> new FuelBlockItem(IcariaBlocks.DEAD_POPULUS_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> STRIPPED_DEAD_POPULUS_LOG = IcariaItems.register("stripped_dead_populus_log", () -> new FuelBlockItem(IcariaBlocks.STRIPPED_DEAD_POPULUS_LOG.get(), IcariaItems.propertiesItem(), 100));
	public static final Supplier<Item> POPULUS_PLANKS = IcariaItems.register("populus_planks", () -> new FuelBlockItem(IcariaBlocks.POPULUS_PLANKS.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> POPULUS_CRAFTING_TABLE = IcariaItems.register("populus_crafting_table", () -> new FuelBlockItem(IcariaBlocks.POPULUS_CRAFTING_TABLE.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> POPULUS_LADDER = IcariaItems.registerSimple("populus_ladder", () -> new FuelBlockItem(IcariaBlocks.POPULUS_LADDER.get(), IcariaItems.propertiesItem(), 300));
	...
	public static final Supplier<Item> LIGNITE = IcariaItems.registerSimple("lignite", () -> new FuelItem(IcariaItems.propertiesItem(), 800));
	...
	public static final Supplier<Item> ANTHRACITE = IcariaItems.registerSimple("anthracite", () -> new FuelItem(IcariaItems.propertiesItem(), 3200));
	...
	public static final Supplier<Item> ORICHALCUM_HELMET = IcariaItems.registerSimple("orichalcum_helmet", () -> new OrichalcumHelmetItem(IcariaArmorMaterials.ORICHALCUM, ArmorItem.Type.HELMET, IcariaItems.propertiesItem()));
	public static final Supplier<Item> ORICHALCUM_CHESTPLATE = IcariaItems.registerSimple("orichalcum_chestplate", () -> new ArmorItem(IcariaArmorMaterials.ORICHALCUM, ArmorItem.Type.CHESTPLATE, IcariaItems.propertiesItem()));
	public static final Supplier<Item> ORICHALCUM_LEGGINGS = IcariaItems.registerSimple("orichalcum_leggings", () -> new ArmorItem(IcariaArmorMaterials.ORICHALCUM, ArmorItem.Type.LEGGINGS, IcariaItems.propertiesItem()));
	public static final Supplier<Item> ORICHALCUM_BOOTS = IcariaItems.registerSimple("orichalcum_boots", () -> new ArmorItem(IcariaArmorMaterials.ORICHALCUM, ArmorItem.Type.BOOTS, IcariaItems.propertiesItem()));
	...
	public static final Supplier<Item> MEDITERRANEAN_WATER_BUCKET = IcariaItems.registerSimple("mediterranean_water_bucket", () -> new BucketItem(IcariaFluids.MEDITERRANEAN_WATER, IcariaItems.propertiesItem(1).craftRemainder(Items.BUCKET)));
