...
public class IcariaItems {
	...
	public static final RegistryObject<Item> LAUREL_CHERRY = IcariaItems.registerSimple("laurel_cherry", () -> new Item(IcariaItems.propertiesFood(2, 0.5F)));
	public static final RegistryObject<Item> BLACK_OLIVES = IcariaItems.registerSimple("black_olives", () -> new Item(IcariaItems.propertiesFood(2, 0.5F)));
	public static final RegistryObject<Item> GREEN_OLIVES = IcariaItems.registerSimple("green_olives", () -> new Item(IcariaItems.propertiesFood(2, 0.5F)));
	public static final RegistryObject<Item> GARLIC = IcariaItems.registerSimple("garlic", () -> new Item(IcariaItems.propertiesFood(2, 0.5F)));
	public static final RegistryObject<Item> ONION = IcariaItems.registerSimple("onion", () -> new ItemNameBlockItem(IcariaBlocks.ONION_CROP.get(), IcariaItems.propertiesFood(2, 0.5F)));
	public static final RegistryObject<Item> RAW_AETERNAE_MEAT = IcariaItems.registerSimple("raw_aeternae_meat", () -> new Item(IcariaItems.propertiesFood(3, 0.5F, MobEffects.HUNGER, 200, 0, 0.5F)));
	public static final RegistryObject<Item> COOKED_AETERNAE_MEAT = IcariaItems.registerSimple("cooked_aeternae_meat", () -> new Item(IcariaItems.propertiesFood(8, 1.0F)));
	public static final RegistryObject<Item> RAW_CATOBLEPAS_MEAT = IcariaItems.registerSimple("raw_catoblepas_meat", () -> new Item(IcariaItems.propertiesFood(2, 0.5F, MobEffects.HUNGER, 200, 0, 0.5F)));
	public static final RegistryObject<Item> COOKED_CATOBLEPAS_MEAT = IcariaItems.registerSimple("cooked_catoblepas_meat", () -> new Item(IcariaItems.propertiesFood(7, 1.0F)));
	public static final RegistryObject<Item> RAW_CERVER_MEAT = IcariaItems.registerSimple("raw_cerver_meat", () -> new Item(IcariaItems.propertiesItem().food(IcariaItems.foodProperties(3, 0.5F, MobEffects.HUNGER, 200, 0, 0.5F))));
	public static final RegistryObject<Item> COOKED_CERVER_MEAT = IcariaItems.registerSimple("cooked_cerver_meat", () -> new Item(IcariaItems.propertiesFood(8, 1.0F)));
	public static final RegistryObject<Item> RAW_SOW_MEAT = IcariaItems.registerSimple("raw_sow_meat", () -> new Item(IcariaItems.propertiesItem().food(IcariaItems.foodProperties(2, 0.5F, MobEffects.HUNGER, 200, 0, 0.5F))));
	public static final RegistryObject<Item> COOKED_SOW_MEAT = IcariaItems.registerSimple("cooked_sow_meat", () -> new Item(IcariaItems.propertiesFood(7, 1.0F)));
	...
	public static final RegistryObject<Item> SNULL_CREAM = IcariaItems.registerSimple("snull_cream", () -> new Item(IcariaItems.propertiesFood(2, 0.5F, MobEffects.HUNGER, 200, 0, 1.0F, MobEffects.CONFUSION, 200, 0, 1.0F)));
