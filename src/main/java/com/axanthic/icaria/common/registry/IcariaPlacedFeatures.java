...
public class IcariaPlacedFeatures {
	...
	public static void bootstrap(BootstapContext<PlacedFeature> pContext) {
		...
		pContext.register(IcariaPlacedFeatures.GRAINITE_SPIKE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.GRAINITE_SPIKE), List.of(CountPlacement.of(2), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesBlocks(IcariaBlocks.GRAINEL.get()), BlockPredicate.replaceable(), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		...
		pContext.register(IcariaPlacedFeatures.GRAINITE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.GRAINITE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(96)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.DESERT_SILKSTONE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DESERT_SILKSTONE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(96)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.YELLOWSTONE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.YELLOWSTONE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(60), VerticalAnchor.absolute(96)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.SILKSTONE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.SILKSTONE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(60), VerticalAnchor.absolute(72)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.SUNSTONE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.SUNSTONE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(36), VerticalAnchor.absolute(48)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.VOIDSHALE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.VOIDSHALE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(12), VerticalAnchor.absolute(48)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.BAETYL_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.BAETYL_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(24)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.RELICSTONE_RUBBLE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.RELICSTONE_RUBBLE), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(96)), BiomeFilter.biome())));
		...
		pContext.register(IcariaPlacedFeatures.FIR_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.FIR_TREE), List.of(CountPlacement.of(8), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		...
		pContext.register(IcariaPlacedFeatures.DEAD_CYPRESS_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DEAD_CYPRESS_TREE), List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		...
		pContext.register(IcariaPlacedFeatures.DEAD_FIR_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DEAD_FIR_TREE), List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.DEAD_LAUREL_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DEAD_LAUREL_TREE), List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.DEAD_OLIVE_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DEAD_OLIVE_TREE), List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.DEAD_PLANE_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DEAD_PLANE_TREE), List.of(RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.DEAD_POPULUS_TREE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DEAD_POPULUS_TREE), List.of(RarityFilter.onAverageOnceEvery(2), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(84), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.allOf(BlockPredicate.noFluid(), BlockPredicate.replaceable()), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));

		pContext.register(IcariaPlacedFeatures.BLOOMY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.BLOOMY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.BRANCHY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.BRANCHY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.BRUSHY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.BRUSHY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.DRY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.DRY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.REEDY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.REEDY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.SWIRLY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.SWIRLY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		pContext.register(IcariaPlacedFeatures.THORNY_VINE, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.THORNY_VINE), List.of(CountPlacement.of(256), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), BiomeFilter.biome())));
		...
		pContext.register(IcariaPlacedFeatures.VOIDLILY, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.VOIDLILY), List.of(CountPlacement.of(64), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.replaceable(), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
		...
		pContext.register(IcariaPlacedFeatures.MONDANOS, new PlacedFeature(configuredFeatures.getOrThrow(IcariaConfiguredFeatures.MONDANOS), List.of(CountPlacement.of(16), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(256)), EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.SAND), BlockPredicate.replaceable(), 16), RandomOffsetPlacement.vertical(ConstantInt.of(1)), BiomeFilter.biome())));
