...
public class IcariaBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<IcariaSkullBlockEntity>> SKULL = BLOCK_ENTITY_TYPES.register("skull", () -> BlockEntityType.Builder.of(IcariaSkullBlockEntity::new, IcariaBlocks.ARGAN_HOUND_SKULL.get(), IcariaBlocks.ARGAN_HOUND_WALL_SKULL.get(), IcariaBlocks.CATOBLEPAS_SKULL.get(), IcariaBlocks.CATOBLEPAS_WALL_SKULL.get(), IcariaBlocks.CERVER_SKULL.get(), IcariaBlocks.CERVER_WALL_SKULL.get(), IcariaBlocks.SOW_SKULL.get(), IcariaBlocks.SOW_WALL_SKULL.get()).build(null));
