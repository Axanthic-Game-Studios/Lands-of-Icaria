...
public class IcariaBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<IcariaSkullBlockEntity>> SKULL = BLOCK_ENTITY_TYPES.register("skull", () -> BlockEntityType.Builder.of(IcariaSkullBlockEntity::new, IcariaBlocks.CERVER_SKULL.get(), IcariaBlocks.CERVER_WALL_SKULL.get()).build(null));
