...
public class IcariaEntityTypes {
	...
	public static final Supplier<EntityType<IcariaPaintingEntity>> PAINTING = IcariaEntityTypes.register("painting", Builder.<IcariaPaintingEntity>of(IcariaPaintingEntity::new, MobCategory.MISC).sized(0.49F, 0.49F).clientTrackingRange(10).updateInterval(Integer.MAX_VALUE));
