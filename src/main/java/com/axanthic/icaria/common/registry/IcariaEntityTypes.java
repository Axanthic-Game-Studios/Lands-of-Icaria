...
public class IcariaEntityTypes {
	...
	public static final RegistryObject<EntityType<CaptainRevenantEntity>> CAPTAIN_REVENANT = IcariaEntityTypes.register("captain_revenant", Builder.of(CaptainRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 1.99F));
	public static final RegistryObject<EntityType<CivilianRevenantEntity>> CIVILIAN_REVENANT = IcariaEntityTypes.register("civilian_revenant", Builder.of(CivilianRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 1.99F));
	public static final RegistryObject<EntityType<CrawlerRevenantEntity>> CRAWLER_REVENANT = IcariaEntityTypes.register("crawler_revenant", Builder.of(CrawlerRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 0.749F));
	public static final RegistryObject<EntityType<OvergrownRevenantEntity>> OVERGROWN_REVENANT = IcariaEntityTypes.register("overgrown_revenant", Builder.of(OvergrownRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 1.99F));
	public static final RegistryObject<EntityType<PyromancerRevenantEntity>> PYROMANCER_REVENANT = IcariaEntityTypes.register("pyromancer_revenant", Builder.of(PyromancerRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 1.99F));
	public static final RegistryObject<EntityType<NetherPyromancerRevenantEntity>> NETHER_PYROMANCER_REVENANT = IcariaEntityTypes.register("nether_pyromancer_revenant", Builder.of(NetherPyromancerRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 1.99F));
	public static final RegistryObject<EntityType<SoldierRevenantEntity>> SOLDIER_REVENANT = IcariaEntityTypes.register("soldier_revenant", Builder.of(SoldierRevenantEntity::new, MobCategory.MONSTER).fireImmune().sized(0.749F, 1.99F));
