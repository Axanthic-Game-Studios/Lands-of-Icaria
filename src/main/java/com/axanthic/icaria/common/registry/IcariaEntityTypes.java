...
public class IcariaEntityTypes {
	...
	public static final Supplier<EntityType<AeternaeEntity>> AETERNAE = IcariaEntityTypes.register("aeternae", Builder.of(AeternaeEntity::new, MobCategory.CREATURE).sized(1.249F, 1.49F).eyeHeight(1.49F));
	public static final Supplier<EntityType<ArachneEntity>> ARACHNE = IcariaEntityTypes.register("arachne", Builder.of(ArachneEntity::new, MobCategory.MONSTER).sized(1.49F, 1.99F).eyeHeight(2.0F));
	public static final Supplier<EntityType<ArachneDroneEntity>> ARACHNE_DRONE = IcariaEntityTypes.register("arachne_drone", Builder.of(ArachneDroneEntity::new, MobCategory.MONSTER).sized(0.749F, 0.49F).eyeHeight(0.49F));
	public static final Supplier<EntityType<ArganHoundEntity>> ARGAN_HOUND = IcariaEntityTypes.register("argan_hound", Builder.of(ArganHoundEntity::new, MobCategory.MONSTER).sized(0.99F, 0.99F).eyeHeight(0.75F));
	...
	public static final Supplier<EntityType<CatoblepasEntity>> CATOBLEPAS = IcariaEntityTypes.register("catoblepas", Builder.of(CatoblepasEntity::new, MobCategory.CREATURE).sized(1.249F, 1.249F).eyeHeight(1.249F));
	public static final Supplier<EntityType<CerverEntity>> CERVER = IcariaEntityTypes.register("cerver", Builder.of(CerverEntity::new, MobCategory.MONSTER).sized(0.99F, 0.99F).eyeHeight(0.85F));
	...
	public static final Supplier<EntityType<SlugEntity>> CRYSTAL_SLUG = IcariaEntityTypes.register("crystal_slug", Builder.of(SlugEntity::new, MobCategory.AMBIENT).sized(1.249F, 0.749F).eyeHeight(0.749F));
	...
	public static final Supplier<EntityType<SolifugaeEntity>> SOLIFUGAE = IcariaEntityTypes.register("solifugae", Builder.of(SolifugaeEntity::new, MobCategory.MONSTER).sized(0.99F, 0.49F).eyeHeight(0.49F));
	...
	public static final Supplier<EntityType<VinegaroonEntity>> VINEGAROON = IcariaEntityTypes.register("vinegaroon", Builder.of(VinegaroonEntity::new, MobCategory.MONSTER).sized(1.49F, 0.749F).eyeHeight(0.749F));
