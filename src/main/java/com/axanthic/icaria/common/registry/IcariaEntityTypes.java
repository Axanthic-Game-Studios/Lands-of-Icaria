...
public class IcariaEntityTypes {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<CaptainRevenantEntity>> CAPTAIN_REVENANT = IcariaEntityTypes.register("captain_revenant", EntityType.Builder.of(CaptainRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 1.99F).eyeHeight(1.749F).fireImmune());
	public static final DeferredHolder<EntityType<?>, EntityType<CivilianRevenantEntity>> CIVILIAN_REVENANT = IcariaEntityTypes.register("civilian_revenant", EntityType.Builder.of(CivilianRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 1.99F).eyeHeight(1.749F).fireImmune());
	public static final DeferredHolder<EntityType<?>, EntityType<CrawlerRevenantEntity>> CRAWLER_REVENANT = IcariaEntityTypes.register("crawler_revenant", EntityType.Builder.of(CrawlerRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 0.749F).eyeHeight(0.3749F).fireImmune());
	public static final DeferredHolder<EntityType<?>, EntityType<OvergrownRevenantEntity>> OVERGROWN_REVENANT = IcariaEntityTypes.register("overgrown_revenant", EntityType.Builder.of(OvergrownRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 1.99F).eyeHeight(1.749F).fireImmune());
	public static final DeferredHolder<EntityType<?>, EntityType<PyromancerRevenantEntity>> PYROMANCER_REVENANT = IcariaEntityTypes.register("pyromancer_revenant", EntityType.Builder.of(PyromancerRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 1.99F).eyeHeight(1.749F).fireImmune());
	public static final DeferredHolder<EntityType<?>, EntityType<NetherPyromancerRevenantEntity>> NETHER_PYROMANCER_REVENANT = IcariaEntityTypes.register("nether_pyromancer_revenant", EntityType.Builder.of(NetherPyromancerRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 1.99F).eyeHeight(1.749F).fireImmune());
	public static final DeferredHolder<EntityType<?>, EntityType<SoldierRevenantEntity>> SOLDIER_REVENANT = IcariaEntityTypes.register("soldier_revenant", EntityType.Builder.of(SoldierRevenantEntity::new, MobCategory.MONSTER).sized(0.6249F, 1.99F).eyeHeight(1.749F).fireImmune());
	...
	public static final DeferredHolder<EntityType<?>, EntityType<SowEntity>> SOW = IcariaEntityTypes.register("sow", EntityType.Builder.of(SowEntity::new, MobCategory.CREATURE).sized(0.749F, 0.99F).eyeHeight(0.749F));
