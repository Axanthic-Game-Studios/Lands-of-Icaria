...
public class IcariaEntityTypes {
	...
	public static final RegistryObject<EntityType<ArachneEntity>> ARACHNE = IcariaEntityTypes.register("arachne", Builder.of(ArachneEntity::new, MobCategory.MONSTER).sized(1.99F, 1.99F));
	...
	public static final RegistryObject<EntityType<ArganHoundEntity>> ARGAN_HOUND = IcariaEntityTypes.register("argan_hound", Builder.of(ArganHoundEntity::new, MobCategory.MONSTER).sized(1.249F, 0.99F));
	...
	public static final RegistryObject<EntityType<CerverEntity>> CERVER = IcariaEntityTypes.register("cerver", Builder.of(CerverEntity::new, MobCategory.MONSTER).sized(1.249F, 0.99F));
	...
	public static final RegistryObject<EntityType<MyrmekeDroneEntity>> MYRMEKE_DRONE = IcariaEntityTypes.register("myrmeke_drone", Builder.of(MyrmekeDroneEntity::new, MobCategory.MONSTER).sized(0.99F, 0.49F));
	public static final RegistryObject<EntityType<MyrmekeSoldierEntity>> MYRMEKE_SOLDIER = IcariaEntityTypes.register("myrmeke_soldier", Builder.of(MyrmekeSoldierEntity::new, MobCategory.MONSTER).sized(0.99F, 0.49F));
	public static final RegistryObject<EntityType<MyrmekeQueenEntity>> MYRMEKE_QUEEN = IcariaEntityTypes.register("myrmeke_queen", Builder.of(MyrmekeQueenEntity::new, MobCategory.MONSTER).sized(1.249F, 0.49F));
	...
	public static final RegistryObject<EntityType<CrawlerRevenantEntity>> CRAWLER_REVENANT = IcariaEntityTypes.register("crawler_revenant", Builder.of(CrawlerRevenantEntity::new, MobCategory.MONSTER).sized(0.99F, 0.749F));
	...
	public static final RegistryObject<EntityType<VinegaroonEntity>> VINEGAROON = IcariaEntityTypes.register("vinegaroon", Builder.of(VinegaroonEntity::new, MobCategory.MONSTER).sized(1.99F, 0.749F));
