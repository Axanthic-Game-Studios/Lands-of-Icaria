...
public class IcariaEntityTypes {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<FeeshEntity>> FEESH = IcariaEntityTypes.register("feesh", EntityType.Builder.of(FeeshEntity::new, MobCategory.WATER_AMBIENT).sized(0.49F, 0.49F).eyeHeight(0.249F));
	public static final DeferredHolder<EntityType<?>, EntityType<FicheEntity>> FICHE = IcariaEntityTypes.register("fiche", EntityType.Builder.of(FicheEntity::new, MobCategory.WATER_AMBIENT).sized(0.49F, 0.49F).eyeHeight(0.249F));
	public static final DeferredHolder<EntityType<?>, EntityType<FisshhEntity>> FISSHH = IcariaEntityTypes.register("fisshh", EntityType.Builder.of(FisshhEntity::new, MobCategory.WATER_AMBIENT).sized(0.49F, 0.49F).eyeHeight(0.249F));
	public static final DeferredHolder<EntityType<?>, EntityType<FyshEntity>> FYSH = IcariaEntityTypes.register("fysh", EntityType.Builder.of(FyshEntity::new, MobCategory.WATER_AMBIENT).sized(0.49F, 0.49F).eyeHeight(0.249F));
	...
	public static final DeferredHolder<EntityType<?>, EntityType<EnderJellyfishEntity>> ENDER_JELLYFISH = IcariaEntityTypes.register("ender_jellyfish", EntityType.Builder.of(EnderJellyfishEntity::new, MobCategory.WATER_AMBIENT).sized(0.99F, 0.99F).eyeHeight(0.49F));
	public static final DeferredHolder<EntityType<?>, EntityType<FireJellyfishEntity>> FIRE_JELLYFISH = IcariaEntityTypes.register("fire_jellyfish", EntityType.Builder.of(FireJellyfishEntity::new, MobCategory.WATER_AMBIENT).fireImmune().sized(0.99F, 0.99F).eyeHeight(0.49F));
	public static final DeferredHolder<EntityType<?>, EntityType<NatureJellyfishEntity>> NATURE_JELLYFISH = IcariaEntityTypes.register("nature_jellyfish", EntityType.Builder.of(NatureJellyfishEntity::new, MobCategory.WATER_AMBIENT).sized(0.99F, 0.99F).eyeHeight(0.49F));
	public static final DeferredHolder<EntityType<?>, EntityType<VoidJellyfishEntity>> VOID_JELLYFISH = IcariaEntityTypes.register("void_jellyfish", EntityType.Builder.of(VoidJellyfishEntity::new, MobCategory.WATER_AMBIENT).sized(0.99F, 0.99F).eyeHeight(0.49F));
	public static final DeferredHolder<EntityType<?>, EntityType<WaterJellyfishEntity>> WATER_JELLYFISH = IcariaEntityTypes.register("water_jellyfish", EntityType.Builder.of(WaterJellyfishEntity::new, MobCategory.WATER_AMBIENT).sized(0.99F, 0.99F).eyeHeight(0.49F));
