...
public class IcariaNoiseSettings {
	...
	public static SurfaceRules.RuleSource surfaceRules() {
		...
		var surfaceRuleE = SurfaceRules.ifTrue(SurfaceRules.stoneDepthCheck(8, false, 0, CaveSurface.FLOOR), SurfaceRules.ifTrue(SurfaceRules.isBiome(IcariaBiomes.DESERT_PEAK, IcariaBiomes.DESERT, IcariaBiomes.LUSH_DESERT, IcariaBiomes.LOST_DESERT, IcariaBiomes.DEEP_DESERT), SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SURFACE, 0.2D, 2.0D), SurfaceRules.state(IcariaBlocks.LOAM.get().defaultBlockState())), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SURFACE, -0.2D, 0.2D), SurfaceRules.state(IcariaBlocks.SILKSAND.get().defaultBlockState())), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SURFACE, -2.0D, -0.2D), SurfaceRules.state(IcariaBlocks.GRAINEL.get().defaultBlockState())))));
