...
public class IcariaTextureSlots {
	...
	public static final TextureSlot COBWEB = TextureSlot.create("cobweb");
	public static final TextureSlot COBWEB_DOWN = TextureSlot.create("cobweb_down");
	public static final TextureSlot COBWEB_DOWN_UP = TextureSlot.create("cobweb_down");
	public static final TextureSlot COBWEB_DOWN_WEST = TextureSlot.create("cobweb_down_west");
	public static final TextureSlot COBWEB_DOWN_WEST_UP = TextureSlot.create("cobweb_down_west_up");
	public static final TextureSlot COBWEB_EAST_DOWN = TextureSlot.create("cobweb_east_down");
	public static final TextureSlot COBWEB_EAST_DOWN_WEST = TextureSlot.create("cobweb_east_down_west");
	public static final TextureSlot COBWEB_EAST_WEST = TextureSlot.create("cobweb_east_west");
	public static final TextureSlot COBWEB_UP = TextureSlot.create("cobweb_up");
	public static final TextureSlot COBWEB_UP_EAST = TextureSlot.create("cobweb_up_east");
	public static final TextureSlot COBWEB_UP_EAST_DOWN = TextureSlot.create("cobweb_up_east_down");
	public static final TextureSlot COBWEB_WEST_UP = TextureSlot.create("cobweb_west_up");
	public static final TextureSlot COBWEB_WEST_UP_EAST = TextureSlot.create("cobweb_west_up_east");
	...
	public static final TextureSlot STORAGE_VASE = TextureSlot.create("storage_vase");
	public static final TextureSlot STORAGE_VASE_DARK = TextureSlot.create("storage_vase_dark");
	public static final TextureSlot STORAGE_VASE_LITE = TextureSlot.create("storage_vase_lite");
