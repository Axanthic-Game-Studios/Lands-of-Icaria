...
public class KilnOutputSlot extends SlotItemHandler {
	...
	public KilnOutputSlot(IItemHandler pHandler, KilnBlockEntity pBlockEntity, Player pPlayer, int pIndex, int pX, int pY) {
