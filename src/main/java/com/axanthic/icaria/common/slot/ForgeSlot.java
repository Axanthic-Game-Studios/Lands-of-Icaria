...
public class ForgeSlot extends ResourceHandlerSlot {
	public ForgeBlockEntity blockEntity;

	public Player player;

	public ForgeSlot(@Nullable ForgeBlockEntity pBlockEntity, @Nullable Player pPlayer, ResourceHandler<ItemResource> pResourceHandler, IndexModifier<ItemResource> pIndexModifier, int pIndex, int pX, int pY) {
