...
public class GrinderOutputSlot extends SlotItemHandler {
	...
	public GrinderOutputSlot(IItemHandler pHandler, GrinderBlockEntity pBlockEntity, Player pPlayer, int pIndex, int pX, int pY) {
