...
public class KilnSlot extends ResourceHandlerSlot {
	public KilnBlockEntity blockEntity;

	public Player player;

	public KilnSlot(@Nullable KilnBlockEntity pBlockEntity, @Nullable Player pPlayer, ResourceHandler<ItemResource> pResourceHandler, IndexModifier<ItemResource> pIndexModifier, int pIndex, int pX, int pY) {
