...
public class GrindingRecipeBuilderResult implements FinishedRecipe {
    ...
    public GrindingRecipeBuilderResult(float pExperience, int pBurnTime, int pCount, AdvancementHolder pAdvancement, Ingredient pGear, Ingredient pIngredient, Item pOutput, ResourceLocation pAdvancementId, ResourceLocation pId) {
    ...
    public void serializeRecipeData(JsonObject pJson) {
        ...
        pJson.add("gear", this.gear.toJson(true));
