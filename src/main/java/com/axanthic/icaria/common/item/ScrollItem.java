...
public class ScrollItem extends Item {
    ...
    public void inventoryTick(ItemStack pStack, Level pLevel, Entity pEntity, int pSlotId, boolean pIsSelected) {
        ...
        var recipe = pLevel.getRecipeManager().byKey(new ResourceLocation(IcariaInfo.ID, ForgeRegistries.ITEMS.getKey(this).getPath().replace("scroll", "") + "spell_from_concocting"));
        if (recipe.isPresent() && recipe.get() instanceof ConcoctingItemRecipe itemRecipe) {
