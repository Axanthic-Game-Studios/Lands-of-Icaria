...
public class GrinderOutputSlotItemHandler extends SlotItemHandler {
	...
	public GrinderOutputSlotItemHandler(ItemStackHandler pItemStackHandler, @Nullable GrinderBlockEntity pBlockEntity, @Nullable Player pPlayer, int pIndex, int pX, int pY) {
