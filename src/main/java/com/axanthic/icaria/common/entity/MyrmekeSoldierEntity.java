...
public class MyrmekeSoldierEntity extends Monster {
    public static EntityDataAccessor<Byte> CLIMBING = SynchedEntityData.defineId(MyrmekeSoldierEntity.class, EntityDataSerializers.BYTE);
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new MyrmekeSoldierAttackGoal(this));
        this.goalSelector.addGoal(4, new WaterAvoidingRandomStrollGoal(this, 0.8D));
        this.goalSelector.addGoal(5, new LookAtPlayerGoal(this, Player.class, 8.0F));
        this.goalSelector.addGoal(6, new RandomLookAroundGoal(this));
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this));
        this.targetSelector.addGoal(2, new MyrmekeSoldierTargetGoal<>(this, Player.class));
        this.targetSelector.addGoal(3, new MyrmekeSoldierTargetGoal<>(this, IronGolem.class));
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pSpawnType, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pTag) {
        ...
        if (pSpawnData == null) {
            pSpawnData = new MyrmekeSoldierEffectsGroupData();
            if (pLevel.getDifficulty() == Difficulty.HARD && randomSource.nextFloat() < 0.1F * pDifficulty.getSpecialMultiplier()) {
                ((MyrmekeSoldierEffectsGroupData)pSpawnData).setRandomEffect(randomSource);
            }
        }

        if (pSpawnData instanceof MyrmekeSoldierEffectsGroupData) {
            MobEffect mobEffect = ((MyrmekeSoldierEffectsGroupData)pSpawnData).mobEffect;
            if (mobEffect != null) {
    ...
    public static class MyrmekeSoldierAttackGoal extends MeleeAttackGoal {
        public MyrmekeSoldierAttackGoal(MyrmekeSoldierEntity pEntity) {
    ...
    public static class MyrmekeSoldierTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
        public MyrmekeSoldierTargetGoal(MyrmekeSoldierEntity pEntity, Class<T> pTarget) {
    ...
    public static class MyrmekeSoldierEffectsGroupData implements SpawnGroupData {
