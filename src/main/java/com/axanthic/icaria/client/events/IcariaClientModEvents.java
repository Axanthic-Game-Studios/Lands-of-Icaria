...
public class IcariaClientModEvents {
	...
	public static void onRegisterItemColorHandlers(RegisterColorHandlersEvent.Item pEvent) {
		pEvent.register(IcariaClientModEvents.itemColor(), IcariaItems.GRASSY_MARL.get());
		pEvent.register(IcariaClientModEvents.itemColor(), IcariaItems.PALM_FERN.get());
		pEvent.register(IcariaClientModEvents.itemColor(), IcariaItems.WHITE_BROMELIA.get());
		pEvent.register(IcariaClientModEvents.itemColor(), IcariaItems.ORANGE_BROMELIA.get());
		pEvent.register(IcariaClientModEvents.itemColor(), IcariaItems.PINK_BROMELIA.get());
		pEvent.register(IcariaClientModEvents.itemColor(), IcariaItems.PURPLE_BROMELIA.get());
	}
	...
	public static ItemColor itemColor() {
		return (itemStack, i) -> IcariaColors.ITEM;
	}
}
