...
public class SoldierRevenantItemRenderLayer extends RenderLayer<SoldierRevenantRenderState, SoldierRevenantModel> {
	public SoldierRevenantItemRenderLayer(RenderLayerParent<SoldierRevenantRenderState, SoldierRevenantModel> pRenderLayerParent) {
		super(pRenderLayerParent);
	}

	@Override
	public void submit(PoseStack pPoseStack, SubmitNodeCollector pSubmitNodeCollector, int pPackedLight, SoldierRevenantRenderState pRenderState, float yRot, float xRot) {
		pPoseStack.pushPose();
