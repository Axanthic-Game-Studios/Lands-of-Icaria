...
public class PlaneForestHagEmissiveLayer extends RenderLayer<ForestHagEntity, PlaneForestHagModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/plane_forest_hag_emissive.png"));
