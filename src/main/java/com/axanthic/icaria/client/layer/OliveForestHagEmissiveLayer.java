...
public class OliveForestHagEmissiveLayer extends RenderLayer<ForestHagEntity, OliveForestHagModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/olive_forest_hag_emissive.png"));
