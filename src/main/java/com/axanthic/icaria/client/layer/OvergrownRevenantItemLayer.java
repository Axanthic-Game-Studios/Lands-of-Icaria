...
public class OvergrownRevenantItemLayer extends RenderLayer<OvergrownRevenantRenderState, OvergrownRevenantModel> {
	public OvergrownRevenantItemLayer(RenderLayerParent<OvergrownRevenantRenderState, OvergrownRevenantModel> pRenderLayerParent) {
