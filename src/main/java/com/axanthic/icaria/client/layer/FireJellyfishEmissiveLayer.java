...
public class FireJellyfishEmissiveLayer extends RenderLayer<JellyfishEntity, FireJellyfishModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/fire_jellyfish_emissive.png"));
