...
public class NatureJellyfishEmissiveLayer extends RenderLayer<JellyfishEntity, NatureJellyfishModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/nature_jellyfish_emissive.png"));
