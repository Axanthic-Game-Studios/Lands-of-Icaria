...
public class DroughtrootForestHagEmissiveLayer extends RenderLayer<ForestHagEntity, DroughtrootForestHagModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/droughtroot_forest_hag_emissive.png"));
