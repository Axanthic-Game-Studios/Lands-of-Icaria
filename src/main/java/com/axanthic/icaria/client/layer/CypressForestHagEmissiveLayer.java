...
public class CypressForestHagEmissiveLayer extends RenderLayer<ForestHagEntity, CypressForestHagModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/cypress_forest_hag_emissive.png"));
