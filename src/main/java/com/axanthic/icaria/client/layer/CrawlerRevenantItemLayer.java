...
public class CrawlerRevenantItemLayer extends RenderLayer<CrawlerRevenantRenderState, CrawlerRevenantModel> {
	public CrawlerRevenantItemLayer(RenderLayerParent<CrawlerRevenantRenderState, CrawlerRevenantModel> pRenderLayerParent) {
		super(pRenderLayerParent);
	}

	@Override
	public void render(PoseStack pPoseStack, MultiBufferSource pMultiBufferSource, int pPackedLight, CrawlerRevenantRenderState pRenderState, float pYRot, float pXRot) {
		pPoseStack.pushPose();
