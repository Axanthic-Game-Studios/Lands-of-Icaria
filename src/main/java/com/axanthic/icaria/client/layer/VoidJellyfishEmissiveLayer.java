...
public class VoidJellyfishEmissiveLayer extends RenderLayer<JellyfishEntity, VoidJellyfishModel> {
    public static final RenderType EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.MODID, "textures/entity/void_jellyfish_emissive.png"));
