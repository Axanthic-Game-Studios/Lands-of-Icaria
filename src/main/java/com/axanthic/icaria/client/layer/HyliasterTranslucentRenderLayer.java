...
public class HyliasterTranslucentRenderLayer extends RenderLayer<HyliasterRenderState, HyliasterModel> {
	public HyliasterTranslucentRenderLayer(RenderLayerParent<HyliasterRenderState, HyliasterModel> pRenderLayerParent) {
