...
public class SoldierRevenantItemLayer extends RenderLayer<SoldierRevenantRenderState, SoldierRevenantModel> {
	public SoldierRevenantItemLayer(RenderLayerParent<SoldierRevenantRenderState, SoldierRevenantModel> pRenderLayerParent) {
		super(pRenderLayerParent);
	}

	@Override
	public void render(PoseStack pPoseStack, MultiBufferSource pMultiBufferSource, int pPackedLight, SoldierRevenantRenderState pRenderState, float pYRot, float pXRot) {
		pPoseStack.pushPose();
