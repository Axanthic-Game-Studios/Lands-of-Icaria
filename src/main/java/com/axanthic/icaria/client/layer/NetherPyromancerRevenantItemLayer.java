...
public class NetherPyromancerRevenantItemLayer extends RenderLayer<NetherPyromancerRevenantRenderState, NetherPyromancerRevenantModel> {
	public NetherPyromancerRevenantItemLayer(RenderLayerParent<NetherPyromancerRevenantRenderState, NetherPyromancerRevenantModel> pRenderLayerParent) {
