...
public class CivilianRevenantItemLayer extends RenderLayer<CivilianRevenantEntity, CivilianRevenantModel> {
    public CivilianRevenantItemLayer(RenderLayerParent<CivilianRevenantEntity, CivilianRevenantModel> pRenderer) {
        super(pRenderer);
    }
