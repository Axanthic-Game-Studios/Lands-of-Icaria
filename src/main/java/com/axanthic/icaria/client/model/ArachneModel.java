...
public class ArachneModel extends HierarchicalModel<ArachneEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition head = partDefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(114, 151).addBox(-3.5F, -4.0F, -3.0F, 7.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 13.5F, -2.0F, -0.3927F, 0.0F, 0.0F));
        PartDefinition abdomen = head.addOrReplaceChild("abdomen", CubeListBuilder.create().texOffs(86, 150).addBox(-4.0F, -4.0F, -6.0F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, -3.0F, -0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition biterRight = skull.addOrReplaceChild("biterRight", CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, 0.6F, -4.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -4.0F, -1.0F, 0.7854F, 0.576F, 0.0F));
        ...
        PartDefinition biterLeft = skull.addOrReplaceChild("biterLeft", CubeListBuilder.create().texOffs(32, 12).addBox(-2.0F, 0.6F, -4.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -4.0F, -1.0F, 0.7854F, -0.576F, 0.0F));
        ...
        PartDefinition body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(136, 148).addBox(-3.0F, -9.3188F, -2.9284F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.3F, 1.1F));
        PartDefinition bodyFront = body.addOrReplaceChild("bodyFront", CubeListBuilder.create().texOffs(132, 136).addBox(-5.0F, -7.0F, 0.0F, 10.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 3.1F, 0.1745F, 0.0F, 0.0F));
        PartDefinition bodyFrontCenter = bodyFront.addOrReplaceChild("bodyFrontCenter", CubeListBuilder.create().texOffs(124, 120).addBox(-6.0F, -8.0F, 4.0F, 12.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.15F, -0.275F, -0.0436F, 0.0F, 0.0F));
        PartDefinition bodyFrontRear = bodyFrontCenter.addOrReplaceChild("bodyFrontRear", CubeListBuilder.create().texOffs(120, 102).addBox(-7.0F, -1.0F, 5.0F, 14.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.2F, 4.0F, -0.0436F, 0.0F, 0.0F));
        PartDefinition bodyCenterFront = bodyFrontRear.addOrReplaceChild("bodyCenterFront", CubeListBuilder.create().texOffs(124, 86).addBox(-6.0F, 1.5F, 4.75F, 12.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.775F, 5.25F, -0.0436F, 0.0F, 0.0F));
        PartDefinition bodyCenter = bodyCenterFront.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(130, 73).addBox(-5.0F, 0.0F, -1.0F, 10.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.475F, 10.775F, -0.0436F, 0.0F, 0.0F));
        PartDefinition bodyCenterRear = bodyCenter.addOrReplaceChild("bodyCenterRear", CubeListBuilder.create().texOffs(136, 63).addBox(-4.0F, 1.5F, 2.5F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.675F, 0.575F, -0.0436F, 0.0F, 0.0F));
        PartDefinition bodyRearFront = bodyCenterRear.addOrReplaceChild("bodyRearFront", CubeListBuilder.create().texOffs(142, 55).addBox(-3.0F, 1.5F, 2.25F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.45F, 4.3F, -0.0873F, 0.0F, 0.0F));
        PartDefinition bodyRearCenter = bodyRearFront.addOrReplaceChild("bodyRearCenter", CubeListBuilder.create().texOffs(146, 48).addBox(-2.0F, 1.75F, 1.25F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.05F, 4.3F, -0.1745F, 0.0F, 0.0F));
        PartDefinition bodyRear = bodyRearCenter.addOrReplaceChild("bodyRear", CubeListBuilder.create().texOffs(148, 0).addBox(-1.5F, 0.0F, -0.75F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.1F, 4.025F, -0.3491F, 0.0F, 0.0F));
        PartDefinition stingerFront = bodyRear.addOrReplaceChild("stingerFront", CubeListBuilder.create().texOffs(150, 6).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.175F, 1.325F, -0.3491F, 0.0F, 0.0F));
