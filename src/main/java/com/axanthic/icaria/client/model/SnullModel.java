...
public class SnullModel extends HierarchicalModel<SnullEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyFront = partDefinition.addOrReplaceChild("bodyFront", CubeListBuilder.create().texOffs(0, 29).addBox(-2.95F, -4.0F, -2.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.0F, -3.0F, -0.2618F, 0.0F, 0.0F));
        PartDefinition chest = bodyFront.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(0, 21).addBox(-2.6F, -4.0F, -4.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, -0.2618F, 0.0F, 0.0F));
        PartDefinition neck = chest.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(0, 13).addBox(-2.55F, -4.0F, -4.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, -0.5236F, 0.0F, 0.0F));
        ...
        PartDefinition head = neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -4.0F, -4.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, -0.2618F, 0.0F, 0.0F));
        ...
        PartDefinition headFeelerRight = head.addOrReplaceChild("headFeelerRight", CubeListBuilder.create().texOffs(18, 0).addBox(-0.5F, -0.5F, -5.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -1.0F, -4.0F, 0.2618F, 0.0F, 0.7854F));
        ...
        PartDefinition headFeelerLeft = head.addOrReplaceChild("headFeelerLeft", CubeListBuilder.create().texOffs(19, 1).addBox(-0.5F, -0.5F, -4.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, -1.0F, -4.0F, 0.0F, -0.2618F, 0.7854F));
        ...
        PartDefinition bodyCenter = partDefinition.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(0, 52).addBox(-3.0F, -1.0F, -4.0F, 6.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.0F, 1.0F));
        ...
        PartDefinition bodySkull = partDefinition.addOrReplaceChild("bodySkull", CubeListBuilder.create().texOffs(78, 15).addBox(-2.0F, -2.0F, -3.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 20.0F, 5.0F, -0.4363F, 0.0F, 0.0F));
        PartDefinition skullJawLower = bodySkull.addOrReplaceChild("skullJawLower", CubeListBuilder.create().texOffs(71, 1).addBox(-2.5F, -0.35F, -5.95F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 1.8F, 0.1745F, 0.0F, 0.0F));
        PartDefinition skullJawUpper = skullJawLower.addOrReplaceChild("skullJawUpper", CubeListBuilder.create().texOffs(70, 7).addBox(-2.5F, -0.7F, -6.05F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0125F, -0.275F, 0.1375F, -0.1745F, 0.0F, 0.0F));
        PartDefinition skull = skullJawUpper.addOrReplaceChild("skull", CubeListBuilder.create().texOffs(68, 0).addBox(-3.5F, -6.0F, -6.8F, 7.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.6F, 0.0F));
        PartDefinition skullFeelerRight = skull.addOrReplaceChild("skullFeelerRight", CubeListBuilder.create().texOffs(18, 0).addBox(-0.5F, -0.55F, -5.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -1.4F, -6.8F, -0.2618F, 0.1745F, 0.0F));
        ...
        PartDefinition skullFeelerLeft = skull.addOrReplaceChild("skullFeelerLeft", CubeListBuilder.create().texOffs(19, 1).addBox(-0.5F, -0.55F, -4.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -1.4F, -6.8F, -0.2618F, -0.1745F, 0.0F));
        ...
        PartDefinition bodyRear = partDefinition.addOrReplaceChild("bodyRear", CubeListBuilder.create().texOffs(0, 42).addBox(-2.6F, -3.0F, 0.0F, 5.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 5.0F));
