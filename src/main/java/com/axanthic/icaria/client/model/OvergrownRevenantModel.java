...
public class OvergrownRevenantModel extends HierarchicalModel<OvergrownRevenantEntity> implements ArmedModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyUpper = partDefinition.addOrReplaceChild("bodyUpper", CubeListBuilder.create().texOffs(8, 35).addBox(-1.0F, -7.05F, -1.0375F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.02F, 9.9641F, 0.4459F));
        PartDefinition spineMain = bodyUpper.addOrReplaceChild("spineMain", CubeListBuilder.create().texOffs(34, 7).addBox(-1.0F, -9.7498F, -1.0076F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.02F, -7.0813F, 0.0002F, 0.2731F, 0.0F, 0.0F));
        PartDefinition headMain = spineMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(0, 21).addBox(-3.6196F, -5.9487F, -5.5416F, 7.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.025F, -8.6576F, -0.0411F, -0.2721F, 0.0F, 0.0F));
        ...
        PartDefinition jawUpper = headMain.addOrReplaceChild("jawUpper", CubeListBuilder.create().texOffs(34, 0).addBox(-2.575F, -0.0375F, -6.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.0446F, 0.0888F, 0.9584F));
        ...
        PartDefinition shoulderMain = spineMain.addOrReplaceChild("shoulderMain", CubeListBuilder.create().texOffs(22, 21).addBox(-6.5F, -0.5F, -0.5F, 13.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.7553F, -0.9128F));
        PartDefinition armRightUpper = shoulderMain.addOrReplaceChild("armRightUpper", CubeListBuilder.create().texOffs(32, 36).addBox(-0.9968F, 0.0078F, -1.0041F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.8125F, 0.0228F, 0.0466F, -0.2731F, 0.0F, 0.2047F));
        ...
        PartDefinition armLeftUpper = shoulderMain.addOrReplaceChild("armLeftUpper", CubeListBuilder.create().texOffs(24, 36).addBox(-1.0154F, 0.002F, -0.9927F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.825F, 0.2103F, -0.0784F, -0.2731F, 0.0F, -0.2047F));
        ...
        PartDefinition ribUpperRightRear = spineMain.addOrReplaceChild("ribUpperRightRear", CubeListBuilder.create().texOffs(56, 47).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -5.7498F, 0.0924F));
        PartDefinition ribUpperRightSide = ribUpperRightRear.addOrReplaceChild("ribUpperRightSide", CubeListBuilder.create().texOffs(44, 28).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribUpperLeftRear = spineMain.addOrReplaceChild("ribUpperLeftRear", CubeListBuilder.create().texOffs(34, 57).addBox(-2.0F, -1.0F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -5.7498F, 0.0924F));
        PartDefinition ribUpperLeftSide = ribUpperLeftRear.addOrReplaceChild("ribUpperLeftSide", CubeListBuilder.create().texOffs(46, 12).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribUpperCenterRightRear = spineMain.addOrReplaceChild("ribUpperCenterRightRear", CubeListBuilder.create().texOffs(58, 20).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9177F, -3.9554F, 0.0924F, 0.0F, 0.0F, -0.1047F));
        PartDefinition ribUpperCenterRightSide = ribUpperCenterRightRear.addOrReplaceChild("ribUpperCenterRightSide", CubeListBuilder.create().texOffs(52, 52).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribUpperCenterLeftRear = spineMain.addOrReplaceChild("ribUpperCenterLeftRear", CubeListBuilder.create().texOffs(22, 27).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9177F, -3.9554F, 0.0924F, 0.0F, 0.0F, 0.1047F));
        PartDefinition ribUpperCenterLeftSide = ribUpperCenterLeftRear.addOrReplaceChild("ribUpperCenterLeftSide", CubeListBuilder.create().texOffs(29, 0).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribCenterRightRear = spineMain.addOrReplaceChild("ribCenterRightRear", CubeListBuilder.create().texOffs(8, 58).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.6067F, -2.7025F, 0.0924F, 0.0F, 0.0F, -0.2094F));
        PartDefinition ribCenterRightSide = ribCenterRightRear.addOrReplaceChild("ribCenterRightSide", CubeListBuilder.create().texOffs(34, 52).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribCenterLeftRear = spineMain.addOrReplaceChild("ribCenterLeftRear", CubeListBuilder.create().texOffs(56, 5).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.6067F, -2.7025F, 0.0924F, 0.0F, 0.0F, 0.2094F));
        PartDefinition ribCenterLeftSide = ribCenterLeftRear.addOrReplaceChild("ribCenterLeftSide", CubeListBuilder.create().texOffs(38, 16).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribLowerCenterRightRear = spineMain.addOrReplaceChild("ribLowerCenterRightRear", CubeListBuilder.create().texOffs(58, 7).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.1716F, -1.4941F, 0.0924F, 0.0F, 0.0F, -0.3142F));
        PartDefinition ribLowerCenterRightSide = ribLowerCenterRightRear.addOrReplaceChild("ribLowerCenterRightSide", CubeListBuilder.create().texOffs(50, 47).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribLowerCenterLeftRear = spineMain.addOrReplaceChild("ribLowerCenterLeftRear", CubeListBuilder.create().texOffs(56, 57).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1716F, -1.4941F, 0.0924F, 0.0F, 0.0F, 0.3142F));
        PartDefinition ribLowerCenterLeftSide = ribLowerCenterLeftRear.addOrReplaceChild("ribLowerCenterLeftSide", CubeListBuilder.create().texOffs(50, 26).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribLowerRightRear = spineMain.addOrReplaceChild("ribLowerRightRear", CubeListBuilder.create().texOffs(58, 22).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.6171F, -0.3322F, 0.0924F, 0.0F, 0.0F, -0.4189F));
        PartDefinition ribLowerRightSide = ribLowerRightRear.addOrReplaceChild("ribLowerRightSide", CubeListBuilder.create().texOffs(16, 53).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 0.0F, -1.5F));
        ...
        PartDefinition ribLowerLeftRear = spineMain.addOrReplaceChild("ribLowerLeftRear", CubeListBuilder.create().texOffs(56, 18).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.6171F, -0.3322F, 0.0924F, 0.0F, 0.0F, 0.4189F));
        PartDefinition ribLowerLeftSide = ribLowerLeftRear.addOrReplaceChild("ribLowerLeftSide", CubeListBuilder.create().texOffs(50, 0).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 0.0F, -1.5F));
        ...
        PartDefinition bodyLower = partDefinition.addOrReplaceChild("bodyLower", CubeListBuilder.create().texOffs(22, 23).addBox(-4.0F, -0.5F, -0.5F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 9.9248F, 0.4112F));
        PartDefinition pelvisMain = bodyLower.addOrReplaceChild("pelvisMain", CubeListBuilder.create().texOffs(22, 25).addBox(-3.5F, -0.5F, -0.5F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.75F, -2.4625F));
        PartDefinition pelvisRight = pelvisMain.addOrReplaceChild("pelvisRight", CubeListBuilder.create().texOffs(56, 14).addBox(-1.0F, -0.5F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.8575F, -0.4258F, 1.4005F, 0.2094F, -0.1047F, 0.0F));
        ...
        PartDefinition thighRight = pelvisRight.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(42, 7).addBox(-0.9657F, 0.1285F, -1.1001F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0012F, 0.0765F, 0.5268F, -0.3142F, 0.3142F, -0.0436F));
        ...
        PartDefinition pelvisLeft = pelvisMain.addOrReplaceChild("pelvisLeft", CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, -0.5F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.8575F, -0.4258F, 1.4005F, 0.2094F, 0.1047F, 0.0F));
        PartDefinition thighLeft = pelvisLeft.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(14, 44).addBox(-1.0165F, 0.1732F, -1.0778F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0091F, 0.0425F, 0.5056F, -0.3142F, -0.3142F, 0.0436F));
        PartDefinition legLeft = thighLeft.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(0, 45).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.004F, 7.1732F, -0.0778F, 0.2094F, 0.0F, 0.0F));
