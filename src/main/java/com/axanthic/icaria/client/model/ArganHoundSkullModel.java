...
public class ArganHoundSkullModel extends SkullModel {
	...
	public static LayerDefinition createLayer() {
		...
		var head = partDefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 48).addBox(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		var nose = head.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(43, 46).addBox(-2.0F, -1.025F, -4.925F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.9567F, -2.0744F));
