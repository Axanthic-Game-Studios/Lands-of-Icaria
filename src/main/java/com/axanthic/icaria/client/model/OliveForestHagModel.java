...
public class OliveForestHagModel extends HierarchicalModel<ForestHagEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(IcariaInfo.MODID, "olive_forest_hag"), "main");
    ...
    public void walkAnim(float pLimbSwing, float pLimbSwingAmount) {
        ...
        this.armLeftLower.xRot = Mth.cos(pLimbSwing * 0.6662F + Mth.PI) * ulnaBend * pLimbSwingAmount - this.ulnaBend * pLimbSwingAmount - 0.1820F;
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyBase = partDefinition.addOrReplaceChild("bodyBase", CubeListBuilder.create().texOffs(32, 10).addBox(-5.9599F, -4.2017F, -2.5084F, 13.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2125F, 8.2625F, 0.0F, -0.167F, 0.0F, -0.1061F));
        PartDefinition bodyMain = bodyBase.addOrReplaceChild("bodyMain", CubeListBuilder.create().texOffs(32, 19).addBox(-5.8246F, -2.8478F, -2.2689F, 12.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1901F, -4.1267F, 0.2666F, -0.167F, 0.0F, -0.1061F));
        PartDefinition bodyLower = bodyMain.addOrReplaceChild("bodyLower", CubeListBuilder.create().texOffs(48, 27).addBox(-5.9577F, -3.8032F, -1.564F, 11.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5504F, -3.1228F, -0.3064F, 0.1061F, 0.0F, 0.0761F));
        PartDefinition bodyCenter = bodyLower.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(44, 44).addBox(-5.9924F, -3.5181F, -1.7566F, 12.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2327F, -3.2782F, -0.314F, 0.197F, 0.0F, 0.0761F));
        PartDefinition bodyUpper = bodyCenter.addOrReplaceChild("bodyUpper", CubeListBuilder.create().texOffs(0, 0).addBox(-7.3716F, -4.7791F, -2.546F, 18.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5076F, -2.6306F, 0.2434F, 0.197F, 0.0F, 0.0761F));
        ...
        PartDefinition shoulderRight = bodyUpper.addOrReplaceChild("shoulderRight", CubeListBuilder.create().texOffs(46, 0).addBox(-11.8005F, -4.2922F, -1.2377F, 12.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0466F, -4.2416F, 0.079F, 0.4077F, 0.0F, -0.4077F));
        PartDefinition armRightUpper = shoulderRight.addOrReplaceChild("armRightUpper", CubeListBuilder.create().texOffs(64, 62).addBox(-0.8689F, 0.3634F, -1.3015F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.913F, -2.2922F, 0.2623F, -0.5918F, 0.0436F, 0.4427F));
        ...
        PartDefinition armLeftUpper = bodyUpper.addOrReplaceChild("armLeftUpper", CubeListBuilder.create().texOffs(0, 62).addBox(-1.1868F, -0.4039F, -1.4712F, 3.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.6409F, -2.7791F, -0.071F, -0.1784F, 0.0F, -0.3193F));
        ...
        PartDefinition neckMain = bodyUpper.addOrReplaceChild("neckMain", CubeListBuilder.create().texOffs(52, 52).addBox(-2.0F, -6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1284F, -3.2791F, -0.046F, 0.8004F, 0.0F, -0.015F));
        PartDefinition headMain = neckMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(0, 48).addBox(-3.0F, -5.0F, -6.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.5F, 0.2F, -0.8727F, 0.0F, 0.0F));
        ...
        PartDefinition thighRight = bodyBase.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(64, 35).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5849F, -1.5517F, -0.3834F, 0.0759F, 0.182F, 0.1309F));
        PartDefinition legRight = thighRight.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(44, 68).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.5F, 0.0F, 0.0911F, -0.0911F, 0.0F));
        ...
        PartDefinition thighLeft = bodyBase.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(63, 8).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5526F, -0.9142F, -0.0709F, 0.0759F, -0.0948F, 0.048F));
        PartDefinition legLeft = thighLeft.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(24, 66).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, -0.0911F, -0.0911F, 0.0F));
        PartDefinition footLeft = legLeft.addOrReplaceChild("footLeft", CubeListBuilder.create().texOffs(36, 68).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.5F, 0.0F, 0.0911F, 0.0911F, 0.0F));
