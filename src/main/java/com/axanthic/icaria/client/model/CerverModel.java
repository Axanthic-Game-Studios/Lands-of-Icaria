...
public class CerverModel extends EntityModel<CerverEntity> {
    ...
    public ModelPart thigh_right_back;
    public ModelPart thigh_left_back;
    public ModelPart tail_back;
    public ModelPart leg_right_back;
    public ModelPart paw_right_back;
    public ModelPart leg_left_back;
    public ModelPart paw_left_back;
    ...
    public CerverModel(ModelPart pModelPart) {
        ...
        this.tail_back = this.tail_front.getChild("tail_back");
        this.thigh_right_back = this.rump.getChild("thigh_right_back");
        this.leg_right_back = this.thigh_right_back.getChild("leg_right_back");
        this.paw_right_back = this.leg_right_back.getChild("paw_right_back");
        this.thigh_left_back = this.rump.getChild("thigh_left_back");
        this.leg_left_back = this.thigh_left_back.getChild("leg_left_back");
        this.paw_left_back = this.leg_left_back.getChild("paw_left_back");
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        tail_front.addOrReplaceChild("tail_back", CubeListBuilder.create().texOffs(62, 33).addBox(-1.02F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.0F, -1.5F, 0.5462880558742251F, 0.0F, 0.0F));
        PartDefinition thigh_right_back = rump.addOrReplaceChild("thigh_right_back", CubeListBuilder.create().texOffs(38, 30).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 1.2F, 0.8F, 0.39269908169872414F, 0.0F, 0.0F));
        PartDefinition leg_right_back = thigh_right_back.addOrReplaceChild("leg_right_back", CubeListBuilder.create().texOffs(70, 33).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, 5.15F, -0.25F, 0.5918411493512771F, 0.0F, 0.0F));
        leg_right_back.addOrReplaceChild("paw_right_back", CubeListBuilder.create().texOffs(0, 38).addBox(-2.0F, 0.0F, -2.2F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.3F, 0.0F, -0.136659280431156F, 0.0F, 0.0F));
        PartDefinition thigh_left_back = rump.addOrReplaceChild("thigh_left_back", CubeListBuilder.create().texOffs(50, 30).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 1.2F, 0.8F, 0.39269908169872414F, 0.0F, 0.0F));
        PartDefinition leg_left_back = thigh_left_back.addOrReplaceChild("leg_left_back", CubeListBuilder.create().texOffs(82, 33).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, 5.15F, -0.25F, 0.5918411493512771F, 0.0F, 0.0F));
        leg_left_back.addOrReplaceChild("paw_left_back", CubeListBuilder.create().texOffs(16, 38).addBox(-2.0F, 0.0F, -2.2F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.3F, 0.0F, -0.136659280431156F, 0.0F, 0.0F));
    ...
    public void walkAnim(float pLimbSwing, float pLimbSwingAmount) {
        ...
        this.thigh_right_back.xRot = Mth.cos(pLimbSwing * 0.5F + (float) Math.PI * 1.5F) * 1.2F * pLimbSwingAmount + 0.39269908169872414F;
        this.thigh_left_back.xRot = Mth.cos(pLimbSwing * 0.5F + (float) Math.PI * 0.5F) * 1.2F * pLimbSwingAmount + 0.39269908169872414F;
        ...
        this.leg_right_back.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + (float) Math.PI * 0.75F)) * 0.5F + (float) Math.PI * 1.5F) * kneebend * pLimbSwingAmount + kneebend * pLimbSwingAmount + 0.5918411493512771F;
        this.leg_left_back.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + (float) Math.PI * 0.25F)) * 0.5F + (float) Math.PI * 0.5F) * kneebend * pLimbSwingAmount + kneebend * pLimbSwingAmount + 0.5918411493512771F;
        ...
        this.paw_right_back.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + (float) Math.PI * 0.75F)) * 0.5F + (float) Math.PI * 1.5F) * kneebend * 1.7F * pLimbSwingAmount + kneebend * 1.0F * pLimbSwingAmount - 0.136659280431156F;
        this.paw_left_back.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + (float) Math.PI * 0.25F)) * 0.5F + (float) Math.PI * 0.5F) * kneebend * 1.7F * pLimbSwingAmount + kneebend * 1.0F * pLimbSwingAmount - 0.136659280431156F;
    }
}
