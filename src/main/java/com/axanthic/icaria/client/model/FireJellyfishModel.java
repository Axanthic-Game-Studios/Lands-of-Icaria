...
public class FireJellyfishModel extends HierarchicalModel<JellyfishEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(IcariaInfo.MODID, "fire_jellyfish"), "main");
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition bell = body.addOrReplaceChild("bell", CubeListBuilder.create().texOffs(0, 34).addBox(-6.0F, -26.0F, -6.0F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(48, 48).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, 0.0F));
        PartDefinition tentacleInnerSouthEastUpper = head.addOrReplaceChild("tentacleInnerSouthEastUpper", CubeListBuilder.create().texOffs(4, 48).addBox(-0.5F, 0.0F, 0.5F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 4.9742F, 0.0F));
        ...
        PartDefinition tentacleInnerNorthUpper = head.addOrReplaceChild("tentacleInnerNorthUpper", CubeListBuilder.create().texOffs(2, 48).addBox(-0.5F, 0.0F, 0.5F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 2.8798F, 0.0F));
        ...
        PartDefinition tentacleInnerSouthWestUpper = head.addOrReplaceChild("tentacleInnerSouthWestUpper", CubeListBuilder.create().texOffs(0, 48).addBox(-0.5F, 0.0F, 0.5F, 1.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.7854F, 0.0F));
        ...
        PartDefinition tentacleCenterNorthEastUpper = head.addOrReplaceChild("tentacleCenterNorthEastUpper", CubeListBuilder.create().texOffs(10, 48).addBox(-0.5F, 0.0F, 0.75F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, -2.3562F, 0.0F));
        ...
        PartDefinition tentacleCenterSouthUpper = head.addOrReplaceChild("tentacleCenterSouthUpper", CubeListBuilder.create().texOffs(6, 48).addBox(-0.5F, 0.0F, 0.75F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, -0.2618F, 0.0F));
        ...
        PartDefinition tentacleCenterNorthWestUpper = head.addOrReplaceChild("tentacleCenterNorthWestUpper", CubeListBuilder.create().texOffs(8, 48).addBox(-0.5F, 0.0F, 0.75F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 1.8326F, 0.0F));
        ...
        PartDefinition tentacleOuterNorthUpper = head.addOrReplaceChild("tentacleOuterNorthUpper", CubeListBuilder.create().texOffs(18, 48).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, -3.0107F, 0.0F));
        ...
        PartDefinition tentacleOuterNorthEastUpper = head.addOrReplaceChild("tentacleOuterNorthEastUpper", CubeListBuilder.create().texOffs(20, 48).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, -1.7017F, 0.0F));
        ...
        PartDefinition tentacleOuterSouthEastUpper = head.addOrReplaceChild("tentacleOuterSouthEastUpper", CubeListBuilder.create().texOffs(22, 48).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, -0.9163F, 0.0F));
        ...
        PartDefinition tentacleOuterSouthUpper = head.addOrReplaceChild("tentacleOuterSouthUpper", CubeListBuilder.create().texOffs(12, 48).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, 0.3927F, 0.0F));
        ...
        PartDefinition tentacleOuterSouthWestUpper = head.addOrReplaceChild("tentacleOuterSouthWestUpper", CubeListBuilder.create().texOffs(14, 48).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, 1.1781F, 0.0F));
        ...
        PartDefinition tentacleOuterNorthWestUpper = head.addOrReplaceChild("tentacleOuterNorthWestUpper", CubeListBuilder.create().texOffs(16, 48).addBox(-0.5F, 0.0F, 1.0F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, 2.4871F, 0.0F));
