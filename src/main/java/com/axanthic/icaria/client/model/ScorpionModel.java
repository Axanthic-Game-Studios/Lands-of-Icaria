...
public class ScorpionModel extends HierarchicalModel<ScorpionEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition headMain = bodyMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -3.0657F, -6.8917F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.525F, -4.025F, -0.085F, 0.0F, 0.0F));
        PartDefinition armRightRear = headMain.addOrReplaceChild("armRightRear", CubeListBuilder.create().texOffs(0, 59).addBox(-6.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.3F, -0.0657F, -7.8917F, 0.0F, 0.2793F, 0.0F));
        ...
        PartDefinition armRightFront = armRightCenter.addOrReplaceChild("armRightFront", CubeListBuilder.create().texOffs(46, 30).addBox(-6.006F, -1.5F, -2.1738F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.9375F, 0.0F, 0.0125F, 0.0F, -0.7156F, 0.0F));
        ...
        PartDefinition armLeftRear = headMain.addOrReplaceChild("armLeftRear", CubeListBuilder.create().texOffs(16, 59).addBox(0.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.3F, -0.0657F, -7.8917F, 0.0F, -0.2793F, 0.0F));
        ...
        PartDefinition armLeftFront = armLeftCenter.addOrReplaceChild("armLeftFront", CubeListBuilder.create().texOffs(0, 43).addBox(0.0011F, -1.5F, -2.1021F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.9F, 0.0F, -0.05F, 0.0F, 0.7285F, 0.0F));
        ...
        PartDefinition bodyFront = bodyMain.addOrReplaceChild("bodyFront", CubeListBuilder.create().texOffs(62, 0).addBox(-4.0F, -2.9837F, -0.1256F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.4875F, 2.975F, 0.3643F, 0.0F, 0.0F));
        PartDefinition bodyCenter = bodyFront.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(0, 13).addBox(-3.5F, -2.9986F, -0.8111F, 7.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0288F, 6.8619F, 0.2731F, 0.0F, 0.0F));
        PartDefinition bodyRear = bodyCenter.addOrReplaceChild("bodyRear", CubeListBuilder.create().texOffs(26, 13).addBox(-3.0F, -7.6652F, -2.2439F, 6.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.6361F, 5.1889F, -0.8652F, 0.0F, 0.0F));
        PartDefinition tailFront = bodyRear.addOrReplaceChild("tailFront", CubeListBuilder.create().texOffs(28, 30).addBox(-2.5F, -7.657F, -2.8162F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.6652F, -0.2439F, 1.0174F, 0.0F, 0.0F));
        PartDefinition tailCenter = tailFront.addOrReplaceChild("tailCenter", CubeListBuilder.create().texOffs(20, 43).addBox(-2.0F, -8.0713F, -1.5312F, 4.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.657F, -0.9412F, 0.5009F, 0.0F, 0.0F));
        PartDefinition tailRear = tailCenter.addOrReplaceChild("tailRear", CubeListBuilder.create().texOffs(32, 59).addBox(-0.5F, -5.6199F, -1.8625F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -8.0588F, -0.0062F, 1.9124F, 0.0F, 0.0F));
        ...
        PartDefinition legRightCenterFrontUpper = bodyMain.addOrReplaceChild("legRightCenterFrontUpper", CubeListBuilder.create().texOffs(0, 55).addBox(-6.9187F, -1.0196F, -0.8046F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 1.125F, -1.3F, -0.188F, -0.2688F, 0.2789F));
        ...
        PartDefinition legLeftCenterFrontUpper = bodyMain.addOrReplaceChild("legLeftCenterFrontUpper", CubeListBuilder.create().texOffs(60, 55).addBox(-1.1387F, -1.0378F, -0.6672F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.1F, -1.3F, -0.1826F, 0.2781F, -0.2766F));
        ...
        PartDefinition legRightCenterRearUpper = bodyMain.addOrReplaceChild("legRightCenterRearUpper", CubeListBuilder.create().texOffs(34, 43).addBox(-7.0745F, -0.9815F, -0.8018F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 1.2125F, -0.3F, -0.0017F, 0.2709F, 0.2255F));
        ...
        PartDefinition legLeftCenterRearUpper = bodyMain.addOrReplaceChild("legLeftCenterRearUpper", CubeListBuilder.create().texOffs(34, 47).addBox(-0.8729F, -0.9684F, -0.662F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.2125F, -0.3F, -0.0017F, -0.2622F, -0.2255F));
