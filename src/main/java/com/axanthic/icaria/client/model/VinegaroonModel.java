...
public class VinegaroonModel extends HierarchicalModel<VinegaroonEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyMain = partDefinition.addOrReplaceChild("bodyMain", CubeListBuilder.create().texOffs(56, 0).addBox(-4.5F, -3.5F, -4.0F, 9.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 15.7F, 0.0F));
        PartDefinition headMain = bodyMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(0, 24).addBox(-4.0F, -2.95F, -7.0125F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5625F, -3.9875F));
        ...
        PartDefinition armRightRear = headMain.addOrReplaceChild("armRightRear", CubeListBuilder.create().texOffs(0, 55).addBox(-6.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 0.0375F, -6.0125F, 0.0F, -0.3F, 0.0F));
        PartDefinition armRightCenter = armRightRear.addOrReplaceChild("armRightCenter", CubeListBuilder.create().texOffs(40, 45).addBox(-7.0383F, -2.0F, -1.5747F, 7.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.8625F, 0.0F, 0.8875F, 0.0F, -1.0472F, 0.0F));
        PartDefinition armRightFront = armRightCenter.addOrReplaceChild("armRightFront", CubeListBuilder.create().texOffs(74, 61).addBox(-3.9112F, -2.0F, -1.2519F, 5.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0508F, 0.0125F, -0.0247F, 0.0F, -1.0472F, 0.0F));
        ...
        PartDefinition armLeftRear = headMain.addOrReplaceChild("armLeftRear", CubeListBuilder.create().texOffs(18, 55).addBox(0.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 0.05F, -6.0125F, 0.0F, 0.3F, 0.0F));
        PartDefinition armLeftCenter = armLeftRear.addOrReplaceChild("armLeftCenter", CubeListBuilder.create().texOffs(60, 45).addBox(0.015F, -2.0F, -1.5901F, 7.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.8875F, 0.0F, 0.875F, 0.0F, 1.0472F, 0.0F));
        PartDefinition armLeftFront = armLeftCenter.addOrReplaceChild("armLeftFront", CubeListBuilder.create().texOffs(60, 61).addBox(-1.1025F, -2.0F, -1.2006F, 5.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.99F, 0.0125F, -0.0776F, 0.0F, 1.0472F, 0.0F));
        ...
        PartDefinition bodyRear = bodyMain.addOrReplaceChild("bodyRear", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -2.9625F, 0.0F, 10.0F, 6.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5375F, 3.0F));
        PartDefinition tailMain = bodyRear.addOrReplaceChild("tailMain", CubeListBuilder.create().texOffs(0, 67).addBox(-1.5F, -1.5F, -0.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0375F, 18.0F));
        PartDefinition tailFront = tailMain.addOrReplaceChild("tailFront", CubeListBuilder.create().texOffs(20, 45).addBox(-0.5F, -0.4698F, -0.1887F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0125F, 2.4875F, 0.1367F, 0.0F, 0.0F));
        ...
        PartDefinition legRightFrontUpper = bodyMain.addOrReplaceChild("legRightFrontUpper", CubeListBuilder.create().texOffs(30, 24).addBox(-14.0F, -1.0F, -1.0F, 15.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 1.3F, -3.0F, 0.0F, -0.9638F, -0.4887F));
        ...
        PartDefinition legLeftFrontUpper = bodyMain.addOrReplaceChild("legLeftFrontUpper", CubeListBuilder.create().texOffs(30, 28).addBox(-1.0F, -1.0F, -1.0F, 15.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.3F, -3.0F, 0.0F, 0.9638F, 0.4887F));
        ...
        PartDefinition legRightCenterFrontUpper = bodyMain.addOrReplaceChild("legRightCenterFrontUpper", CubeListBuilder.create().texOffs(76, 55).addBox(-7.006F, -1.0243F, -1.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 1.3F, -1.3F, -0.0964F, -0.3076F, 0.2555F));
        ...
        PartDefinition legLeftCenterFrontUpper = bodyMain.addOrReplaceChild("legLeftCenterFrontUpper", CubeListBuilder.create().texOffs(0, 61).addBox(-0.994F, -1.0243F, -0.9999F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.3F, -1.3F, -0.0922F, 0.3075F, -0.2558F));
        ...
        PartDefinition legRightCenterRearUpper = bodyMain.addOrReplaceChild("legRightCenterRearUpper", CubeListBuilder.create().texOffs(36, 55).addBox(-7.006F, -1.0243F, -1.0001F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 1.3F, -0.3F, 0.092F, 0.3032F, 0.2554F));
        ...
        PartDefinition legLeftCenterRearUpper = bodyMain.addOrReplaceChild("legLeftCenterRearUpper", CubeListBuilder.create().texOffs(56, 55).addBox(-0.994F, -1.0243F, -1.0001F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.3F, -0.3F, 0.092F, -0.3032F, -0.2554F));
        ...
        PartDefinition legRightRearUpper = bodyMain.addOrReplaceChild("legRightRearUpper", CubeListBuilder.create().texOffs(20, 61).addBox(-7.0056F, -1.0244F, -1.0001F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 1.0375F, 1.5F, 0.2664F, 0.9177F, 0.375F));
        ...
        PartDefinition legLeftRearUpper = bodyMain.addOrReplaceChild("legLeftRearUpper", CubeListBuilder.create().texOffs(40, 61).addBox(-0.9944F, -1.0244F, -1.0001F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 1.05F, 1.3F, 0.2664F, -0.9177F, -0.375F));
