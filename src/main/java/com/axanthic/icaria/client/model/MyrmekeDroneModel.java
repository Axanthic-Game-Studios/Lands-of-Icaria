...
public class MyrmekeDroneModel extends EntityModel<MyrmekeDroneEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        abdomen.addOrReplaceChild("ABDOMEN0", CubeListBuilder.create().texOffs(32, 19).addBox(-2.002F, 0.4142F, -1.2929F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3F, 1.8F, -0.7854F, 0.0F, 0.0F));
        abdomen.addOrReplaceChild("ABDOMEN1", CubeListBuilder.create().texOffs(27, 10).addBox(-1.997F, -1.7375F, -0.8078F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.3F, 4.8F, -0.48F, 0.0F, 0.0F));
        abdomen.addOrReplaceChild("ABDOMEN2", CubeListBuilder.create().texOffs(0, 26).addBox(-1.978F, -1.0698F, 0.0742F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.02F, 1.4921F, 3.8831F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition L1 = leg_left_front.addOrReplaceChild("L0", CubeListBuilder.create().texOffs(0, 31).addBox(-0.5F, -0.3F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -0.2F, 0.0F, 0.0F, -0.7854F));
        PartDefinition L2 = L1.addOrReplaceChild("L1", CubeListBuilder.create().texOffs(29, 30).addBox(0.6025F, -0.614F, -0.301F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));
        PartDefinition L3 = L2.addOrReplaceChild("L2", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L3.addOrReplaceChild("L2R0", CubeListBuilder.create().texOffs(7, 37).addBox(-0.2889F, -0.8F, -0.298F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
        ...
        PartDefinition L4 = leg_left_center.addOrReplaceChild("L3", CubeListBuilder.create().texOffs(30, 24).addBox(-0.5F, -0.3F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -0.5F, 0.0F, 0.0F, -0.7854F));
        PartDefinition L5 = L4.addOrReplaceChild("L4", CubeListBuilder.create().texOffs(30, 22).addBox(0.6025F, -0.614F, -0.001F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));
        PartDefinition L6 = L5.addOrReplaceChild("L5", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L6.addOrReplaceChild("L5R0", CubeListBuilder.create().texOffs(0, 36).addBox(-0.2889F, -0.8F, 0.002F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
        ...
        PartDefinition L7 = leg_right_center.addOrReplaceChild("L6", CubeListBuilder.create().texOffs(30, 4).addBox(-0.5F, -0.3F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -0.5F, 0.0F, 0.0F, -0.7854F));
        PartDefinition L8 = L7.addOrReplaceChild("L7", CubeListBuilder.create().texOffs(18, 29).addBox(0.6025F, -0.614F, -0.001F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));
        PartDefinition L9 = L8.addOrReplaceChild("L8", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L9.addOrReplaceChild("L8R0", CubeListBuilder.create().texOffs(31, 35).addBox(-0.2889F, -0.8F, 0.002F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
        ...
        PartDefinition L10 = leg_left_back.addOrReplaceChild("L9", CubeListBuilder.create().texOffs(29, 14).addBox(-0.5F, -0.3F, 0.2F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -0.7F, 0.0F, 0.0F, -0.7854F));
        PartDefinition L11 = L10.addOrReplaceChild("L10", CubeListBuilder.create().texOffs(29, 2).addBox(0.6025F, -0.614F, 0.21F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));
        PartDefinition L12 = L11.addOrReplaceChild("L11", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L12.addOrReplaceChild("L11R0", CubeListBuilder.create().texOffs(23, 35).addBox(-0.2889F, -0.8F, 0.202F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
        ...
        PartDefinition L13 = leg_right_back.addOrReplaceChild("L12", CubeListBuilder.create().texOffs(26, 27).addBox(-0.5F, -0.3F, 0.2F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -0.7F, 0.0F, 0.0F, -0.7854F));
        PartDefinition L14 = L13.addOrReplaceChild("L13", CubeListBuilder.create().texOffs(14, 27).addBox(0.6025F, -0.614F, 0.21F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));
        PartDefinition L15 = L14.addOrReplaceChild("L14", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L15.addOrReplaceChild("L14R0", CubeListBuilder.create().texOffs(15, 35).addBox(-0.2889F, -0.8F, 0.202F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
        ...
        PartDefinition L16 = leg_right_front.addOrReplaceChild("L15", CubeListBuilder.create().texOffs(27, 7).addBox(-0.5F, -0.3F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -0.2F, 0.0F, 0.0F, -0.7854F));
        PartDefinition L17 = L16.addOrReplaceChild("L16", CubeListBuilder.create().texOffs(27, 0).addBox(0.6025F, -0.614F, -0.301F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.7453F));
        PartDefinition L18 = L17.addOrReplaceChild("L17", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L18.addOrReplaceChild("L17R0", CubeListBuilder.create().texOffs(7, 35).addBox(-0.2889F, -0.8F, -0.298F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
