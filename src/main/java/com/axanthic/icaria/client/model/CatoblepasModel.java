...
public class CatoblepasModel extends EntityModel<CatoblepasRenderState> {
	...
	public void setupAnim(CatoblepasRenderState pRenderState) {
		...
		IcariaClientHelper.anim(IcariaAnimationDefinitions.CATOBLEPAS_ATTACK, pRenderState.attackAnimationState, pRenderState.ageInTicks, this.root);
		IcariaClientHelper.anim(IcariaAnimationDefinitions.CATOBLEPAS_EATING, pRenderState.eatingAnimationState, pRenderState.ageInTicks, this.root);
	...
	public static LayerDefinition createLayer() {
		...
		var skull = head.addOrReplaceChild("skull", CubeListBuilder.create().texOffs(12, 31).addBox(-3.0F, -3.5F, -6.0F, 6.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.25F, -3.0F, 0.3927F, 0.0F, 0.0F));
		...
		var hornRightBaby = skull.addOrReplaceChild("hornRightBaby", CubeListBuilder.create().texOffs(0, 7).addBox(6.3F, -0.5F, 1.5F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.8F, -6.0F, -3.225F, 0.0F, 0.2731F, 2.6721F));
		...
		var hornLeftTeen = skull.addOrReplaceChild("hornLeftTeen", CubeListBuilder.create().texOffs(113, 17).addBox(2.8F, -0.5F, 0.4F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.675F, -4.375F, -3.625F, 0.0F, 0.2731F, 0.4554F));
		var hornLeftTeenCenter = hornLeftTeen.addOrReplaceChild("hornLeftTeenCenter", CubeListBuilder.create().texOffs(0, 10).addBox(0.0F, -0.5F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.3F, 0.0F, 2.5F, 0.0F, 0.5463F, 0.1367F));
		...
		var hornRightAdult = skull.addOrReplaceChild("hornRightAdult", CubeListBuilder.create().texOffs(97, 30).addBox(0.0F, -0.5F, -1.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -3.1F, -3.5F, 0.0F, 0.2731F, 2.6721F));
		...
		var hornLeftAdult = skull.addOrReplaceChild("hornLeftAdult", CubeListBuilder.create().texOffs(30, 31).addBox(0.0F, -0.5F, -1.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -3.1F, -3.5F, 0.0F, 0.2731F, 0.4554F));
		...
		var body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -4.95F, -7.325F, 9.0F, 8.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.9018F, 4.1216F, -0.0873F, 0.0F, 0.0F));
		...
		var udder = body.addOrReplaceChild("udder", CubeListBuilder.create().texOffs(31, 0).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.6683F, -0.5686F));
		...
		var legRightFront = partDefinition.addOrReplaceChild("legRightFront", CubeListBuilder.create().texOffs(0, 21).addBox(-4.0F, 0.0F, -2.0F, 4.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 8.666F, -6.7073F, 0.0911F, 0.0F, 0.0F));
		...
		var legLeftFront = partDefinition.addOrReplaceChild("legLeftFront", CubeListBuilder.create().texOffs(100, 17).addBox(0.0F, 0.0F, -2.0F, 4.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 8.666F, -6.7073F, 0.0911F, 0.0F, 0.0F));
		...
		var legRightRear = partDefinition.addOrReplaceChild("legRightRear", CubeListBuilder.create().texOffs(60, 15).addBox(-4.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 9.541F, 7.9619F, -0.0911F, 0.0F, 0.0F));
		...
		var legLeftRear = partDefinition.addOrReplaceChild("legLeftRear", CubeListBuilder.create().texOffs(44, 15).addBox(0.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 9.541F, 7.9619F, -0.0911F, 0.0F, 0.0F));
