...
public class LaurelForestHagModel extends EntityModel<LaurelForestHagRenderState> {
	...
	@Override
	public void setupAnim(LaurelForestHagRenderState pRenderState) {
	...
	public void lookAnim(float pXRot, float pYRot) {
		this.headMain.xRot = IcariaMath.rad(pXRot) - 0.9163F;
	...
	public void walkAnim(float pWalkAnimationPos, float pWalkAnimationSpeed) {
		...
		this.armRightUpper.xRot = Mth.cos(pWalkAnimationPos * 0.6F + Mth.PI) * pWalkAnimationSpeed - 0.2731F;
		this.armRightLower.xRot = Mth.cos(pWalkAnimationPos * 0.6F + Mth.PI) * pWalkAnimationSpeed - pWalkAnimationSpeed - 0.1367F;
		...
		this.armLeftUpper.xRot = Mth.cos(pWalkAnimationPos * 0.6F) * pWalkAnimationSpeed - 0.1499F;
		...
		this.legLeft.xRot = Mth.sin(pWalkAnimationPos * 0.6F) * pWalkAnimationSpeed + pWalkAnimationSpeed + 0.0873F;
	}
