...
public class LaurelForestHagModel extends HierarchicalModel<ForestHagEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition shoulderRightShroomBase = shoulderRight.addOrReplaceChild("shoulderRightShroomBase", CubeListBuilder.create(), PartPose.offsetAndRotation(-25.0F, 10.525F, -6.55F, 0.0F, 1.5708F, 0.0F));
        PartDefinition shoulderRightShroomMain = shoulderRightShroomBase.addOrReplaceChild("shoulderRightShroomMain", CubeListBuilder.create().texOffs(59, 9).addBox(-9.5F, -14.0F, 12.0F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition armRightShroomBase = armRightUpper.addOrReplaceChild("armRightShroomBase", CubeListBuilder.create(), PartPose.offsetAndRotation(-18.0219F, 18.4876F, -6.7592F, 0.0F, 1.5708F, 0.0F));
        PartDefinition armRightShroomMain = armRightShroomBase.addOrReplaceChild("armRightShroomMain", CubeListBuilder.create().texOffs(65, 0).addBox(-8.8F, -13.0F, 14.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition armLeftUpper = shoulderLeft.addOrReplaceChild("armLeftUpper", CubeListBuilder.create().texOffs(33, 72).addBox(-1.6843F, -1.5413F, -1.3765F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.8561F, -1.8509F, -0.162F, -0.1499F, 0.0246F, -0.7481F));
        ...
        PartDefinition thighRight = bodyMain.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(67, 40).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 3.7F, 0.0F, -0.0873F, 0.0911F, 0.0F));
        PartDefinition legRight = thighRight.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(73, 48).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.9F, 0.0F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition thighLeft = bodyMain.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(58, 66).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 3.7F, 0.0F, -0.0873F, -0.0911F, -0.0873F));
        PartDefinition legLeft = thighLeft.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(71, 73).addBox(-1.5F, 0.5F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, 0.0F, 0.0873F, 0.0F, 0.0F));
        PartDefinition footLeft = legLeft.addOrReplaceChild("footLeft", CubeListBuilder.create().texOffs(60, 23).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.6F, 0.0F, 0.0873F, -0.0911F, 0.0436F));
