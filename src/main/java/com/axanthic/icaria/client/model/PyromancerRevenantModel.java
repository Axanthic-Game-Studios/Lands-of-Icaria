...
public class PyromancerRevenantModel extends EntityModel<PyromancerRevenantRenderState> implements ArmedModel<PyromancerRevenantRenderState> {
	...
	@Override
	public void setupAnim(PyromancerRevenantRenderState pRenderState) {
		...
		IcariaClientHelper.anim(IcariaAnimationDefinitions.PYROMANCER_REVENANT_RELOAD, pRenderState.reloadAnimationState, pRenderState.ageInTicks, this.root);
		IcariaClientHelper.anim(IcariaAnimationDefinitions.PYROMANCER_REVENANT_THROWN, pRenderState.thrownAnimationState, pRenderState.ageInTicks, this.root);
	}
	...
	@Override
	public void translateToHand(PyromancerRevenantRenderState pRenderState, HumanoidArm pHumanoidArm, PoseStack pPoseStack) {
