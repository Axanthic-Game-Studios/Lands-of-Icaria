...
public class MyrmekeQueenModel extends EntityModel<MyrmekeQueenEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition body_head = partdefinition.addOrReplaceChild("body_head", CubeListBuilder.create().texOffs(37, 9).addBox(-1.5F, -0.7F, -2.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 5).addBox(-1.5F, -1.7F, -1.0F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 19.2F, -4.0F));
        ...
        body_head.addOrReplaceChild("B0H1", CubeListBuilder.create().texOffs(32, 16).addBox(-2.001F, 1.6481F, -0.0735F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -1.9539F, -0.6313F, -0.7418F, 0.0F, 0.0F));
        PartDefinition head = body_head.addOrReplaceChild("head", CubeListBuilder.create().texOffs(42, 21).addBox(-3.0F, -1.0F, -2.0F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 15).addBox(-2.99F, 0.0F, -6.0F, 6.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 26).addBox(-3.5F, -0.5F, -4.0F, 7.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.2F, -2.0F, 0.2618F, 0.0F, 0.0F));
        head.addOrReplaceChild("mandible_left", CubeListBuilder.create().texOffs(23, 37).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 1.3F, -6.0F, 0.0F, 0.1309F, 0.0F));
        head.addOrReplaceChild("mandible_right", CubeListBuilder.create().texOffs(36, 27).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 1.3F, -6.0F, 0.0F, -0.1309F, 0.0F));
        head.addOrReplaceChild("antenna_left", CubeListBuilder.create().texOffs(15, 37).addBox(-0.5F, -4.5F, -1.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 26).addBox(-0.5F, -4.5F, -5.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.3F, -4.0F, 0.1745F, 0.0F, 0.4363F));
        head.addOrReplaceChild("antenna_right", CubeListBuilder.create().texOffs(19, 37).addBox(-0.5F, -4.5F, -1.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 17).addBox(-0.5F, -4.5F, -5.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.3F, -4.0F, 0.1745F, 0.0F, -0.4363F));
        head.addOrReplaceChild("H0", CubeListBuilder.create().texOffs(44, 10).addBox(-3.01F, -1.9201F, -0.897F, 6.0F, 4.0F, 1.0F, new CubeDeformation(0.01F)).texOffs(50, 5).addBox(-1.0F, -1.9093F, -1.3681F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, 0.3033F, -3.6881F, -1.3526F, 0.0F, 0.0F));
        PartDefinition body_thorax = partdefinition.addOrReplaceChild("body_thorax", CubeListBuilder.create().texOffs(37, 36).addBox(-2.0F, -2.3571F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 19.3571F, -2.0F));
        ...
        body_thorax.addOrReplaceChild("B1T2", CubeListBuilder.create().texOffs(57, 0).addBox(-2.9517F, -2.5942F, -5.2266F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, 1.0908F, 0.0F));
        body_thorax.addOrReplaceChild("B1T3", CubeListBuilder.create().texOffs(41, 0).addBox(-6.6527F, -2.5942F, -0.8316F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, 1.0908F, 0.0F));
        body_thorax.addOrReplaceChild("B1T4", CubeListBuilder.create().texOffs(47, 0).addBox(0.9597F, -2.5942F, 6.2627F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, -1.0908F, 0.0F));
        body_thorax.addOrReplaceChild("B1T5", CubeListBuilder.create().texOffs(53, 0).addBox(-1.7414F, -2.5942F, 1.8677F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, -1.0908F, 0.0F));
        PartDefinition thorax = partdefinition.addOrReplaceChild("thorax", CubeListBuilder.create().texOffs(0, 33).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 19.5F, 3.0F, -0.0873F, 0.0F, 0.0F));
        PartDefinition body_abdomen = partdefinition.addOrReplaceChild("body_abdomen", CubeListBuilder.create().texOffs(40, 29).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 19.5F, 0.0F));
        body_abdomen.addOrReplaceChild("B2A0", CubeListBuilder.create().texOffs(21, 23).addBox(-1.499F, -5.8955F, -6.9095F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.5F, 6.0F, -0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition abdomen = thorax.addOrReplaceChild("abdomen", CubeListBuilder.create().texOffs(0, 43).addBox(-3.0F, -1.6142F, -0.4F, 6.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(30, 46).addBox(-3.001F, 2.0929F, 0.5929F, 6.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.3F, 0.7F));
        abdomen.addOrReplaceChild("A0", CubeListBuilder.create().texOffs(23, 41).addBox(-3.002F, 0.4142F, -1.2929F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3F, 1.8F, -0.7854F, 0.0F, 0.0F));
        abdomen.addOrReplaceChild("A1", CubeListBuilder.create().texOffs(21, 47).addBox(-2.997F, -4.3F, 2.1922F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.3F, 4.8F, -0.48F, 0.0F, 0.0F));
        abdomen.addOrReplaceChild("A2", CubeListBuilder.create().texOffs(21, 43).addBox(-2.978F, -2.0698F, 3.0742F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.02F, 1.4921F, 3.8831F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition L18 = L16.addOrReplaceChild("L18", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
        L18.addOrReplaceChild("L18R0", CubeListBuilder.create().texOffs(7, 35).addBox(-0.2889F, -0.8F, -0.298F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0684F, 0.2189F, -0.002F, 0.0F, 0.0F, 0.1309F));
    ...
    public void renderToBuffer(PoseStack pPoseStack, VertexConsumer pVertexConsumer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {
        ...
        body_abdomen.render(pPoseStack, pVertexConsumer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        thorax.render(pPoseStack, pVertexConsumer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        ...
        leg_right_center.render(pPoseStack, pVertexConsumer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        leg_left_back.render(pPoseStack, pVertexConsumer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        leg_right_back.render(pPoseStack, pVertexConsumer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        leg_right_front.render(pPoseStack, pVertexConsumer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
