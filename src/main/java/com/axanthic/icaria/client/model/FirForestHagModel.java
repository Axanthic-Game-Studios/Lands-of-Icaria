...
public class FirForestHagModel extends HierarchicalModel<ForestHagEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(IcariaInfo.MODID, "fir_forest_hag"), "main");
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyBase = partDefinition.addOrReplaceChild("bodyBase", CubeListBuilder.create().texOffs(42, 40).addBox(-6.5F, -1.0F, -2.5F, 13.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 4.0F, 1.7F, -0.1595F, 0.0436F, 0.0723F));
        PartDefinition bodyMain = bodyBase.addOrReplaceChild("bodyMain", CubeListBuilder.create().texOffs(0, 66).addBox(-5.5F, -1.0F, -2.0F, 11.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, -4.0F, -0.2F, 0.1023F, 0.0436F, 0.0723F));
        ...
        PartDefinition bodyLower = bodyMain.addOrReplaceChild("bodyLower", CubeListBuilder.create().texOffs(48, 51).addBox(-6.0F, -1.0F, -2.5F, 12.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3F, -5.0F, -0.2F, 0.1023F, 0.0436F, 0.0723F));
        ...
        PartDefinition bodyCenter = bodyLower.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(32, 28).addBox(-6.5F, -1.0F, -3.0F, 13.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4F, -2.2F, -1.5F, 0.2768F, 0.0436F, -0.1023F));
        ...
        PartDefinition bodyUpper = bodyCenter.addOrReplaceChild("bodyUpper", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, 0.0F, -4.0F, 16.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4F, -4.0F, -0.5F, 0.1895F, 0.0436F, -0.1023F));
        PartDefinition shoulderRight = bodyUpper.addOrReplaceChild("shoulderRight", CubeListBuilder.create().texOffs(32, 14).addBox(-9.0F, -3.0F, -6.0F, 13.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 3.5F, 2.0F, 0.015F, -0.3927F, -0.015F));
        PartDefinition armRightUpper = shoulderRight.addOrReplaceChild("armRightUpper", CubeListBuilder.create().texOffs(54, 72).addBox(-3.0F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -1.0F, -2.0F, -0.5236F, 0.0873F, 0.4427F));
        ...
        PartDefinition shoulderLeft = bodyUpper.addOrReplaceChild("shoulderLeft", CubeListBuilder.create().texOffs(0, 45).addBox(0.0F, -3.0F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 4.0F, 0.5F, 0.015F, 0.3927F, -0.015F));
        PartDefinition armLeftUpper = shoulderLeft.addOrReplaceChild("armLeftUpper", CubeListBuilder.create().texOffs(12, 75).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -1.5F, 0.0F, -0.3491F, -0.5236F, -0.1373F));
        ...
        PartDefinition neckMain = bodyUpper.addOrReplaceChild("neckMain", CubeListBuilder.create().texOffs(21, 40).addBox(-2.5F, -5.0F, -9.5F, 5.0F, 5.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 5.0F, -2.0F, -0.7704F, 0.0873F, -0.1895F));
        ...
        PartDefinition headMain = neckMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(30, 66).addBox(-3.0F, -4.0F, -6.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -3.0F, -6.5F, 0.3491F, -0.4363F, 0.1745F));
        PartDefinition beardMain = headMain.addOrReplaceChild("beardMain", CubeListBuilder.create().texOffs(48, 62).addBox(-4.0F, 0.0F, -4.0F, 7.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3F, 4.05F, -3.0F, 0.0F, -0.0873F, 0.0F));
        PartDefinition beardUpper = beardMain.addOrReplaceChild("beardUpper", CubeListBuilder.create().texOffs(72, 28).addBox(-3.0F, 0.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3F, 1.0F, 0.0F, 0.0586F, -0.1745F, -0.0586F));
        PartDefinition beardCenter = beardUpper.addOrReplaceChild("beardCenter", CubeListBuilder.create().texOffs(79, 81).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, 2.0F, 0.0F, 0.0586F, -0.0873F, -0.0586F));
        PartDefinition beardLower = beardCenter.addOrReplaceChild("beardLower", CubeListBuilder.create().texOffs(32, 20).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2F, 3.0F, 0.0F, 0.0586F, -0.1745F, -0.0586F));
        ...
        PartDefinition shroomRightStem = bodyUpper.addOrReplaceChild("shroomRightStem", CubeListBuilder.create().texOffs(82, 51).addBox(-1.0F, -8.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.0F, 1.0F, 4.0F, -0.5959F, -0.3927F, -0.015F));
        ...
        PartDefinition shroomCenterStem = bodyUpper.addOrReplaceChild("shroomCenterStem", CubeListBuilder.create().texOffs(24, 78).addBox(-1.0F, -8.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -1.0F, 0.015F, 0.3927F, -0.015F));
        ...
        PartDefinition shroomLeftStem = bodyUpper.addOrReplaceChild("shroomLeftStem", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 1.5F, -1.0F, -0.1595F, 0.1745F, 0.3777F));
        ...
        PartDefinition thighRight = bodyBase.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(0, 75).addBox(-3.0F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0375F, 2.4125F, 0.025F, -0.1023F, 0.0436F, -0.0723F));
        PartDefinition legRight = thighRight.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(0, 53).addBox(-3.0F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 7.0F, 0.0F, 0.0873F, -0.0873F, 0.0F));
        PartDefinition footRight = legRight.addOrReplaceChild("footRight", CubeListBuilder.create().texOffs(15, 45).addBox(-1.5F, 0.0F, -1.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 7.5F, -0.5F, 0.1745F, 0.1745F, 0.0F));
        ...
        PartDefinition thighLeft = bodyBase.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(66, 74).addBox(0.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5125F, 2.9F, -0.125F, -0.1023F, -0.1309F, -0.0723F));
        PartDefinition legLeft = thighLeft.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(77, 0).addBox(0.0F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 5.0F, 0.0F, 0.0873F, 0.0873F, 0.0F));
        PartDefinition kneeLeft = legLeft.addOrReplaceChild("kneeLeft", CubeListBuilder.create().texOffs(24, 56).addBox(0.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 3.0F, 0.0F, 0.0873F, 0.0F, 0.0F));
        PartDefinition footLeft = kneeLeft.addOrReplaceChild("footLeft", CubeListBuilder.create().texOffs(41, 0).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 4.4F, 0.0F, 0.0873F, 0.0873F, 0.0F));
