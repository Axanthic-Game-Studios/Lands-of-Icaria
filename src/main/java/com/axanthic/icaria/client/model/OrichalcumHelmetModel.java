...
public class OrichalcumHelmetModel<T extends HumanoidRenderState> extends HumanoidModel<T> {
	...
	public static LayerDefinition createLayer() {
		...
		var helmet = partDefinition.getChild("head").addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)), PartPose.ZERO);
