...
public class PlaneForestHagModel extends HierarchicalModel<ForestHagEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(IcariaInfo.MODID, "plane_forest_hag"), "main");
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyBase = partDefinition.addOrReplaceChild("bodyBase", CubeListBuilder.create().texOffs(21, 25).addBox(-5.5F, 0.0F, -2.5F, 11.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.8F, 0.0F, -0.0873F, 0.0F, 0.0F));
        PartDefinition bodyMain = bodyBase.addOrReplaceChild("bodyMain", CubeListBuilder.create().texOffs(48, 20).addBox(-4.6F, 0.0F, -1.7F, 10.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.4F, 0.0F, -0.0723F, 0.0F, 0.0723F));
        PartDefinition bodyLower = bodyMain.addOrReplaceChild("bodyLower", CubeListBuilder.create().texOffs(11, 50).addBox(-3.9F, 0.0F, -1.2F, 9.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.4F, 0.0F, 0.015F, 0.0F, 0.0723F));
        PartDefinition bodyCenterRight = bodyLower.addOrReplaceChild("bodyCenterRight", CubeListBuilder.create().texOffs(0, 56).addBox(-5.2F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 0.1023F, 0.0F, -0.2881F));
        ...
        PartDefinition bodyCenterLeft = bodyLower.addOrReplaceChild("bodyCenterLeft", CubeListBuilder.create().texOffs(31, 52).addBox(0.6F, 0.0F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.9F, 0.0F, 0.1023F, 0.0F, 0.0723F));
        PartDefinition bodyUpperLeft = bodyCenterLeft.addOrReplaceChild("bodyUpperLeft", CubeListBuilder.create().texOffs(47, 47).addBox(0.5F, 0.0F, -2.8F, 6.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.3F, -1.3F, 0.0F, 0.1023F, 0.0F, -0.3641F));
        PartDefinition shoulderMain = bodyUpperLeft.addOrReplaceChild("shoulderMain", CubeListBuilder.create().texOffs(0, 0).addBox(-5.7F, 0.0F, -3.0F, 13.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.6F, -0.7F, 0.1023F, 0.0F, 0.0723F));
        PartDefinition shoulderRight = shoulderMain.addOrReplaceChild("shoulderRight", CubeListBuilder.create().texOffs(52, 29).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.4F, 0.3F, 0.1F, -0.4554F, 0.7854F, -0.0411F));
        PartDefinition armRightUpper = shoulderRight.addOrReplaceChild("armRightUpper", CubeListBuilder.create().texOffs(16, 64).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.8F, 3.5F, -0.8F, 0.015F, 0.7854F, -0.015F));
        ...
        PartDefinition shoulderLeft = shoulderMain.addOrReplaceChild("shoulderLeft", CubeListBuilder.create().texOffs(44, 0).addBox(-2.5F, 0.0F, -2.5F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.5F, -1.0F, 0.8F, -0.5009F, 0.7854F, -0.5054F));
        PartDefinition armLeftUpper = shoulderLeft.addOrReplaceChild("armLeftUpper", CubeListBuilder.create().texOffs(24, 64).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7F, 5.5F, 0.8F, -0.0723F, 0.5812F, -0.1546F));
        ...
        PartDefinition neckMain = shoulderMain.addOrReplaceChild("neckMain", CubeListBuilder.create().texOffs(32, 60).addBox(-1.5F, -6.4F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6F, 0.8F, -0.5F, 0.8877F, 0.0873F, -0.015F));
        PartDefinition neckLeavesUpper = neckMain.addOrReplaceChild("neckLeavesUpper", CubeListBuilder.create().texOffs(14, 34).addBox(-3.5F, -6.4F, -1.5F, 7.0F, 13.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.4F, 2.7F, 0.015F, 0.0F, 0.0306F));
        ...
        PartDefinition bodyMainWoodMain = bodyMain.addOrReplaceChild("bodyMainWoodMain", CubeListBuilder.create().texOffs(44, 63).addBox(-5.3F, -7.2F, -1.5F, 1.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.2F, 0.0F, 0.0586F, 0.0F, -0.1459F));
        ...
        PartDefinition thighRight = bodyBase.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(57, 59).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 3.5F, 0.0F, -0.0873F, 0.0436F, 0.0436F));
        PartDefinition legRight = thighRight.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(32, 0).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.8F, 0.0F, 0.0F, 0.0436F, 0.0436F));
        PartDefinition kneeRight = legRight.addOrReplaceChild("kneeRight", CubeListBuilder.create().texOffs(52, 66).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.7F, 0.0F, 0.0873F, -0.0436F, 0.0F));
        PartDefinition footRight = kneeRight.addOrReplaceChild("footRight", CubeListBuilder.create().texOffs(65, 9).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.8F, 0.0F, 0.0F, -0.0436F, -0.0436F));
        ...
        PartDefinition thighLeft = bodyBase.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(52, 38).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 3.5F, 0.0F, -0.0873F, -0.0436F, -0.0436F));
        PartDefinition legLeft = thighLeft.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(62, 0).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.8F, 0.0F, 0.0F, 0.0436F, 0.0436F));
        PartDefinition kneeLeftRight = legLeft.addOrReplaceChild("kneeLeftRight", CubeListBuilder.create().texOffs(64, 66).addBox(-1.3F, 0.0F, -1.2F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.7F, 0.0F, 0.0873F, -0.0873F, 0.0F));
        ...
        PartDefinition footLeft = kneeLeftRight.addOrReplaceChild("footLeft", CubeListBuilder.create().texOffs(64, 46).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.8F, 0.0F, 0.0F, 0.0436F, 0.0F));
