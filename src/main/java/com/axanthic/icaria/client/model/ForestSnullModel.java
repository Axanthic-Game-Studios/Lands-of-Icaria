...
public class ForestSnullModel extends EntityModel<ForestSnullRenderState> {
	...
	public void setupAnim(ForestSnullRenderState pRenderState) {
		...
		IcariaClientHelper.anim(IcariaAnimationDefinitions.FOREST_SNULL_HIDE, pRenderState.hideAnimationState, pRenderState.ageInTicks, this.root);
		IcariaClientHelper.anim(IcariaAnimationDefinitions.FOREST_SNULL_HURT, pRenderState.hurtAnimationState, pRenderState.ageInTicks, this.root);
		IcariaClientHelper.anim(IcariaAnimationDefinitions.FOREST_SNULL_IDLE, pRenderState.idleAnimationState, pRenderState.ageInTicks, this.root);
		IcariaClientHelper.anim(IcariaAnimationDefinitions.FOREST_SNULL_MOVE, pRenderState.moveAnimationState, pRenderState.ageInTicks, this.root);
		IcariaClientHelper.anim(IcariaAnimationDefinitions.FOREST_SNULL_SHOW, pRenderState.showAnimationState, pRenderState.ageInTicks, this.root);
	}
	...
	public static LayerDefinition createLayer() {
		...
		var bodyFrontLower = bodyFront.addOrReplaceChild("bodyFrontLower", CubeListBuilder.create().texOffs(33, 38).addBox(-2.49F, -4.0F, -3.0F, 5.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, -0.3927F, 0.0F, 0.0F));
		var bodyFrontCenter = bodyFrontLower.addOrReplaceChild("bodyFrontCenter", CubeListBuilder.create().texOffs(36, 31).addBox(-2.48F, -4.0F, -3.0F, 5.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -3.0F, -0.3927F, 0.0F, 0.0F));
		var bodyFrontUpper = bodyFrontCenter.addOrReplaceChild("bodyFrontUpper", CubeListBuilder.create().texOffs(0, 36).addBox(-2.47F, -4.0F, -3.0F, 5.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -3.0F, -0.3927F, 0.0F, 0.0F));
		...
		var head = bodyFrontUpper.addOrReplaceChild("head", CubeListBuilder.create().texOffs(27, 0).addBox(-2.46F, 0.0F, -4.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -3.0F, 0.1963F, 0.0F, 0.0F));
		var headFeelerRight = head.addOrReplaceChild("headFeelerRight", CubeListBuilder.create().texOffs(46, 23).addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 3.0F, -4.0F, 0.2618F, 0.0F, 0.7854F));
		...
		var headFeelerLeft = head.addOrReplaceChild("headFeelerLeft", CubeListBuilder.create().texOffs(12, 46).addBox(-0.5F, -0.5F, -3.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 3.0F, -4.0F, 0.2618F, 0.0F, -0.7854F));
		...
		var bodyCenter = partDefinition.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(0, 10).addBox(-3.0F, -5.0F, -4.0F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		var bodyCenterShroomFront = partDefinition.addOrReplaceChild("bodyCenterShroomFront", CubeListBuilder.create().texOffs(24, 39).addBox(-2.5F, 0.0F, -1.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 19.25F, -4.0F));
		...
		var bodyCenterShroomRight = partDefinition.addOrReplaceChild("bodyCenterShroomRight", CubeListBuilder.create().texOffs(18, 29).addBox(0.0F, -5.0F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 22.0F, -3.0F, 0.0F, 0.0F, -0.6109F));
		...
		var bodyCenterShroomLeftFront = partDefinition.addOrReplaceChild("bodyCenterShroomLeftFront", CubeListBuilder.create().texOffs(44, 40).addBox(2.5F, -2.5F, -6.0F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		var bodyCenterShroomLeftRear = partDefinition.addOrReplaceChild("bodyCenterShroomLeftRear", CubeListBuilder.create().texOffs(32, 10).addBox(2.0F, -2.0F, 0.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		var bodySkull = partDefinition.addOrReplaceChild("bodySkull", CubeListBuilder.create().texOffs(22, 17).addBox(-2.99F, -9.0F, 0.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 20.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
		var skullFeelerRight = bodySkull.addOrReplaceChild("skullFeelerRight", CubeListBuilder.create().texOffs(34, 45).addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -4.5F, 0.0F, -0.2618F, 0.1745F, 0.0F));
		...
		var skullFeelerLeft = bodySkull.addOrReplaceChild("skullFeelerLeft", CubeListBuilder.create().texOffs(45, 0).addBox(-0.5F, -0.5F, -3.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, -4.5F, 0.0F, -0.2618F, -0.1745F, 0.0F));
		...
		var bodyRear = partDefinition.addOrReplaceChild("bodyRear", CubeListBuilder.create().texOffs(18, 31).addBox(-2.5F, -4.0F, 0.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 4.0F));
		var bodyRearFront = bodyRear.addOrReplaceChild("bodyRearFront", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, -3.99F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 0.0F, 4.0F));
		var bodyRearCenter = bodyRearFront.addOrReplaceChild("bodyRearCenter", CubeListBuilder.create().texOffs(12, 39).addBox(-2.0F, -3.01F, -0.2F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 0.0F, 0.0F, 0.0F, 0.0087F, 0.0F));
		...
		var bodyRearShroom = partDefinition.addOrReplaceChild("bodyRearShroom", CubeListBuilder.create().texOffs(26, 44).addBox(-0.5F, -10.8F, 0.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 20.0F, 6.0F, -0.2618F, 0.0F, 0.1745F));
