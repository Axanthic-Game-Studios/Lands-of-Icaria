...
public class SolifugaeModel extends HierarchicalModel<SolifugaeEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition headMain = bodyMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(54, 27).addBox(-5.0F, -4.0832F, -7.981F, 10.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, -3.9375F, -0.085F, 0.0F, 0.0F));
        ...
        PartDefinition jawMain = headMain.addOrReplaceChild("jawMain", CubeListBuilder.create().texOffs(0, 43).addBox(-3.95F, -2.958F, -4.4308F, 8.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.05F, -0.1207F, -8.006F, 0.096F, 0.0F, 0.0F));
        PartDefinition mouthMain = jawMain.addOrReplaceChild("mouthMain", CubeListBuilder.create().texOffs(28, 58).addBox(-2.9F, -2.6875F, -3.0F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.05F, 0.2295F, -4.4308F));
        ...
        PartDefinition legRightFrontUpper = bodyMain.addOrReplaceChild("legRightFrontUpper", CubeListBuilder.create().texOffs(60, 66).addBox(-7.0053F, -1.0244F, -1.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 0.05F, -4.0F, -0.2233F, -0.7864F, 0.3079F));
        ...
        PartDefinition legLeftFrontUpper = bodyMain.addOrReplaceChild("legLeftFrontUpper", CubeListBuilder.create().texOffs(0, 66).addBox(-0.994F, -1.0243F, -0.9999F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 0.075F, -4.0F, -0.2445F, 0.7811F, -0.3441F));
        ...
        PartDefinition legRightCenterFrontUpper = bodyMain.addOrReplaceChild("legRightCenterFrontUpper", CubeListBuilder.create().texOffs(66, 58).addBox(-7.0057F, -1.0243F, -1.0001F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 0.3F, -2.3F, -0.0945F, -0.2698F, 0.2376F));
        ...
        PartDefinition legLeftCenterFrontUpper = bodyMain.addOrReplaceChild("legLeftCenterFrontUpper", CubeListBuilder.create().texOffs(20, 66).addBox(-0.9943F, -1.0243F, -1.0001F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 0.3F, -2.3F, -0.0944F, 0.2654F, -0.2372F));
        ...
        PartDefinition legRightCenterRearUpper = bodyMain.addOrReplaceChild("legRightCenterRearUpper", CubeListBuilder.create().texOffs(46, 62).addBox(-7.0057F, -1.0243F, -0.9999F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 0.3F, -1.3F, 0.0946F, 0.2741F, 0.2381F));
        ...
        PartDefinition legLeftCenterRearUpper = bodyMain.addOrReplaceChild("legLeftCenterRearUpper", CubeListBuilder.create().texOffs(46, 58).addBox(-0.9943F, -1.0243F, -0.9999F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 0.3F, -1.3F, 0.0946F, -0.2741F, -0.2381F));
        ...
        PartDefinition legRightRearUpper = bodyMain.addOrReplaceChild("legRightRearUpper", CubeListBuilder.create().texOffs(40, 66).addBox(-7.0053F, -1.0244F, -0.9999F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, 0.025F, 0.5F, 0.2227F, 0.781F, 0.304F));
        ...
        PartDefinition legLeftRearUpper = bodyMain.addOrReplaceChild("legLeftRearUpper", CubeListBuilder.create().texOffs(80, 66).addBox(-0.9947F, -1.0744F, -0.9999F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 0.1F, 0.3F, 0.2227F, -0.781F, -0.304F));
