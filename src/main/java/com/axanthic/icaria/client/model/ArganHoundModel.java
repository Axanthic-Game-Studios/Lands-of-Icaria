...
public class ArganHoundModel extends HierarchicalModel<ArganHoundEntity> {
    ...
    public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.withLength(0.25F).addAnimation("mouth", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM), new Keyframe(0.16667F, KeyframeAnimations.degreeVec(30.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM), new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM))).build();
    
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(IcariaInfo.MODID, "argan_hound"), "main");
    ...
    public void walkAnim(float pLimbSwing, float pLimbSwingAmount) {
        ...
        this.legRightFront.xRot = -Mth.cos(pLimbSwing * 0.5F) * 0.6F * pLimbSwingAmount + 0.091106186954104F;
        this.legRightFrontLower.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing)) * 0.5F) * this.kneebend * pLimbSwingAmount - this.kneebend * pLimbSwingAmount - 0.36425021489121656F;
        this.legLeftFront.xRot = -Mth.cos(pLimbSwing * 0.5F + Mth.PI) * 0.6F * pLimbSwingAmount + 0.091106186954104F;
        this.legLeftFrontLower.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + Mth.PI * 0.5F)) * 0.5F + Mth.PI) * this.kneebend * pLimbSwingAmount - this.kneebend * pLimbSwingAmount - 0.36425021489121656F;
        this.legRightRear.xRot = Mth.cos(pLimbSwing * 0.5F + Mth.PI * 1.5F) * 1.2F * pLimbSwingAmount - 0.091106186954104F;
        this.legRightRearLower.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + Mth.PI * 0.75F)) * 0.5F + Mth.PI * 1.5F) * this.kneebend * pLimbSwingAmount + this.kneebend * pLimbSwingAmount + 0.27314402793711257F;
        this.legLeftRear.xRot = Mth.cos(pLimbSwing * 0.5F + Mth.PI * 0.5F) * 1.2F * pLimbSwingAmount - 0.091106186954104F;
        this.legLeftRearLower.xRot = Mth.sin((pLimbSwing + Mth.sin(pLimbSwing + Mth.PI * 0.25F)) * 0.5F + Mth.PI * 0.5F) * this.kneebend * pLimbSwingAmount + this.kneebend * pLimbSwingAmount + 0.27314402793711257F;
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition head = partDefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(19, 28).addBox(-2.0F, -6.0F, -4.0F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 16.3433F, -6.0869F, -0.3016F, 0.0F, 0.0F));
        PartDefinition skull = head.addOrReplaceChild("skull", CubeListBuilder.create().texOffs(0, 48).addBox(-3.0F, -5.0F, -6.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, -1.0F, 0.3927F, 0.0F, 0.0F));
        PartDefinition nose = skull.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(43, 46).addBox(-2.0F, -1.025F, -4.925F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.975F, -5.075F));
        ...
        PartDefinition body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -16.1115F, -5.5236F, 8.0F, 9.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 23.7F, 0.0F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition spine = body.addOrReplaceChild("spine", CubeListBuilder.create().texOffs(0, 20).addBox(-1.5F, 0.0F, -9.0F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -17.329F, 2.1619F, 0.1571F, 0.0F, 0.0F));
        PartDefinition spineFront = spine.addOrReplaceChild("spineFront", CubeListBuilder.create().texOffs(15, 20).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
        ...
        PartDefinition legRightFront = partDefinition.addOrReplaceChild("legRightFront", CubeListBuilder.create().texOffs(41, 0).addBox(-1.5F, -3.0F, -3.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 15.2282F, -2.6742F, 0.1822F, 0.0F, 0.0F));
        ...
        PartDefinition legLeftFront = partDefinition.addOrReplaceChild("legLeftFront", CubeListBuilder.create().texOffs(27, 0).addBox(-1.5F, -3.0F, -3.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 15.2282F, -2.6742F, 0.1822F, 0.0F, 0.0F));
        ...
        PartDefinition legRightRear = partDefinition.addOrReplaceChild("legRightRear", CubeListBuilder.create().texOffs(10, 39).addBox(-1.5F, -3.0F, -3.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, 15.4793F, 8.2365F, -0.2731F, 0.0F, 0.0F));
        ...
        PartDefinition legLeftRear = partDefinition.addOrReplaceChild("legLeftRear", CubeListBuilder.create().texOffs(0, 31).addBox(-1.5F, -3.0F, -3.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, 15.4793F, 8.2365F, -0.2731F, 0.0F, 0.0F));
