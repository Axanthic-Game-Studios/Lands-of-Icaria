...
public class CypressForestHagModel extends HierarchicalModel<ForestHagEntity> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition bodyBase = partDefinition.addOrReplaceChild("bodyBase", CubeListBuilder.create().texOffs(0, 35).addBox(-5.5F, 0.0F, -2.5F, 11.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.8F, 0.5F, -0.0873F, 0.0F, 0.0F));
        PartDefinition bodyMain = bodyBase.addOrReplaceChild("bodyMain", CubeListBuilder.create().texOffs(36, 15).addBox(-4.5F, -3.5F, -2.0F, 9.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.015F, -0.0873F, -0.015F));
        ...
        PartDefinition bodyLower = bodyMain.addOrReplaceChild("bodyLower", CubeListBuilder.create().texOffs(35, 6).addBox(-5.0F, -3.5F, -2.5F, 10.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.5F, 0.0F, 0.1023F, -0.0873F, -0.015F));
        ...
        PartDefinition bodyCenter = bodyLower.addOrReplaceChild("bodyCenter", CubeListBuilder.create().texOffs(0, 11).addBox(-6.0F, -3.5F, -3.0F, 12.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.5F, 0.0F, 0.1023F, -0.0873F, -0.015F));
        ...
        PartDefinition bodyUpper = bodyCenter.addOrReplaceChild("bodyUpper", CubeListBuilder.create().texOffs(0, 0).addBox(-6.5F, -3.5F, -3.5F, 13.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.5F, 0.0F, 0.1023F, -0.0873F, -0.015F));
        PartDefinition neckMain = bodyUpper.addOrReplaceChild("neckMain", CubeListBuilder.create().texOffs(20, 59).addBox(-2.0F, -8.0F, -1.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.5F, -0.5F, 0.6259F, 0.1745F, -0.015F));
        PartDefinition headMain = neckMain.addOrReplaceChild("headMain", CubeListBuilder.create().texOffs(0, 44).addBox(-3.0F, -8.0F, -4.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -5.0F, 0.0F, -0.6109F, 0.1745F, 0.0873F));
        PartDefinition headBranchLeavesLower = headMain.addOrReplaceChild("headBranchLeavesLower", CubeListBuilder.create().texOffs(26, 23).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.65F, -10.0F, -0.5F));
        ...
        PartDefinition headBranchRightLower = headMain.addOrReplaceChild("headBranchRightLower", CubeListBuilder.create().texOffs(26, 21).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -6.4F, -2.5F, 0.015F, -0.4098F, -0.5613F));
        ...
        PartDefinition headBranchLeftLower = headMain.addOrReplaceChild("headBranchLeftLower", CubeListBuilder.create().texOffs(0, 21).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -6.4F, 0.5F, 0.015F, 0.3927F, 0.5086F));
        ...
        PartDefinition neckShroom = bodyUpper.addOrReplaceChild("neckShroom", CubeListBuilder.create().texOffs(0, 21).addBox(-9.5F, -2.0F, -3.5F, 9.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.1023F, -0.0873F, 0.1595F));
        ...
        PartDefinition shoulderRight = bodyUpper.addOrReplaceChild("shoulderRight", CubeListBuilder.create().texOffs(62, 48).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.4F, -4.3F, -0.5F, -0.1745F, 0.1745F, 0.4427F));
        ...
        PartDefinition shoulderLeft = bodyUpper.addOrReplaceChild("shoulderLeft", CubeListBuilder.create().texOffs(61, 11).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, -3.0F, -1.0F, -0.3927F, -0.7854F, -0.1373F));
        ...
        PartDefinition bodyUpperBranchLower = bodyUpper.addOrReplaceChild("bodyUpperBranchLower", CubeListBuilder.create().texOffs(24, 48).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.4F, -2.5F, 0.5F, 0.4248F, 0.7854F, -0.015F));
        PartDefinition bodyUpperTwigLower = bodyUpperBranchLower.addOrReplaceChild("bodyUpperTwigLower", CubeListBuilder.create().texOffs(67, 19).addBox(-2.0F, -1.0F, -5.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 2.0F, 2.0F, -0.3948F, 1.7301F, -0.0606F));
        ...
        PartDefinition bodyUpperLeavesLeft = bodyUpperTwigLower.addOrReplaceChild("bodyUpperLeavesLeft", CubeListBuilder.create().texOffs(0, 58).addBox(-3.5F, -3.5F, -3.0F, 7.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 0.0F, -4.0F));
        ...
        PartDefinition bodyUpperBranchCenter = bodyUpperBranchLower.addOrReplaceChild("bodyUpperBranchCenter", CubeListBuilder.create().texOffs(60, 0).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 5.5F, 0.4077F, -0.1745F, -0.015F));
        PartDefinition bodyUpperBranchUpper = bodyUpperBranchCenter.addOrReplaceChild("bodyUpperBranchUpper", CubeListBuilder.create().texOffs(64, 66).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.8F, 4.0F, 0.4077F, 0.2618F, -0.015F));
        ...
        PartDefinition bodyUpperLeavesLower = bodyUpperBranchUpper.addOrReplaceChild("bodyUpperLeavesLower", CubeListBuilder.create().texOffs(32, 35).addBox(-4.5F, -4.5F, 4.0F, 9.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 0.0F, 0.0F));
        ...
        PartDefinition thighRight = bodyBase.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(14, 69).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, 3.2F, -0.5F));
        PartDefinition legRight = thighRight.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(69, 27).addBox(-1.5F, -0.2F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 9.0F, 0.0F, 0.0873F, -0.0873F, 0.0F));
        PartDefinition footRight = legRight.addOrReplaceChild("footRight", CubeListBuilder.create().texOffs(33, 0).addBox(-2.0F, -0.4F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, 0.0F, -0.0873F, 0.0873F));
        ...
        PartDefinition thighLeft = bodyBase.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(18, 44).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.4F, 3.7F, -0.5F, 0.0F, -0.2731F, 0.0F));
        PartDefinition legLeft = thighLeft.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(22, 71).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.5F, 0.0F, 0.0F, -0.3927F, 0.0F));
