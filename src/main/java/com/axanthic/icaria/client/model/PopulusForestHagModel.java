...
public class PopulusForestHagModel extends EntityModel<PopulusForestHagRenderState> {
	...
	@Override
	public void setupAnim(PopulusForestHagRenderState pRenderState) {
	...
	public void lookAnim(float pXRot, float pYRot) {
		this.headMain.xRot = IcariaMath.rad(pXRot) - 0.9599F;
	...
	public void walkAnim(float pWalkAnimationPos, float pWalkAnimationSpeed) {
		...
		this.armRightUpper.xRot = Mth.cos(pWalkAnimationPos * 0.6F + Mth.PI) * pWalkAnimationSpeed - 0.3927F;
		this.armRightLower.xRot = Mth.cos(pWalkAnimationPos * 0.6F + Mth.PI) * pWalkAnimationSpeed - pWalkAnimationSpeed - 0.3927F;
		...
		this.armLeftUpper.xRot = Mth.cos(pWalkAnimationPos * 0.6F) * pWalkAnimationSpeed - 0.3927F;
		this.armLeftLower.xRot = Mth.cos(pWalkAnimationPos * 0.6F) * pWalkAnimationSpeed - pWalkAnimationSpeed - 0.3927F;
