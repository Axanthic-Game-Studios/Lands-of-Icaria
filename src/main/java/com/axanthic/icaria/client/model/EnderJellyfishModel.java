...
public class EnderJellyfishModel extends EntityModel<EnderJellyfishRenderState> {
	...
	@Override
	public void setupAnim(EnderJellyfishRenderState pRenderState) {
	...
	public void swimAnim(float pTentacleAngle) {
		...
		this.tentacleNorth.xRot = -pTentacleAngle * IcariaMath.rad(11.25F) - IcariaMath.rad(11.25F);
		this.tentacleEast.xRot = pTentacleAngle * IcariaMath.rad(11.25F) + IcariaMath.rad(11.25F);
		this.tentacleSouth.xRot = pTentacleAngle * IcariaMath.rad(11.25F) + IcariaMath.rad(11.25F);
		this.tentacleWest.xRot = -pTentacleAngle * IcariaMath.rad(11.25F) - IcariaMath.rad(11.25F);
		this.armOuterNorthEastUpper.xRot = -pTentacleAngle * IcariaMath.rad(11.25F) - IcariaMath.rad(11.25F);
		this.armOuterNorthEastLower.xRot = pTentacleAngle * IcariaMath.rad(11.25F) + IcariaMath.rad(11.25F);
		this.armOuterSouthEastUpper.xRot = -pTentacleAngle * IcariaMath.rad(11.25F) - IcariaMath.rad(11.25F);
		this.armOuterSouthEastLower.xRot = pTentacleAngle * IcariaMath.rad(11.25F) + IcariaMath.rad(11.25F);
		this.armOuterSouthWestUpper.xRot = -pTentacleAngle * IcariaMath.rad(11.25F) - IcariaMath.rad(11.25F);
		this.armOuterSouthWestLower.xRot = pTentacleAngle * IcariaMath.rad(11.25F) + IcariaMath.rad(11.25F);
		this.armOuterNorthWestUpper.xRot = -pTentacleAngle * IcariaMath.rad(11.25F) - IcariaMath.rad(11.25F);
		this.armOuterNorthWestLower.xRot = pTentacleAngle * IcariaMath.rad(11.25F) + IcariaMath.rad(11.25F);
	}
	...
	public static LayerDefinition createLayer() {
		...
		var body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 9).addBox(-3.0F, -1.0F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));
		var bell = body.addOrReplaceChild("bell", CubeListBuilder.create().texOffs(0, 30).addBox(-5.0F, -26.0F, -4.0F, 10.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 0.0F));
		var bellNorth = bell.addOrReplaceChild("bellNorth", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 0.0F, -5.0F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -26.0F, 0.0F));
		...
		var bellSouth = bell.addOrReplaceChild("bellSouth", CubeListBuilder.create().texOffs(18, 0).addBox(-4.0F, 0.0F, 4.0F, 8.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -26.0F, 0.0F));
		...
		var head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(18, 9).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, 0.0F));
		var torso = head.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 17).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 2.0F, 0.0F));
		...
		var armOuterNorthEastUpper = head.addOrReplaceChild("armOuterNorthEastUpper", CubeListBuilder.create().texOffs(0, 51).addBox(-0.5F, 0.0F, -1.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.5F, 0.0F, -0.1963F, 0.7854F, 0.0F));
		...
		var armOuterSouthEastUpper = head.addOrReplaceChild("armOuterSouthEastUpper", CubeListBuilder.create().texOffs(4, 51).addBox(-0.5F, 0.0F, -1.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.5F, 0.0F, -0.1963F, 2.3562F, 0.0F));
		...
		var armOuterSouthWestUpper = head.addOrReplaceChild("armOuterSouthWestUpper", CubeListBuilder.create().texOffs(8, 51).addBox(-0.5F, 0.0F, -1.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.5F, 0.0F, -0.1963F, -2.3562F, 0.0F));
		...
		var armOuterNorthWestUpper = head.addOrReplaceChild("armOuterNorthWestUpper", CubeListBuilder.create().texOffs(12, 51).addBox(-0.5F, 0.0F, -1.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.5F, 0.0F, -0.1963F, -0.7854F, 0.0F));
