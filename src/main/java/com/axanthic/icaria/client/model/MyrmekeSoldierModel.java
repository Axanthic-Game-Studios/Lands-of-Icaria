...
public class MyrmekeSoldierModel extends EntityModel<MyrmekeSoldierEntity> {
    public static ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(IcariaInfo.MODID, "myrmeke_soldier"), "main");
    ...
    public static LayerDefinition createLayer() {
        ...
        head.addOrReplaceChild("mandible_left", CubeListBuilder.create().texOffs(51, 0).addBox(-0.5F, -0.5F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 5).addBox(-1.5F, -0.5F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 1.3F, -4.0F, 0.0F, 0.0436F, 0.0F));
        head.addOrReplaceChild("mandible_right", CubeListBuilder.create().texOffs(41, 0).addBox(-0.5F, -0.5F, -4.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(42, 5).addBox(0.5F, -0.5F, -3.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 1.3F, -4.0F, 0.0F, -0.0436F, 0.0F));
        ...
        body_thorax.addOrReplaceChild("B1T0", CubeListBuilder.create().texOffs(47, 5).addBox(-1.5F, -0.5F, -2.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.01F)).texOffs(41, 13).addBox(-1.5F, 0.5F, 2.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.01F)).texOffs(42, 9).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.8571F, 0.0F, 0.2182F, 0.0F, 0.0F));
        body_thorax.addOrReplaceChild("B1T1", CubeListBuilder.create().texOffs(13, 8).addBox(-7.0F, -6.3F, -5.8F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 5.6429F, 4.0F));
        body_thorax.addOrReplaceChild("B1T2", CubeListBuilder.create().texOffs(13, 0).addBox(-7.0F, -6.3F, -5.5F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 5.6429F, 6.0F));
        body_thorax.addOrReplaceChild("B1T3", CubeListBuilder.create().texOffs(0, 0).addBox(-2.9517F, -1.5942F, -5.2266F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, 1.0908F, 0.0F));
        body_thorax.addOrReplaceChild("B1T4", CubeListBuilder.create().texOffs(35, 37).addBox(-6.6527F, -1.5942F, -0.8316F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, 1.0908F, 0.0F));
        body_thorax.addOrReplaceChild("B1T5", CubeListBuilder.create().texOffs(29, 37).addBox(0.9597F, -1.5942F, 6.2627F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, -1.0908F, 0.0F));
        body_thorax.addOrReplaceChild("B1T6", CubeListBuilder.create().texOffs(0, 8).addBox(-1.7414F, -1.5942F, 1.8677F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.999F, 0.5371F, -2.2048F, 0.0F, -1.0908F, 0.0F));
        ...
        abdomen.addOrReplaceChild("A2", CubeListBuilder.create().texOffs(0, 26).addBox(-1.978F, -1.0698F, 0.0742F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(49, 1).addBox(-0.48F, -1.0698F, 2.0742F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.02F, 1.4921F, 3.8831F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition L11 = L10.addOrReplaceChild("L12", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
