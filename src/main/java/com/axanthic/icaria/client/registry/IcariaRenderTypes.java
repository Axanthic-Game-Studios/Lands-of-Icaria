...
public class IcariaRenderTypes {
    ...
    public static final RenderType VINEGAROON_EMISSIVE = RenderType.entityTranslucentEmissive(new ResourceLocation(IcariaInfo.ID, "textures/entity/vinegaroon_emissive.png"));
