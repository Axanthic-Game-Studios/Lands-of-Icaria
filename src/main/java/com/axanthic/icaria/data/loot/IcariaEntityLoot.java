...
public class IcariaEntityLoot extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        this.dropItemWithCookFunc(IcariaEntityTypes.CATOBLEPAS.get(), IcariaItems.RAW_CATOBLEPAS_MEAT.get());
        this.dropItemWithCookFunc(IcariaEntityTypes.CERVER.get(), IcariaItems.RAW_CERVER_MEAT.get());
        this.dropItemWithCookFunc(IcariaEntityTypes.SOW.get(), IcariaItems.RAW_SOW_MEAT.get());
        ...
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.AETERNAE.get(), IcariaItems.AETERNAE_HIDE.get(), IcariaItems.RAW_AETERNAE_MEAT.get());
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.CYPRESS_FOREST_HAG.get(), IcariaItems.CYPRESS_SAPLING.get(), IcariaItems.CYPRESS_LOG.get());
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.DROUGHTROOT_FOREST_HAG.get(), IcariaItems.DROUGHTROOT_SAPLING.get(), IcariaItems.DROUGHTROOT_LOG.get());
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.FIR_FOREST_HAG.get(), IcariaItems.FIR_SAPLING.get(), IcariaItems.FIR_LOG.get());
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.OLIVE_FOREST_HAG.get(), IcariaItems.OLIVE_SAPLING.get(), IcariaItems.OLIVE_LOG.get());
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.PLANE_FOREST_HAG.get(), IcariaItems.PLANE_SAPLING.get(), IcariaItems.PLANE_LOG.get());
        this.dropItemPlusScndWithCookFunc(IcariaEntityTypes.POPULUS_FOREST_HAG.get(), IcariaItems.POPULUS_SAPLING.get(), IcariaItems.POPULUS_LOG.get());
        ...
        this.dropItemPlusScndPlusThrd(IcariaEntityTypes.PYROMANCER_REVENANT.get(), IcariaItems.GREENPOWDER.get(), IcariaItems.GREEK_FIRE_GRENADE.get(), Items.BONE);
        this.dropItemPlusScndPlusThrd(IcariaEntityTypes.NETHER_PYROMANCER_REVENANT.get(), IcariaItems.GREENPOWDER.get(), IcariaItems.GREEK_FIRE_GRENADE.get(), Items.BONE);

        this.dropItemPlusScndPlusThrdWithCookFunc(IcariaEntityTypes.LAUREL_FOREST_HAG.get(), IcariaItems.LAUREL_SAPLING.get(), IcariaItems.LAUREL_WREATH.get(), IcariaItems.LAUREL_LOG.get());
    }
    ...
    public void dropItemWithCookFunc(EntityType<?> pEntity, Item pItem) {
        this.add(pEntity, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(pItem).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))).apply(SmeltItemFunction.smelted().when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, EntityLootSubProvider.ENTITY_ON_FIRE))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))));
    }
    ...
    public void dropItemPlusScndWithCookFunc(EntityType<?> pEntity, Item pItem, Item pScnd) {
        this.add(pEntity, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(pItem).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(pScnd).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))).apply(SmeltItemFunction.smelted().when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, EntityLootSubProvider.ENTITY_ON_FIRE))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))));
    }
    ...
    public void dropItemPlusScndPlusThrdWithCookFunc(EntityType<?> pEntity, Item pItem, Item pScnd, Item pThrd) {
        this.add(pEntity, LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(pItem).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(pScnd).when(LootItemRandomChanceCondition.randomChance(0.1F)))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(pThrd).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))).apply(SmeltItemFunction.smelted().when(LootItemEntityPropertyCondition.hasProperties(LootContext.EntityTarget.THIS, EntityLootSubProvider.ENTITY_ON_FIRE))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))));
    }
