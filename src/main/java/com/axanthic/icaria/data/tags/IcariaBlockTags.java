...
public class IcariaBlockTags extends BlockTagsProvider {
	...
	public static final TagKey<Block> INCORRECT_FOR_KASSITEROS_TOOL = IcariaBlockTags.icariaTag("incorrect_for_kassiteros_tool");
	public static final TagKey<Block> INCORRECT_FOR_ORICHALCUM_TOOL = IcariaBlockTags.icariaTag("incorrect_for_orichalcum_tool");
	public static final TagKey<Block> INCORRECT_FOR_VANADIUMSTEEL_TOOL = IcariaBlockTags.icariaTag("incorrect_for_vanadiumsteel_tool");
	public static final TagKey<Block> INCORRECT_FOR_SIDEROS_TOOL = IcariaBlockTags.icariaTag("incorrect_for_sideros_tool");
	public static final TagKey<Block> INCORRECT_FOR_MOLYBDENUMSTEEL_TOOL = IcariaBlockTags.icariaTag("incorrect_for_molybdenumsteel_tool");
	...
	public static final TagKey<Block> LOGS_CYPRESS = IcariaBlockTags.cTag("logs/cypress");
	public static final TagKey<Block> LOGS_DROUGHTROOT = IcariaBlockTags.cTag("logs/droughtroot");
	public static final TagKey<Block> LOGS_FIR = IcariaBlockTags.cTag("logs/fir");
	public static final TagKey<Block> LOGS_LAUREL = IcariaBlockTags.cTag("logs/laurel");
	public static final TagKey<Block> LOGS_OLIVE = IcariaBlockTags.cTag("logs/olive");
	public static final TagKey<Block> LOGS_PLANE = IcariaBlockTags.cTag("logs/plane");
	public static final TagKey<Block> LOGS_POPULUS = IcariaBlockTags.cTag("logs/populus");

	public static final TagKey<Block> ORE_BEARING_GROUND_MARL = IcariaBlockTags.cTag("ore_bearing_ground/marl");
	public static final TagKey<Block> ORE_BEARING_GROUND_GRAINEL = IcariaBlockTags.cTag("ore_bearing_ground/grainel");
	public static final TagKey<Block> ORE_BEARING_GROUND_YELLOWSTONE = IcariaBlockTags.cTag("ore_bearing_ground/yellowstone");
	public static final TagKey<Block> ORE_BEARING_GROUND_SILKSTONE = IcariaBlockTags.cTag("ore_bearing_ground/silkstone");
	public static final TagKey<Block> ORE_BEARING_GROUND_SUNSTONE = IcariaBlockTags.cTag("ore_bearing_ground/sunstone");
	public static final TagKey<Block> ORE_BEARING_GROUND_VOIDSHALE = IcariaBlockTags.cTag("ore_bearing_ground/voidshale");
	public static final TagKey<Block> ORE_BEARING_GROUND_BAETYL = IcariaBlockTags.cTag("ore_bearing_ground/baetyl");

	public static final TagKey<Block> ORES_CHERT = IcariaBlockTags.cTag("ores/chert");
	public static final TagKey<Block> ORES_BONES = IcariaBlockTags.cTag("ores/bones");
	public static final TagKey<Block> ORES_LIGNITE = IcariaBlockTags.cTag("ores/lignite");
	public static final TagKey<Block> ORES_CHALKOS = IcariaBlockTags.cTag("ores/chalkos");
	public static final TagKey<Block> ORES_KASSITEROS = IcariaBlockTags.cTag("ores/kassiteros");
	public static final TagKey<Block> ORES_DOLOMITE = IcariaBlockTags.cTag("ores/dolomite");
	public static final TagKey<Block> ORES_VANADIUM = IcariaBlockTags.cTag("ores/vanadium");
	public static final TagKey<Block> ORES_SLIVER = IcariaBlockTags.cTag("ores/sliver");
	public static final TagKey<Block> ORES_SIDEROS = IcariaBlockTags.cTag("ores/sideros");
	public static final TagKey<Block> ORES_ANTHRACITE = IcariaBlockTags.cTag("ores/anthracite");
	public static final TagKey<Block> ORES_MOLYBDENUM = IcariaBlockTags.cTag("ores/molybdenum");
	public static final TagKey<Block> ORES_HYLIASTRUM = IcariaBlockTags.cTag("ores/hyliastrum");

	public static final TagKey<Block> ORES_IN_GROUND_MARL = IcariaBlockTags.cTag("ores_in_ground/marl");
	public static final TagKey<Block> ORES_IN_GROUND_GRAINEL = IcariaBlockTags.cTag("ores_in_ground/grainel");
	public static final TagKey<Block> ORES_IN_GROUND_YELLOWSTONE = IcariaBlockTags.cTag("ores_in_ground/yellowstone");
	public static final TagKey<Block> ORES_IN_GROUND_SILKSTONE = IcariaBlockTags.cTag("ores_in_ground/silkstone");
	public static final TagKey<Block> ORES_IN_GROUND_SUNSTONE = IcariaBlockTags.cTag("ores_in_ground/sunstone");
	public static final TagKey<Block> ORES_IN_GROUND_VOIDSHALE = IcariaBlockTags.cTag("ores_in_ground/voidshale");
	public static final TagKey<Block> ORES_IN_GROUND_BAETYL = IcariaBlockTags.cTag("ores_in_ground/baetyl");

	public static final TagKey<Block> STORAGE_BLOCKS_ARISTONE = IcariaBlockTags.cTag("storage_blocks/aristone");
	public static final TagKey<Block> STORAGE_BLOCKS_ENDER_JELLYFISH_JELLY = IcariaBlockTags.cTag("storage_blocks/ender_jellyfish_jelly");
	public static final TagKey<Block> STORAGE_BLOCKS_FIRE_JELLYFISH_JELLY = IcariaBlockTags.cTag("storage_blocks/fire_jellyfish_jelly");
	public static final TagKey<Block> STORAGE_BLOCKS_NATURE_JELLYFISH_JELLY = IcariaBlockTags.cTag("storage_blocks/nature_jellyfish_jelly");
	public static final TagKey<Block> STORAGE_BLOCKS_VOID_JELLYFISH_JELLY = IcariaBlockTags.cTag("storage_blocks/void_jellyfish_jelly");
	public static final TagKey<Block> STORAGE_BLOCKS_WATER_JELLYFISH_JELLY = IcariaBlockTags.cTag("storage_blocks/water_jellyfish_jelly");
	public static final TagKey<Block> STORAGE_BLOCKS_ARACHNE_STRING = IcariaBlockTags.cTag("storage_blocks/arachne_string");
	public static final TagKey<Block> STORAGE_BLOCKS_SPELT = IcariaBlockTags.cTag("storage_blocks/spelt");
	public static final TagKey<Block> STORAGE_BLOCKS_VINE_REED = IcariaBlockTags.cTag("storage_blocks/vine_reed");
	public static final TagKey<Block> STORAGE_BLOCKS_ROTTEN_BONES = IcariaBlockTags.cTag("storage_blocks/rotten_bones");
	public static final TagKey<Block> STORAGE_BLOCKS_RAW_CHALKOS = IcariaBlockTags.cTag("storage_blocks/raw_chalkos");
	public static final TagKey<Block> STORAGE_BLOCKS_RAW_KASSITEROS = IcariaBlockTags.cTag("storage_blocks/raw_kassiteros");
	public static final TagKey<Block> STORAGE_BLOCKS_RAW_VANADIUM = IcariaBlockTags.cTag("storage_blocks/raw_vanadium");
	public static final TagKey<Block> STORAGE_BLOCKS_RAW_SIDEROS = IcariaBlockTags.cTag("storage_blocks/raw_sideros");
	public static final TagKey<Block> STORAGE_BLOCKS_RAW_MOLYBDENUM = IcariaBlockTags.cTag("storage_blocks/raw_molybdenum");
	public static final TagKey<Block> STORAGE_BLOCKS_CALCITE = IcariaBlockTags.cTag("storage_blocks/calcite");
	public static final TagKey<Block> STORAGE_BLOCKS_HALITE = IcariaBlockTags.cTag("storage_blocks/halite");
	public static final TagKey<Block> STORAGE_BLOCKS_JASPER = IcariaBlockTags.cTag("storage_blocks/jasper");
	public static final TagKey<Block> STORAGE_BLOCKS_ZIRCON = IcariaBlockTags.cTag("storage_blocks/zircon");
	public static final TagKey<Block> STORAGE_BLOCKS_CHERT = IcariaBlockTags.cTag("storage_blocks/chert");
	public static final TagKey<Block> STORAGE_BLOCKS_LIGNITE = IcariaBlockTags.cTag("storage_blocks/lignite");
	public static final TagKey<Block> STORAGE_BLOCKS_CHALKOS = IcariaBlockTags.cTag("storage_blocks/chalkos");
	public static final TagKey<Block> STORAGE_BLOCKS_KASSITEROS = IcariaBlockTags.cTag("storage_blocks/kassiteros");
	public static final TagKey<Block> STORAGE_BLOCKS_ORICHALCUM = IcariaBlockTags.cTag("storage_blocks/orichalcum");
	public static final TagKey<Block> STORAGE_BLOCKS_VANADIUM = IcariaBlockTags.cTag("storage_blocks/vanadium");
	public static final TagKey<Block> STORAGE_BLOCKS_VANADIUMSTEEL = IcariaBlockTags.cTag("storage_blocks/vanadiumsteel");
	public static final TagKey<Block> STORAGE_BLOCKS_SLIVER = IcariaBlockTags.cTag("storage_blocks/sliver");
	public static final TagKey<Block> STORAGE_BLOCKS_SIDEROS = IcariaBlockTags.cTag("storage_blocks/sideros");
	public static final TagKey<Block> STORAGE_BLOCKS_ANTHRACITE = IcariaBlockTags.cTag("storage_blocks/anthracite");
	public static final TagKey<Block> STORAGE_BLOCKS_MOLYBDENUM = IcariaBlockTags.cTag("storage_blocks/molybdenum");
	public static final TagKey<Block> STORAGE_BLOCKS_MOLYBDENUMSTEEL = IcariaBlockTags.cTag("storage_blocks/molybdenumsteel");
	public static final TagKey<Block> STORAGE_BLOCKS_BLURIDIUM = IcariaBlockTags.cTag("storage_blocks/bluridium");
	...
	public void addTags(HolderLookup.Provider pProvider) {
		...
		this.tag(Tags.Blocks.DYED_WHITE).add(IcariaBlocks.WHITE_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_LIGHT_GRAY).add(IcariaBlocks.LIGHT_GRAY_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_GRAY).add(IcariaBlocks.GRAY_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_BLACK).add(IcariaBlocks.BLACK_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_BROWN).add(IcariaBlocks.BROWN_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_RED).add(IcariaBlocks.RED_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_ORANGE).add(IcariaBlocks.ORANGE_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_YELLOW).add(IcariaBlocks.YELLOW_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_LIME).add(IcariaBlocks.LIME_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_GREEN).add(IcariaBlocks.GREEN_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_CYAN).add(IcariaBlocks.CYAN_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_LIGHT_BLUE).add(IcariaBlocks.LIGHT_BLUE_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_BLUE).add(IcariaBlocks.BLUE_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_PURPLE).add(IcariaBlocks.PURPLE_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_MAGENTA).add(IcariaBlocks.MAGENTA_STORAGE_VASE.get());
		this.tag(Tags.Blocks.DYED_PINK).add(IcariaBlocks.PINK_STORAGE_VASE.get());
		...
		this.tag(IcariaBlockTags.INCORRECT_FOR_CHALKOS_TOOL)
			.addTag(BlockTags.NEEDS_IRON_TOOL)
			.addTag(BlockTags.NEEDS_DIAMOND_TOOL)
			.addTag(IcariaBlockTags.NEEDS_KASSITEROS_TOOL)
			.addTag(IcariaBlockTags.NEEDS_ORICHALCUM_TOOL)
		...
		this.tag(IcariaBlockTags.INCORRECT_FOR_KASSITEROS_TOOL)
			.addTag(BlockTags.NEEDS_DIAMOND_TOOL)
			.addTag(IcariaBlockTags.NEEDS_ORICHALCUM_TOOL)
			.addTag(IcariaBlockTags.NEEDS_VANADIUMSTEEL_TOOL)
			.addTag(IcariaBlockTags.NEEDS_SIDEROS_TOOL)
		...
		this.tag(IcariaBlockTags.INCORRECT_FOR_ORICHALCUM_TOOL)
			.addTag(BlockTags.NEEDS_DIAMOND_TOOL)
			.addTag(IcariaBlockTags.NEEDS_VANADIUMSTEEL_TOOL)
			.addTag(IcariaBlockTags.NEEDS_SIDEROS_TOOL)
			.addTag(IcariaBlockTags.NEEDS_MOLYBDENUMSTEEL_TOOL);

		this.tag(IcariaBlockTags.INCORRECT_FOR_VANADIUMSTEEL_TOOL)
			.addTag(IcariaBlockTags.NEEDS_SIDEROS_TOOL)
			.addTag(IcariaBlockTags.NEEDS_MOLYBDENUMSTEEL_TOOL);

		this.tag(IcariaBlockTags.INCORRECT_FOR_SIDEROS_TOOL)
			.addTag(IcariaBlockTags.NEEDS_MOLYBDENUMSTEEL_TOOL);

		this.tag(IcariaBlockTags.INCORRECT_FOR_MOLYBDENUMSTEEL_TOOL);
		...
		for (var items : IcariaWoodDecoItems.WOOD_DECO_ITEMS) {
			...
			this.tag(BlockTags.FENCE_GATES).add(items.block.gate.get());
		}
		...
		this.tag(BlockTags.LOGS_THAT_BURN)
			.addTag(IcariaBlockTags.LOGS_CYPRESS)
			.addTag(IcariaBlockTags.LOGS_DROUGHTROOT)
			.addTag(IcariaBlockTags.LOGS_FIR)
			.addTag(IcariaBlockTags.LOGS_LAUREL)
		...
		this.tag(IcariaBlockTags.ORES_BONES)
			.add(IcariaBlocks.MARL_BONES.get());
		...
		this.tag(IcariaBlockTags.ORES_CHALKOS)
			.add(IcariaBlocks.CHALKOS_ORE.get());

		this.tag(IcariaBlockTags.ORES_KASSITEROS)
			.add(IcariaBlocks.KASSITEROS_ORE.get());

		this.tag(IcariaBlockTags.ORES_DOLOMITE)
			.add(IcariaBlocks.DOLOMITE_ORE.get());

		this.tag(IcariaBlockTags.ORES_VANADIUM)
			.add(IcariaBlocks.VANADIUM_ORE.get());

		this.tag(IcariaBlockTags.ORES_SLIVER)
			.add(IcariaBlocks.SLIVER_ORE.get());

		this.tag(IcariaBlockTags.ORES_SIDEROS)
			.add(IcariaBlocks.SIDEROS_ORE.get());

		this.tag(IcariaBlockTags.ORES_ANTHRACITE)
			.add(IcariaBlocks.ANTHRACITE_ORE.get());

		this.tag(IcariaBlockTags.ORES_MOLYBDENUM)
			.add(IcariaBlocks.MOLYBDENUM_ORE.get());

		this.tag(IcariaBlockTags.ORES_HYLIASTRUM)
			.add(IcariaBlocks.HYLIASTRUM_ORE.get());
		...
		this.tag(IcariaBlockTags.STORAGE_BLOCKS_ARISTONE).add(IcariaBlocks.PACKED_ARISTONE.get());
