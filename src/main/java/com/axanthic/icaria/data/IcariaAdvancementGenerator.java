...
public class IcariaAdvancementGenerator implements AdvancementProvider.AdvancementGenerator {

	@Override
	public void generate(HolderLookup.Provider pProvider, Consumer<AdvancementHolder> pConsumer, ExistingFileHelper pExistingFileHelper) {
		...
		var root = IcariaAdvancementGenerator.advancement("root", IcariaItems.GRASSY_MARL.get(), rootTrigger, pConsumer, AdvancementType.TASK, true, false, true);
		var arachne = IcariaAdvancementGenerator.advancement("arachne", IcariaItems.ARACHNE_STRING.get(), arachneTrigger, pConsumer, AdvancementType.CHALLENGE, arachneReward, root, true, false, true);
		var barrel = IcariaAdvancementGenerator.advancement("barrel", IcariaItems.LAUREL_BARREL.get(), barrelTrigger, pConsumer, AdvancementType.TASK, root, true, false, true);
		var captainRevenant = IcariaAdvancementGenerator.advancement("captain_revenant", Items.BONE, captainRevenantTrigger, pConsumer, AdvancementType.CHALLENGE, captainRevenantReward, root, true, false, true);
		var chertPickaxe = IcariaAdvancementGenerator.advancement("chert_pickaxe", IcariaItems.CHERT_PICKAXE.get(), chertPickaxeTrigger, pConsumer, AdvancementType.TASK, root, true, false, true);
		var chest = IcariaAdvancementGenerator.chest("chest", pProvider, IcariaItems.CHEST.get(), chestTrigger, pConsumer, AdvancementType.TASK, root, true, false, true);
		var fertilizedFarmland = IcariaAdvancementGenerator.advancement("fertilized_farmland", IcariaItems.CALCITE_DUST.get(), fertilizedFarmlandTrigger, pConsumer, AdvancementType.TASK, root, true, false, true);
		var lootVase = IcariaAdvancementGenerator.advancement("loot_vase", IcariaItems.CYAN_LOOT_VASE.get(), lootVaseTrigger, pConsumer, AdvancementType.TASK, root, true, false, true);
		var storageVase = IcariaAdvancementGenerator.storageVase("storage_vase", IcariaItems.STORAGE_VASE.get(), storageVaseTrigger, pConsumer, AdvancementType.TASK, root, true, false, true);
		var chalkosPickaxe = IcariaAdvancementGenerator.advancement("chalkos_pickaxe", IcariaItems.CHALKOS_PICKAXE.get(), chalkosPickaxeTrigger, pConsumer, AdvancementType.TASK, chertPickaxe, true, false, true);
		var kiln = IcariaAdvancementGenerator.advancement("kiln", IcariaItems.KILN.get(), kilnTrigger, pConsumer, AdvancementType.GOAL, chertPickaxe, true, false, true);
		var kassiterosPickaxe = IcariaAdvancementGenerator.advancement("kassiteros_pickaxe", IcariaItems.KASSITEROS_PICKAXE.get(), kassiterosPickaxeTrigger, pConsumer, AdvancementType.TASK, chalkosPickaxe, true, false, true);
		var forge = IcariaAdvancementGenerator.advancement("forge", IcariaItems.FORGE.get(), forgeTrigger, pConsumer, AdvancementType.GOAL, chalkosPickaxe, true, false, true);
		var orichalcumPickaxe = IcariaAdvancementGenerator.advancement("orichalcum_pickaxe", IcariaItems.ORICHALCUM_PICKAXE.get(), orichalcumPickaxeTrigger, pConsumer, AdvancementType.TASK, kassiterosPickaxe, true, false, true);
		var grinder = IcariaAdvancementGenerator.advancement("grinder", IcariaItems.GRINDER.get(), grinderTrigger, pConsumer, AdvancementType.GOAL, kassiterosPickaxe, true, false, true);
		var vanadiumsteelPickaxe = IcariaAdvancementGenerator.advancement("vanadiumsteel_pickaxe", IcariaItems.VANADIUMSTEEL_PICKAXE.get(), vanadiumsteelPickaxeTrigger, pConsumer, AdvancementType.TASK, orichalcumPickaxe, true, false, true);
		var kettle = IcariaAdvancementGenerator.advancement("kettle", IcariaItems.KETTLE.get(), kettleTrigger, pConsumer, AdvancementType.GOAL, orichalcumPickaxe, true, false, true);
		var siderosPickaxe = IcariaAdvancementGenerator.advancement("sideros_pickaxe", IcariaItems.SIDEROS_PICKAXE.get(), siderosPickaxeTrigger, pConsumer, AdvancementType.TASK, vanadiumsteelPickaxe, true, false, true);
		var hyliaster = IcariaAdvancementGenerator.advancement("hyliaster", IcariaItems.HYLIASTRUM_VIAL.get(), hyliasterTrigger, pConsumer, AdvancementType.GOAL, siderosPickaxe, true, false, true);
		var molybdenumsteelPickaxe = IcariaAdvancementGenerator.advancement("molybdenumsteel_pickaxe", IcariaItems.MOLYBDENUMSTEEL_PICKAXE.get(), molybdenumsteelPickaxeTrigger, pConsumer, AdvancementType.GOAL, siderosPickaxe, true, false, true);
	}
	...
	public static AdvancementHolder advancement(String pKey, Item pItem, Criterion<?> pTrigger, Consumer<AdvancementHolder> pConsumer, AdvancementType pAdvancementType, AdvancementRewards pReward, boolean pChat, boolean pHidden, boolean pToast) {
		return Advancement.Builder.advancement().addCriterion(pKey, pTrigger).display(pItem, Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "title"), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "description"), IcariaResourceLocations.BACKGROUND, pAdvancementType, pToast, pChat, pHidden).rewards(pReward).save(pConsumer, IcariaIdents.ID + ":" + pKey);
	}
	...
	public static AdvancementHolder advancement(String pKey, Item pItem, Criterion<?> pTrigger, Consumer<AdvancementHolder> pConsumer, AdvancementType pAdvancementType, AdvancementHolder pParent, boolean pChat, boolean pHidden, boolean pToast) {
		return Advancement.Builder.advancement().addCriterion(pKey, pTrigger).display(pItem, Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "title"), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "description"), IcariaResourceLocations.BACKGROUND, pAdvancementType, pToast, pChat, pHidden).parent(pParent).save(pConsumer, IcariaIdents.ID + ":" + pKey);
	}
	...
	public static AdvancementHolder advancement(String pKey, Item pItem, Criterion<?> pTrigger, Consumer<AdvancementHolder> pConsumer, AdvancementType pAdvancementType, boolean pChat, boolean pHidden, boolean pToast) {
		return Advancement.Builder.advancement().addCriterion(pKey, pTrigger).display(pItem, Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "title"), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "description"), IcariaResourceLocations.BACKGROUND, pAdvancementType, pToast, pChat, pHidden).save(pConsumer, IcariaIdents.ID + ":" + pKey);
	}
}
