...
public class IcariaBlockStateProvider {
	...
	public static void register(BlockModelGenerators pBlockModelGenerators) {
		...
		IcariaBlockStateProvider.bathtub(pBlockModelGenerators);
		...
		IcariaBlockStateProvider.suspiciousSubstance(pBlockModelGenerators);
	...
	public static void bathtub(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.bathtub(IcariaBlocks.CYPRESS_BATHTUB.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.bathtub(IcariaBlocks.DROUGHTROOT_BATHTUB.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.bathtub(IcariaBlocks.FIR_BATHTUB.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.bathtub(IcariaBlocks.LAUREL_BATHTUB.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.bathtub(IcariaBlocks.OLIVE_BATHTUB.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.bathtub(IcariaBlocks.PLANE_BATHTUB.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.bathtub(IcariaBlocks.POPULUS_BATHTUB.get(), pBlockModelGenerators);
	}
	...
	public static void countertop(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.countertop(IcariaBlocks.CYPRESS_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.countertop(IcariaBlocks.DROUGHTROOT_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.countertop(IcariaBlocks.FIR_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.countertop(IcariaBlocks.LAUREL_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.countertop(IcariaBlocks.OLIVE_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.countertop(IcariaBlocks.PLANE_COUNTERTOP.get(), pBlockModelGenerators);
	...
	public static void firewoodWedge(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.firewoodWedge(IcariaBlocks.CYPRESS_FIREWOOD_WEDGE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.firewoodWedge(IcariaBlocks.DROUGHTROOT_FIREWOOD_WEDGE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.firewoodWedge(IcariaBlocks.FIR_FIREWOOD_WEDGE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.firewoodWedge(IcariaBlocks.LAUREL_FIREWOOD_WEDGE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.firewoodWedge(IcariaBlocks.OLIVE_FIREWOOD_WEDGE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.firewoodWedge(IcariaBlocks.PLANE_FIREWOOD_WEDGE.get(), pBlockModelGenerators);
	...
	public static void flowerPotCountertop(BlockModelGenerators pBlockModelGenerators) {
		...
		IcariaBlockStateProvider.flowerPotCountertop(IcariaBlocks.FIR_FLOWER_POT_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.flowerPotCountertop(IcariaBlocks.LAUREL_FLOWER_POT_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.flowerPotCountertop(IcariaBlocks.OLIVE_FLOWER_POT_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.flowerPotCountertop(IcariaBlocks.PLANE_FLOWER_POT_COUNTERTOP.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.flowerPotCountertop(IcariaBlocks.POPULUS_FLOWER_POT_COUNTERTOP.get(), pBlockModelGenerators);
	}
	...
	public static void horizontal1(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.BONE_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LIGNITE_WALL_TORCH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.ANTHRACITE_WALL_TORCH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POT.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LARGE_BOWLS.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.SMALL_BOWLS.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLATES.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.CYPRESS_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.DROUGHTROOT_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.FIR_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.LAUREL_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.OLIVE_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.PLANE_LADDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_FIREWOOD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_TROUGH.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_CUTTING_BOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_HERB_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_PAN_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_POT_HOLDER.get(), pBlockModelGenerators);
		...
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_SHELF.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal1(IcariaBlocks.POPULUS_LADDER.get(), pBlockModelGenerators);
	}

	public static void horizontal3(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_CYPRESS_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_CYPRESS_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_DROUGHTROOT_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_DROUGHTROOT_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_FIR_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_FIR_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_LAUREL_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_LAUREL_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_OLIVE_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_OLIVE_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_PLANE_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_PLANE_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_POPULUS_HOLDER.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.BROKEN_POPULUS_CUPBOARD.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.TINDER_FUNGUS_TREE_SHROOMS.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.TURKEY_TAIL_TREE_SHROOMS.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.horizontal3(IcariaBlocks.UNNAMED_TREE_SHROOMS.get(), pBlockModelGenerators);
	}
	...
	public static void kline(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.kline(IcariaBlocks.CYPRESS_KLINE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.kline(IcariaBlocks.DROUGHTROOT_KLINE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.kline(IcariaBlocks.FIR_KLINE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.kline(IcariaBlocks.LAUREL_KLINE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.kline(IcariaBlocks.OLIVE_KLINE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.kline(IcariaBlocks.PLANE_KLINE.get(), pBlockModelGenerators);
		IcariaBlockStateProvider.kline(IcariaBlocks.POPULUS_KLINE.get(), pBlockModelGenerators);
	}
	...
	public static void suspiciousSubstance(BlockModelGenerators pBlockModelGenerators) {
		IcariaBlockStateProvider.suspiciousSubstance(IcariaBlocks.SUSPICIOUS_SUBSTANCE.get(), pBlockModelGenerators);
	}
	...
	public static void cobweb(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiPartGenerator.multiPart(pBlock)
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "up"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_down")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_down")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "up_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_down")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_down")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south_up"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south_up")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up_down")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_up_down")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_south_west"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_down")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_down")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up_down")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_up_down")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south_up_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_south_up_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, false), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_south_west_up"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, false).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_south_west_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up_down"))))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up_down")).with(BlockModelGenerators.Y_ROT_90)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up_down")).with(BlockModelGenerators.Y_ROT_180)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_west_up_down")).with(BlockModelGenerators.Y_ROT_270)))
			.with(BlockModelGenerators.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, true).term(BlockStateProperties.UP, true).term(BlockStateProperties.DOWN, true), BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "north_east_south_west_up_down"))))
		);
	}
	...
	public static void amphora(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING, IcariaBlockStateProperties.AMPHORA_AMOUNT)
				.select(Direction.NORTH, 1, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "single"))))
				.select(Direction.NORTH, 2, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "double"))))
				.select(Direction.NORTH, 3, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "triple"))))
				.select(Direction.EAST, 1, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "single")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.EAST, 2, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "double")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.EAST, 3, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "triple")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, 1, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "single")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.SOUTH, 2, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "double")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.SOUTH, 3, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "triple")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, 1, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "single")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.WEST, 2, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "double")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.WEST, 3, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "triple")).with(BlockModelGenerators.Y_ROT_270)))
			)
		);
	}
	...
	public static void bathtub(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING, IcariaBlockStateProperties.BATHTUB_REMAINS, IcariaBlockStateProperties.PART)
				.select(Direction.NORTH, false, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head"))))
				.select(Direction.NORTH, false, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot"))))
				.select(Direction.NORTH, true, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head_remains"))))
				.select(Direction.NORTH, true, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot"))))
				.select(Direction.EAST, false, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.EAST, false, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.EAST, true, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head_remains")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.EAST, true, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, false, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.SOUTH, false, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.SOUTH, true, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head_remains")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.SOUTH, true, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, false, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.WEST, false, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.WEST, true, Part.HEAD, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "head_remains")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.WEST, true, Part.FOOT, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "foot")).with(BlockModelGenerators.Y_ROT_270)))
			)
		);
	}
	...
	public static void countertop(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING, IcariaBlockStateProperties.CANDLE, IcariaBlockStateProperties.CANDLE_AMOUNT, BlockStateProperties.LIT)
				.select(Direction.NORTH, Candle.NONE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.NONE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.NONE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.NONE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.NONE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.WHITE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.WHITE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.WHITE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.WHITE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("white_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.LIGHT_GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_gray_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GRAY_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("gray_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLACK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.BLACK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLACK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLACK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("black_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BROWN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.BROWN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BROWN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BROWN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("brown_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.RED_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.RED_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.RED_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.RED_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.RED_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.RED_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("red_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.ORANGE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.ORANGE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.ORANGE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.ORANGE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("orange_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.YELLOW_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.YELLOW_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.YELLOW_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.YELLOW_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("yellow_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIME_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.LIME_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIME_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIME_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("lime_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.GREEN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.GREEN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.GREEN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.GREEN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("green_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.CYAN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.CYAN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.CYAN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.CYAN_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("cyan_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.LIGHT_BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.LIGHT_BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.LIGHT_BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.LIGHT_BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("light_blue_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.BLUE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("blue_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PURPLE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.PURPLE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PURPLE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PURPLE_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("purple_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.MAGENTA_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.MAGENTA_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.MAGENTA_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.MAGENTA_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("magenta_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 0, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 0, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock)).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "1"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 1, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_1"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 1, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_1")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "2"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 2, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_2"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 2, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_2")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "3"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 3, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_3"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 3, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_3")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "4"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 4, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "4")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, Candle.PINK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_4"))))
				.select(Direction.EAST, Candle.PINK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, Candle.PINK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, Candle.PINK_CANDLE, 4, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile("pink_candle", pBlock, "lit_4")).with(BlockModelGenerators.Y_ROT_270)))
			)
		);
	}
	...
	public static void firewoodWedge(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING, IcariaBlockStateProperties.FIREWOOD_WEDGE)
				.select(Direction.NORTH, FirewoodWedge.JAGGED, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "jagged"))))
				.select(Direction.NORTH, FirewoodWedge.SMOOTH, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "smooth"))))
				.select(Direction.EAST, FirewoodWedge.JAGGED, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "jagged")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.EAST, FirewoodWedge.SMOOTH, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "smooth")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, FirewoodWedge.JAGGED, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "jagged")).with(BlockModelGenerators.Y_ROT_180)))
	...
	public static void flowerPotCountertop(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING, IcariaBlockStateProperties.FLOWER_POTTED)
				.select(Direction.NORTH, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0"))))
				.select(Direction.EAST, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, false, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0")).with(BlockModelGenerators.Y_ROT_270)))
				.select(Direction.NORTH, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "1"))))
				.select(Direction.EAST, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "1")).with(BlockModelGenerators.Y_ROT_90)))
				.select(Direction.SOUTH, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "1")).with(BlockModelGenerators.Y_ROT_180)))
				.select(Direction.WEST, true, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "1")).with(BlockModelGenerators.Y_ROT_270)))
			)
		);
	}
	...
	public static void horizontal1(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
	...
	public static void horizontal3(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING)
	...
	public static void suspiciousSubstance(Block pBlock, BlockModelGenerators pBlockModelGenerators) {
		pBlockModelGenerators.blockStateOutput.accept(MultiVariantGenerator.dispatch(pBlock)
			.with(PropertyDispatch.initial(BlockStateProperties.HORIZONTAL_FACING, IcariaBlockStateProperties.SUSPICIOUS_SUBSTANCE)
				.select(Direction.NORTH, 0, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0"))))
				...
				.select(Direction.EAST, 0, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0")).with(BlockModelGenerators.Y_ROT_90)))
				...
				.select(Direction.SOUTH, 0, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0")).with(BlockModelGenerators.Y_ROT_180)))
				...
				.select(Direction.WEST, 0, BlockModelGenerators.variants(BlockModelGenerators.plainModel(IcariaModelProvider.blockFile(pBlock, "0")).with(BlockModelGenerators.Y_ROT_270)))
