...
public class IcariaEnglishLanguageProvider extends LanguageProvider {
	...
	public void addTranslations() {
		...
		this.add("advancement" + "." + IcariaIdents.ID + "." + "hyliaster" + "." + "description", "Kill a Hyliaster");
		...
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_crystal_rays", "Render Crystal Rays");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_crystal_rays" + "." + "tooltip", "Default: ON. Whether a Crystal should render Rays.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_settings", "Render Distance Settings");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_settings" + "." + "tooltip", "Render Distance Settings");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_crystal_rays", "Render Distance Crystal Rays");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_crystal_rays" + "." + "tooltip", "Default: 256. Whether a Crystal should render Rays based on Distance to a Player.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_fireplace_items", "Render Distance Fireplace Items");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_fireplace_items" + "." + "tooltip", "Default: 256. Whether a Fireplace should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_forge_items", "Render Distance Forge Items");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_forge_items" + "." + "tooltip", "Default: 256. Whether a Forge should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_grinder_gears", "Render Distance Grinder Gears");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_grinder_gears" + "." + "tooltip", "Default: 256. Whether a Grinder should render Gears based on Distance to a Player.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_kettle_items", "Render Distance Kettle Items");
		...
		this.add("instrument" + "." + IcariaIdents.ID + "." + "fail_capella_horn", "Fail");
