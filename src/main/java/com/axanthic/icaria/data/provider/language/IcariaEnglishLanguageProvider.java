...
public class IcariaEnglishLanguageProvider extends LanguageProvider {
	public IcariaEnglishLanguageProvider(PackOutput pPackOutput, String pId, String pLanguage) {
		super(pPackOutput, pId, pLanguage);
	}

	@Override
	public void addTranslations() {
		this.add("advancement" + "." + IcariaKeys.ID + "." + "root" + "." + "title", "The Lands of Icaria");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "arachne" + "." + "title", "Caught in the Net");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "barrel" + "." + "title", "I got a Headache");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "captain_revenant" + "." + "title", "Wasn't it dead already?");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "chert_pickaxe" + "." + "title", "Chert Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "chest" + "." + "title", "Labeling Everything");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "fertilized_farmland" + "." + "title", "Feeding Plants");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "loot_vase" + "." + "title", "Heavy Lifting");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "storage_vase" + "." + "title", "Bigger than a Chest");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "chalkos_pickaxe" + "." + "title", "Chalkos Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "kiln" + "." + "title", "I am Kiln it");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "kassiteros_pickaxe" + "." + "title", "Kassiteros Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "forge" + "." + "title", "Getting hot in here");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "orichalcum_pickaxe" + "." + "title", "Orichalcum Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "grinder" + "." + "title", "I had to grind for this");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "vanadiumsteel_pickaxe" + "." + "title", "Vanadiumsteel Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "kettle" + "." + "title", "It's not a Teapot");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "sideros_pickaxe" + "." + "title", "Sideros Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "hyliaster" + "." + "title", "Slimy Foe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "molybdenumsteel_pickaxe" + "." + "title", "Molybdenumsteel Pickaxe");

		this.add("advancement" + "." + IcariaKeys.ID + "." + "root" + "." + "description", "Travel to the Lands of Icaria");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "arachne" + "." + "description", "Kill an Arachne");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "barrel" + "." + "description", "Carry a Barrel");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "captain_revenant" + "." + "description", "Kill a Captain Revenant");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "chert_pickaxe" + "." + "description", "Craft a Chert Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "chest" + "." + "description", "Place a Label on a Chest");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "fertilized_farmland" + "." + "description", "Fertilize Farmland with Calcite");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "loot_vase" + "." + "description", "Carry a Loot Vase");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "storage_vase" + "." + "description", "Place a Storage Vase");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "chalkos_pickaxe" + "." + "description", "Craft a Chalkos Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "kiln" + "." + "description", "Place a Kiln");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "kassiteros_pickaxe" + "." + "description", "Craft a Kassiteros Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "forge" + "." + "description", "Place a Forge");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "orichalcum_pickaxe" + "." + "description", "Craft an Orichalcum Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "grinder" + "." + "description", "Place a Grinder");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "vanadiumsteel_pickaxe" + "." + "description", "Craft a Vanadiumsteel Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "kettle" + "." + "description", "Place a Kettle");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "sideros_pickaxe" + "." + "description", "Craft a Sideros Pickaxe");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "hyliaster" + "." + "description", "Kill a Hyliaster");
		this.add("advancement" + "." + IcariaKeys.ID + "." + "molybdenumsteel_pickaxe" + "." + "description", "Craft a Molybdenumsteel Pickaxe");

		this.add("biome" + "." + IcariaKeys.ID + "." + "forest", "Forest");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lush_forest", "Lush Forest");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lost_forest", "Lost Forest");
		this.add("biome" + "." + IcariaKeys.ID + "." + "deep_forest", "Deep Forest");
		this.add("biome" + "." + IcariaKeys.ID + "." + "scrubland", "Scrubland");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lush_scrubland", "Lush Scrubland");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lost_scrubland", "Lost Scrubland");
		this.add("biome" + "." + IcariaKeys.ID + "." + "deep_scrubland", "Deep Scrubland");
		this.add("biome" + "." + IcariaKeys.ID + "." + "steppe", "Steppe");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lush_steppe", "Lush Steppe");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lost_steppe", "Lost Steppe");
		this.add("biome" + "." + IcariaKeys.ID + "." + "deep_steppe", "Deep Steppe");
		this.add("biome" + "." + IcariaKeys.ID + "." + "desert", "Desert");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lush_desert", "Lush Desert");
		this.add("biome" + "." + IcariaKeys.ID + "." + "lost_desert", "Lost Desert");
		this.add("biome" + "." + IcariaKeys.ID + "." + "deep_desert", "Deep Desert");
		this.add("biome" + "." + IcariaKeys.ID + "." + "void", "Void");
		...
		this.add(IcariaBlocks.MARL_ADOBE_SLAB.get(), "Marl Adobe Slab");
		...
		this.add(IcariaBlocks.LOAM_BRICK_WALL.get(), "Loam Brick Wall");

		this.add(IcariaBlocks.DOLOMITE_ADOBE.get(), "Dolomite Adobe");
		this.add(IcariaBlocks.DOLOMITE_ADOBE_STAIRS.get(), "Dolomite Adobe Stairs");
		this.add(IcariaBlocks.DOLOMITE_ADOBE_SLAB.get(), "Dolomite Adobe Slab");
		this.add(IcariaBlocks.DOLOMITE_ADOBE_WALL.get(), "Dolomite Adobe Wall");
		this.add(IcariaBlocks.SMOOTH_DOLOMITE.get(), "Smooth Dolomite");
		this.add(IcariaBlocks.SMOOTH_DOLOMITE_STAIRS.get(), "Smooth Dolomite Stairs");
		this.add(IcariaBlocks.SMOOTH_DOLOMITE_SLAB.get(), "Smooth Dolomite Slab");
		this.add(IcariaBlocks.SMOOTH_DOLOMITE_WALL.get(), "Smooth Dolomite Wall");
		this.add(IcariaBlocks.DOLOMITE_BRICKS.get(), "Dolomite Bricks");
		this.add(IcariaBlocks.CHISELED_DOLOMITE.get(), "Chiseled Dolomite");
		...
		this.add(IcariaBlocks.GRAINITE_ADOBE_STAIRS.get(), "Grainite Adobe Stairs");
		this.add(IcariaBlocks.GRAINITE_ADOBE_SLAB.get(), "Grainite Adobe Slab");
		this.add(IcariaBlocks.GRAINITE_ADOBE_WALL.get(), "Grainite Adobe Wall");
		this.add(IcariaBlocks.GRAINITE.get(), "Grainite");
		this.add(IcariaBlocks.GRAINITE_STAIRS.get(), "Grainite Stairs");
		this.add(IcariaBlocks.GRAINITE_SLAB.get(), "Grainite Slab");
		this.add(IcariaBlocks.GRAINITE_WALL.get(), "Grainite Wall");
		this.add(IcariaBlocks.GRAINITE_BRICKS.get(), "Grainite Bricks");
		this.add(IcariaBlocks.GRAINITE_BRICK_STAIRS.get(), "Grainite Brick Stairs");
		this.add(IcariaBlocks.GRAINITE_BRICK_SLAB.get(), "Grainite Brick Slab");
		this.add(IcariaBlocks.GRAINITE_BRICK_WALL.get(), "Grainite Brick Wall");
		...
		this.add(IcariaBlocks.YELLOWSTONE_ADOBE_STAIRS.get(), "Yellowstone Adobe Stairs");
		this.add(IcariaBlocks.YELLOWSTONE_ADOBE_SLAB.get(), "Yellowstone Adobe Slab");
		this.add(IcariaBlocks.YELLOWSTONE_ADOBE_WALL.get(), "Yellowstone Adobe Wall");
		this.add(IcariaBlocks.COBBLED_YELLOWSTONE.get(), "Cobbled Yellowstone");
		this.add(IcariaBlocks.COBBLED_YELLOWSTONE_STAIRS.get(), "Cobbled Yellowstone Stairs");
		this.add(IcariaBlocks.COBBLED_YELLOWSTONE_SLAB.get(), "Cobbled Yellowstone Slab");
		this.add(IcariaBlocks.COBBLED_YELLOWSTONE_WALL.get(), "Cobbled Yellowstone Wall");
		this.add(IcariaBlocks.YELLOWSTONE.get(), "Yellowstone");
		this.add(IcariaBlocks.YELLOWSTONE_STAIRS.get(), "Yellowstone Stairs");
		this.add(IcariaBlocks.YELLOWSTONE_SLAB.get(), "Yellowstone Slab");
		this.add(IcariaBlocks.YELLOWSTONE_WALL.get(), "Yellowstone Wall");
		this.add(IcariaBlocks.YELLOWSTONE_BRICKS.get(), "Yellowstone Bricks");
		this.add(IcariaBlocks.YELLOWSTONE_BRICK_STAIRS.get(), "Yellowstone Brick Stairs");
		this.add(IcariaBlocks.YELLOWSTONE_BRICK_SLAB.get(), "Yellowstone Brick Slab");
		this.add(IcariaBlocks.YELLOWSTONE_BRICK_WALL.get(), "Yellowstone Brick Wall");
		...
		this.add(IcariaBlocks.SILKSTONE_ADOBE_STAIRS.get(), "Silkstone Adobe Stairs");
		this.add(IcariaBlocks.SILKSTONE_ADOBE_SLAB.get(), "Silkstone Adobe Slab");
		this.add(IcariaBlocks.SILKSTONE_ADOBE_WALL.get(), "Silkstone Adobe Wall");
		this.add(IcariaBlocks.COBBLED_SILKSTONE.get(), "Cobbled Silkstone");
		this.add(IcariaBlocks.COBBLED_SILKSTONE_STAIRS.get(), "Cobbled Silkstone Stairs");
		this.add(IcariaBlocks.COBBLED_SILKSTONE_SLAB.get(), "Cobbled Silkstone Slab");
		this.add(IcariaBlocks.COBBLED_SILKSTONE_WALL.get(), "Cobbled Silkstone Wall");
		this.add(IcariaBlocks.SILKSTONE.get(), "Silkstone");
		this.add(IcariaBlocks.SILKSTONE_STAIRS.get(), "Silkstone Stairs");
		this.add(IcariaBlocks.SILKSTONE_SLAB.get(), "Silkstone Slab");
		this.add(IcariaBlocks.SILKSTONE_WALL.get(), "Silkstone Wall");
		this.add(IcariaBlocks.SILKSTONE_BRICKS.get(), "Silkstone Bricks");
		this.add(IcariaBlocks.SILKSTONE_BRICK_STAIRS.get(), "Silkstone Brick Stairs");
		this.add(IcariaBlocks.SILKSTONE_BRICK_SLAB.get(), "Silkstone Brick Slab");
		this.add(IcariaBlocks.SILKSTONE_BRICK_WALL.get(), "Silkstone Brick Wall");
		...
		this.add(IcariaBlocks.SUNSTONE_ADOBE_STAIRS.get(), "Sunstone Adobe Stairs");
		this.add(IcariaBlocks.SUNSTONE_ADOBE_SLAB.get(), "Sunstone Adobe Slab");
		this.add(IcariaBlocks.SUNSTONE_ADOBE_WALL.get(), "Sunstone Adobe Wall");
		this.add(IcariaBlocks.COBBLED_SUNSTONE.get(), "Cobbled Sunstone");
		this.add(IcariaBlocks.COBBLED_SUNSTONE_STAIRS.get(), "Cobbled Sunstone Stairs");
		this.add(IcariaBlocks.COBBLED_SUNSTONE_SLAB.get(), "Cobbled Sunstone Slab");
		this.add(IcariaBlocks.COBBLED_SUNSTONE_WALL.get(), "Cobbled Sunstone Wall");
		this.add(IcariaBlocks.SUNSTONE.get(), "Sunstone");
		this.add(IcariaBlocks.SUNSTONE_STAIRS.get(), "Sunstone Stairs");
		this.add(IcariaBlocks.SUNSTONE_SLAB.get(), "Sunstone Slab");
		this.add(IcariaBlocks.SUNSTONE_WALL.get(), "Sunstone Wall");
		this.add(IcariaBlocks.SUNSTONE_BRICKS.get(), "Sunstone Bricks");
		this.add(IcariaBlocks.SUNSTONE_BRICK_STAIRS.get(), "Sunstone Brick Stairs");
		this.add(IcariaBlocks.SUNSTONE_BRICK_SLAB.get(), "Sunstone Brick Slab");
		this.add(IcariaBlocks.SUNSTONE_BRICK_WALL.get(), "Sunstone Brick Wall");
		...
		this.add(IcariaBlocks.VOIDSHALE_ADOBE_STAIRS.get(), "Voidshale Adobe Stairs");
		this.add(IcariaBlocks.VOIDSHALE_ADOBE_SLAB.get(), "Voidshale Adobe Slab");
		this.add(IcariaBlocks.VOIDSHALE_ADOBE_WALL.get(), "Voidshale Adobe Wall");
		this.add(IcariaBlocks.COBBLED_VOIDSHALE.get(), "Cobbled Voidshale");
		this.add(IcariaBlocks.COBBLED_VOIDSHALE_STAIRS.get(), "Cobbled Voidshale Stairs");
		this.add(IcariaBlocks.COBBLED_VOIDSHALE_SLAB.get(), "Cobbled Voidshale Slab");
		this.add(IcariaBlocks.COBBLED_VOIDSHALE_WALL.get(), "Cobbled Voidshale Wall");
		this.add(IcariaBlocks.VOIDSHALE.get(), "Voidshale");
		this.add(IcariaBlocks.VOIDSHALE_STAIRS.get(), "Voidshale Stairs");
		this.add(IcariaBlocks.VOIDSHALE_SLAB.get(), "Voidshale Slab");
		this.add(IcariaBlocks.VOIDSHALE_WALL.get(), "Voidshale Wall");
		this.add(IcariaBlocks.VOIDSHALE_BRICKS.get(), "Voidshale Bricks");
		this.add(IcariaBlocks.VOIDSHALE_BRICK_STAIRS.get(), "Voidshale Brick Stairs");
		this.add(IcariaBlocks.VOIDSHALE_BRICK_SLAB.get(), "Voidshale Brick Slab");
		this.add(IcariaBlocks.VOIDSHALE_BRICK_WALL.get(), "Voidshale Brick Wall");
		...
		this.add(IcariaBlocks.BAETYL_ADOBE_STAIRS.get(), "Baetyl Adobe Stairs");
		this.add(IcariaBlocks.BAETYL_ADOBE_SLAB.get(), "Baetyl Adobe Slab");
		this.add(IcariaBlocks.BAETYL_ADOBE_WALL.get(), "Baetyl Adobe Wall");
		this.add(IcariaBlocks.COBBLED_BAETYL.get(), "Cobbled Baetyl");
		this.add(IcariaBlocks.COBBLED_BAETYL_STAIRS.get(), "Cobbled Baetyl Stairs");
		this.add(IcariaBlocks.COBBLED_BAETYL_SLAB.get(), "Cobbled Baetyl Slab");
		this.add(IcariaBlocks.COBBLED_BAETYL_WALL.get(), "Cobbled Baetyl Wall");
		this.add(IcariaBlocks.BAETYL.get(), "Baetyl");
		this.add(IcariaBlocks.BAETYL_STAIRS.get(), "Baetyl Stairs");
		this.add(IcariaBlocks.BAETYL_SLAB.get(), "Baetyl Slab");
		this.add(IcariaBlocks.BAETYL_WALL.get(), "Baetyl Wall");
		this.add(IcariaBlocks.BAETYL_BRICKS.get(), "Baetyl Bricks");
		this.add(IcariaBlocks.BAETYL_BRICK_STAIRS.get(), "Baetyl Brick Stairs");
		this.add(IcariaBlocks.BAETYL_BRICK_SLAB.get(), "Baetyl Brick Slab");
		this.add(IcariaBlocks.BAETYL_BRICK_WALL.get(), "Baetyl Brick Wall");
		...
		this.add(IcariaBlocks.RELICSTONE_STAIRS.get(), "Relicstone Stairs");
		this.add(IcariaBlocks.RELICSTONE_SLAB.get(), "Relicstone Slab");
		this.add(IcariaBlocks.RELICSTONE_WALL.get(), "Relicstone Wall");
		this.add(IcariaBlocks.SMOOTH_RELICSTONE.get(), "Smooth Relicstone");
		this.add(IcariaBlocks.SMOOTH_RELICSTONE_STAIRS.get(), "Smooth Relicstone Stairs");
		this.add(IcariaBlocks.SMOOTH_RELICSTONE_SLAB.get(), "Smooth Relicstone Slab");
		this.add(IcariaBlocks.SMOOTH_RELICSTONE_WALL.get(), "Smooth Relicstone Wall");
		this.add(IcariaBlocks.RELICSTONE_BRICKS.get(), "Relicstone Bricks");
		this.add(IcariaBlocks.RELICSTONE_BRICK_STAIRS.get(), "Relicstone Brick Stairs");
		this.add(IcariaBlocks.RELICSTONE_BRICK_SLAB.get(), "Relicstone Brick Slab");
		this.add(IcariaBlocks.RELICSTONE_BRICK_WALL.get(), "Relicstone Brick Wall");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_BRICKS.get(), "Cracked Relicstone Bricks");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_BRICK_STAIRS.get(), "Cracked Relicstone Brick Stairs");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_BRICK_SLAB.get(), "Cracked Relicstone Brick Slab");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_BRICK_WALL.get(), "Cracked Relicstone Brick Wall");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_BRICKS.get(), "Mossy Relicstone Bricks");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_BRICK_STAIRS.get(), "Mossy Relicstone Brick Stairs");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_BRICK_SLAB.get(), "Mossy Relicstone Brick Slab");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_BRICK_WALL.get(), "Mossy Relicstone Brick Wall");
		this.add(IcariaBlocks.RELICSTONE_TILES.get(), "Relicstone Tiles");
		this.add(IcariaBlocks.RELICSTONE_TILE_STAIRS.get(), "Relicstone Tile Stairs");
		this.add(IcariaBlocks.RELICSTONE_TILE_SLAB.get(), "Relicstone Tile Slab");
		this.add(IcariaBlocks.RELICSTONE_TILE_WALL.get(), "Relicstone Tile Wall");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_TILES.get(), "Cracked Relicstone Tiles");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_TILE_STAIRS.get(), "Cracked Relicstone Tile Stairs");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_TILE_SLAB.get(), "Cracked Relicstone Tile Slab");
		this.add(IcariaBlocks.CRACKED_RELICSTONE_TILE_WALL.get(), "Cracked Relicstone Tile Wall");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_TILES.get(), "Mossy Relicstone Tiles");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_TILE_STAIRS.get(), "Mossy Relicstone Tile Stairs");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_TILE_SLAB.get(), "Mossy Relicstone Tile Slab");
		this.add(IcariaBlocks.MOSSY_RELICSTONE_TILE_WALL.get(), "Mossy Relicstone Tile Wall");
		...
		this.add(IcariaBlocks.PLATOSHALE_STAIRS.get(), "Platoshale Stairs");
		this.add(IcariaBlocks.PLATOSHALE_SLAB.get(), "Platoshale Slab");
		this.add(IcariaBlocks.PLATOSHALE_WALL.get(), "Platoshale Wall");
		...
		this.add(IcariaBlocks.PLATOSHALE_BRICK_STAIRS.get(), "Platoshale Brick Stairs");
		this.add(IcariaBlocks.PLATOSHALE_BRICK_SLAB.get(), "Platoshale Brick Slab");
		this.add(IcariaBlocks.PLATOSHALE_BRICK_WALL.get(), "Platoshale Brick Wall");
		...
		this.add(IcariaBlocks.AMPHORA.get(), "Amphora");
		...
		this.add(IcariaBlocks.CYPRESS_STAIRS.get(), "Cypress Stairs");
		this.add(IcariaBlocks.CYPRESS_SLAB.get(), "Cypress Slab");
		this.add(IcariaBlocks.CYPRESS_FENCE.get(), "Cypress Fence");
		this.add(IcariaBlocks.CYPRESS_FENCE_GATE.get(), "Cypress Fence Gate");
		...
		this.add(IcariaBlocks.CYPRESS_CUTTING_BOARD.get(), "Cypress Cutting Board");
		...
		this.add(IcariaBlocks.CYPRESS_POT_COUNTERTOP.get(), "Cypress Pot Countertop");
		this.add(IcariaBlocks.CYPRESS_BASINS_COUNTERTOP.get(), "Cypress Basins Countertop");
		this.add(IcariaBlocks.CYPRESS_RAISED_BASINS_COUNTERTOP.get(), "Cypress Raised Basins Countertop");
		this.add(IcariaBlocks.CYPRESS_CUPBOARD.get(), "Cypress Cupboard");
		this.add(IcariaBlocks.CYPRESS_DISHES_CUPBOARD.get(), "Cypress Dishes Cupboard");
		...
		this.add(IcariaBlocks.DROUGHTROOT_STAIRS.get(), "Droughtroot Stairs");
		this.add(IcariaBlocks.DROUGHTROOT_SLAB.get(), "Droughtroot Slab");
		this.add(IcariaBlocks.DROUGHTROOT_FENCE.get(), "Droughtroot Fence");
		this.add(IcariaBlocks.DROUGHTROOT_FENCE_GATE.get(), "Droughtroot Fence Gate");
		...
		this.add(IcariaBlocks.DROUGHTROOT_CUTTING_BOARD.get(), "Droughtroot Cutting Board");
		...
		this.add(IcariaBlocks.DROUGHTROOT_POT_COUNTERTOP.get(), "Droughtroot Pot Countertop");
		this.add(IcariaBlocks.DROUGHTROOT_BASINS_COUNTERTOP.get(), "Droughtroot Basins Countertop");
		this.add(IcariaBlocks.DROUGHTROOT_RAISED_BASINS_COUNTERTOP.get(), "Droughtroot Raised Basins Countertop");
		this.add(IcariaBlocks.DROUGHTROOT_CUPBOARD.get(), "Droughtroot Cupboard");
		this.add(IcariaBlocks.DROUGHTROOT_DISHES_CUPBOARD.get(), "Droughtroot Dishes Cupboard");
		...
		this.add(IcariaBlocks.FIR_STAIRS.get(), "Fir Stairs");
		this.add(IcariaBlocks.FIR_SLAB.get(), "Fir Slab");
		this.add(IcariaBlocks.FIR_FENCE.get(), "Fir Fence");
		this.add(IcariaBlocks.FIR_FENCE_GATE.get(), "Fir Fence Gate");
		...
		this.add(IcariaBlocks.FIR_CUTTING_BOARD.get(), "Fir Cutting Board");
		...
		this.add(IcariaBlocks.FIR_POT_COUNTERTOP.get(), "Fir Pot Countertop");
		this.add(IcariaBlocks.FIR_BASINS_COUNTERTOP.get(), "Fir Basins Countertop");
		this.add(IcariaBlocks.FIR_RAISED_BASINS_COUNTERTOP.get(), "Fir Raised Basins Countertop");
		this.add(IcariaBlocks.FIR_CUPBOARD.get(), "Fir Cupboard");
		this.add(IcariaBlocks.FIR_DISHES_CUPBOARD.get(), "Fir Dishes Cupboard");
		...
		this.add(IcariaBlocks.LAUREL_STAIRS.get(), "Laurel Stairs");
		this.add(IcariaBlocks.LAUREL_SLAB.get(), "Laurel Slab");
		this.add(IcariaBlocks.LAUREL_FENCE.get(), "Laurel Fence");
		this.add(IcariaBlocks.LAUREL_FENCE_GATE.get(), "Laurel Fence Gate");
		...
		this.add(IcariaBlocks.LAUREL_CUTTING_BOARD.get(), "Laurel Cutting Board");
		...
		this.add(IcariaBlocks.LAUREL_POT_COUNTERTOP.get(), "Laurel Pot Countertop");
		this.add(IcariaBlocks.LAUREL_BASINS_COUNTERTOP.get(), "Laurel Basins Countertop");
		this.add(IcariaBlocks.LAUREL_RAISED_BASINS_COUNTERTOP.get(), "Laurel Raised Basins Countertop");
		this.add(IcariaBlocks.LAUREL_CUPBOARD.get(), "Laurel Cupboard");
		this.add(IcariaBlocks.LAUREL_DISHES_CUPBOARD.get(), "Laurel Dishes Cupboard");
		...
		this.add(IcariaBlocks.OLIVE_STAIRS.get(), "Olive Stairs");
		this.add(IcariaBlocks.OLIVE_SLAB.get(), "Olive Slab");
		this.add(IcariaBlocks.OLIVE_FENCE.get(), "Olive Fence");
		this.add(IcariaBlocks.OLIVE_FENCE_GATE.get(), "Olive Fence Gate");
		...
		this.add(IcariaBlocks.OLIVE_CUTTING_BOARD.get(), "Olive Cutting Board");
		...
		this.add(IcariaBlocks.OLIVE_POT_COUNTERTOP.get(), "Olive Pot Countertop");
		this.add(IcariaBlocks.OLIVE_BASINS_COUNTERTOP.get(), "Olive Basins Countertop");
		this.add(IcariaBlocks.OLIVE_RAISED_BASINS_COUNTERTOP.get(), "Olive Raised Basins Countertop");
		this.add(IcariaBlocks.OLIVE_CUPBOARD.get(), "Olive Cupboard");
		this.add(IcariaBlocks.OLIVE_DISHES_CUPBOARD.get(), "Olive Dishes Cupboard");
		...
		this.add(IcariaBlocks.PLANE_STAIRS.get(), "Plane Stairs");
		this.add(IcariaBlocks.PLANE_SLAB.get(), "Plane Slab");
		this.add(IcariaBlocks.PLANE_FENCE.get(), "Plane Fence");
		this.add(IcariaBlocks.PLANE_FENCE_GATE.get(), "Plane Fence Gate");
		...
		this.add(IcariaBlocks.PLANE_CUTTING_BOARD.get(), "Plane Cutting Board");
		...
		this.add(IcariaBlocks.PLANE_POT_COUNTERTOP.get(), "Plane Pot Countertop");
		this.add(IcariaBlocks.PLANE_BASINS_COUNTERTOP.get(), "Plane Basins Countertop");
		this.add(IcariaBlocks.PLANE_RAISED_BASINS_COUNTERTOP.get(), "Plane Raised Basins Countertop");
		this.add(IcariaBlocks.PLANE_CUPBOARD.get(), "Plane Cupboard");
		this.add(IcariaBlocks.PLANE_DISHES_CUPBOARD.get(), "Plane Dishes Cupboard");
		...
		this.add(IcariaBlocks.POPULUS_STAIRS.get(), "Populus Stairs");
		this.add(IcariaBlocks.POPULUS_SLAB.get(), "Populus Slab");
		this.add(IcariaBlocks.POPULUS_FENCE.get(), "Populus Fence");
		this.add(IcariaBlocks.POPULUS_FENCE_GATE.get(), "Populus Fence Gate");
		...
		this.add(IcariaBlocks.POPULUS_CUTTING_BOARD.get(), "Populus Cutting Board");
		...
		this.add(IcariaBlocks.POPULUS_POT_COUNTERTOP.get(), "Populus Pot Countertop");
		this.add(IcariaBlocks.POPULUS_BASINS_COUNTERTOP.get(), "Populus Basins Countertop");
		this.add(IcariaBlocks.POPULUS_RAISED_BASINS_COUNTERTOP.get(), "Populus Raised Basins Countertop");
		this.add(IcariaBlocks.POPULUS_CUPBOARD.get(), "Populus Cupboard");
		this.add(IcariaBlocks.POPULUS_DISHES_CUPBOARD.get(), "Populus Dishes Cupboard");
		...
		this.add("category" + "." + IcariaKeys.ID + "." + "firing", "Firing");
		this.add("category" + "." + IcariaKeys.ID + "." + "forging", "Forging");
		this.add("category" + "." + IcariaKeys.ID + "." + "grinding", "Grinding");

		this.add("command" + "." + IcariaKeys.ID + "." + "heal" + "." + "success", "Healed successfully");

		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_settings", "Render Settings");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_settings" + "." + "tooltip", "Render Settings");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_crystal_rays", "Render Crystal Rays");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_crystal_rays" + "." + "tooltip", "Default: ON. Whether a Crystal should render Rays.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_settings", "Render Distance Settings");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_settings" + "." + "tooltip", "Render Distance Settings");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_crystal_rays", "Render Distance Crystal Rays");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_crystal_rays" + "." + "tooltip", "Default: 256. Whether a Crystal should render Rays based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_fireplace_items", "Render Distance Fireplace Items");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_fireplace_items" + "." + "tooltip", "Default: 256. Whether a Fireplace should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_forge_items", "Render Distance Forge Items");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_forge_items" + "." + "tooltip", "Default: 256. Whether a Forge should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_grinder_gears", "Render Distance Grinder Gears");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_grinder_gears" + "." + "tooltip", "Default: 256. Whether a Grinder should render Gears based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_kettle_items", "Render Distance Kettle Items");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_kettle_items" + "." + "tooltip", "Default: 256. Whether a Kettle should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_kiln_items", "Render Distance Kiln Items");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_kiln_items" + "." + "tooltip", "Default: 256. Whether a Kiln should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_hutch_items", "Render Distance Hutch Items");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "render_distance_hutch_items" + "." + "tooltip", "Default: 256. Whether a Hutch should render Items based on Distance to a Player.");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "spawn_settings", "Spawn Settings");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "spawn_settings" + "." + "tooltip", "Spawn Settings");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "spawn_arachnids", "Spawn Arachnids");
		this.add("configuration" + "." + IcariaKeys.ID + "." + "spawn_arachnids" + "." + "tooltip", "Default: ON. Whether Arachnids should spawn.");
		...
		this.add(IcariaEntityTypes.FEESH.get(), "Feesh");
		this.add(IcariaEntityTypes.FICHE.get(), "Fiche");
		this.add(IcariaEntityTypes.FISSHH.get(), "Fisshh");
		this.add(IcariaEntityTypes.FYSH.get(), "Fysh");
		...
		this.add("fluid" + "." + IcariaKeys.ID + "." + "mediterranean_water", "Mediterranean Water");

		this.add("instrument" + "." + IcariaKeys.ID + "." + "fail_capella_horn", "Fail");

		this.add("item" + "." + IcariaKeys.MC + "." + "tipped_arrow" + "." + "effect" + "." + "blindness", "Arrow of Blindness");
		this.add("item" + "." + IcariaKeys.MC + "." + "tipped_arrow" + "." + "effect" + "." + "nausea", "Arrow of Nausea");
		this.add("item" + "." + IcariaKeys.MC + "." + "tipped_arrow" + "." + "effect" + "." + "wither", "Arrow of Wither");

		this.add("item" + "." + IcariaKeys.MC + "." + "potion" + "." + "effect" + "." + "blindness", "Potion of Blindness");
		this.add("item" + "." + IcariaKeys.MC + "." + "potion" + "." + "effect" + "." + "nausea", "Potion of Nausea");
		this.add("item" + "." + IcariaKeys.MC + "." + "potion" + "." + "effect" + "." + "wither", "Potion of Wither");

		this.add("item" + "." + IcariaKeys.MC + "." + "splash_potion" + "." + "effect" + "." + "blindness", "Splash Potion of Blindness");
		this.add("item" + "." + IcariaKeys.MC + "." + "splash_potion" + "." + "effect" + "." + "nausea", "Splash Potion of Nausea");
		this.add("item" + "." + IcariaKeys.MC + "." + "splash_potion" + "." + "effect" + "." + "wither", "Splash Potion of Wither");

		this.add("item" + "." + IcariaKeys.MC + "." + "lingering_potion" + "." + "effect" + "." + "blindness", "Lingering Potion of Blindness");
		this.add("item" + "." + IcariaKeys.MC + "." + "lingering_potion" + "." + "effect" + "." + "nausea", "Lingering Potion of Nausea");
		this.add("item" + "." + IcariaKeys.MC + "." + "lingering_potion" + "." + "effect" + "." + "wither", "Lingering Potion of Wither");
		...
		this.add(IcariaItems.CHERT_SWORD.get(), "Chert Sword");
		this.add(IcariaItems.CHERT_DAGGER.get(), "Chert Dagger");
		this.add(IcariaItems.CHERT_SHOVEL.get(), "Chert Shovel");
		this.add(IcariaItems.CHERT_PICKAXE.get(), "Chert Pickaxe");
		this.add(IcariaItems.CHERT_AXE.get(), "Chert Axe");
		this.add(IcariaItems.CHERT_SCYTHE.get(), "Chert Scythe");
		this.add(IcariaItems.CHERT_BIDENT.get(), "Chert Bident");
		this.add(IcariaItems.CHALKOS_SWORD.get(), "Chalkos Sword");
		this.add(IcariaItems.CHALKOS_DAGGER.get(), "Chalkos Dagger");
		this.add(IcariaItems.CHALKOS_SHOVEL.get(), "Chalkos Shovel");
		this.add(IcariaItems.CHALKOS_PICKAXE.get(), "Chalkos Pickaxe");
		this.add(IcariaItems.CHALKOS_AXE.get(), "Chalkos Axe");
		this.add(IcariaItems.CHALKOS_SCYTHE.get(), "Chalkos Scythe");
		this.add(IcariaItems.CHALKOS_BIDENT.get(), "Chalkos Bident");
		this.add(IcariaItems.KASSITEROS_SWORD.get(), "Kassiteros Sword");
		this.add(IcariaItems.KASSITEROS_DAGGER.get(), "Kassiteros Dagger");
		this.add(IcariaItems.KASSITEROS_SHOVEL.get(), "Kassiteros Shovel");
		this.add(IcariaItems.KASSITEROS_PICKAXE.get(), "Kassiteros Pickaxe");
		this.add(IcariaItems.KASSITEROS_AXE.get(), "Kassiteros Axe");
		this.add(IcariaItems.KASSITEROS_SCYTHE.get(), "Kassiteros Scythe");
		this.add(IcariaItems.KASSITEROS_BIDENT.get(), "Kassiteros Bident");
		this.add(IcariaItems.ORICHALCUM_SWORD.get(), "Orichalcum Sword");
		this.add(IcariaItems.ORICHALCUM_DAGGER.get(), "Orichalcum Dagger");
		this.add(IcariaItems.ORICHALCUM_SHOVEL.get(), "Orichalcum Shovel");
		this.add(IcariaItems.ORICHALCUM_PICKAXE.get(), "Orichalcum Pickaxe");
		this.add(IcariaItems.ORICHALCUM_AXE.get(), "Orichalcum Axe");
		this.add(IcariaItems.ORICHALCUM_SCYTHE.get(), "Orichalcum Scythe");
		this.add(IcariaItems.ORICHALCUM_BIDENT.get(), "Orichalcum Bident");
		this.add(IcariaItems.VANADIUMSTEEL_SWORD.get(), "Vanadiumsteel Sword");
		this.add(IcariaItems.VANADIUMSTEEL_DAGGER.get(), "Vanadiumsteel Dagger");
		this.add(IcariaItems.VANADIUMSTEEL_SHOVEL.get(), "Vanadiumsteel Shovel");
		this.add(IcariaItems.VANADIUMSTEEL_PICKAXE.get(), "Vanadiumsteel Pickaxe");
		this.add(IcariaItems.VANADIUMSTEEL_AXE.get(), "Vanadiumsteel Axe");
		this.add(IcariaItems.VANADIUMSTEEL_SCYTHE.get(), "Vanadiumsteel Scythe");
		this.add(IcariaItems.VANADIUMSTEEL_BIDENT.get(), "Vanadiumsteel Bident");
		this.add(IcariaItems.SIDEROS_SWORD.get(), "Sideros Sword");
		this.add(IcariaItems.SIDEROS_DAGGER.get(), "Sideros Dagger");
		this.add(IcariaItems.SIDEROS_SHOVEL.get(), "Sideros Shovel");
		this.add(IcariaItems.SIDEROS_PICKAXE.get(), "Sideros Pickaxe");
		this.add(IcariaItems.SIDEROS_AXE.get(), "Sideros Axe");
		this.add(IcariaItems.SIDEROS_SCYTHE.get(), "Sideros Scythe");
		this.add(IcariaItems.SIDEROS_BIDENT.get(), "Sideros Bident");
		this.add(IcariaItems.MOLYBDENUMSTEEL_SWORD.get(), "Molybdenumsteel Sword");
		this.add(IcariaItems.MOLYBDENUMSTEEL_DAGGER.get(), "Molybdenumsteel Dagger");
		this.add(IcariaItems.MOLYBDENUMSTEEL_SHOVEL.get(), "Molybdenumsteel Shovel");
		this.add(IcariaItems.MOLYBDENUMSTEEL_PICKAXE.get(), "Molybdenumsteel Pickaxe");
		this.add(IcariaItems.MOLYBDENUMSTEEL_AXE.get(), "Molybdenumsteel Axe");
		this.add(IcariaItems.MOLYBDENUMSTEEL_SCYTHE.get(), "Molybdenumsteel Scythe");
		this.add(IcariaItems.MOLYBDENUMSTEEL_BIDENT.get(), "Molybdenumsteel Bident");

		this.add(IcariaItems.AETERNAE_HIDE_HELMET.get(), "Aeternae Hide Helmet");
		this.add(IcariaItems.AETERNAE_HIDE_CHESTPLATE.get(), "Aeternae Hide Chestplate");
		this.add(IcariaItems.AETERNAE_HIDE_LEGGINGS.get(), "Aeternae Hide Leggings");
		this.add(IcariaItems.AETERNAE_HIDE_BOOTS.get(), "Aeternae Hide Boots");
		this.add(IcariaItems.CHALKOS_HELMET.get(), "Chalkos Helmet");
		this.add(IcariaItems.CHALKOS_CHESTPLATE.get(), "Chalkos Chestplate");
		this.add(IcariaItems.CHALKOS_LEGGINGS.get(), "Chalkos Leggings");
		this.add(IcariaItems.CHALKOS_BOOTS.get(), "Chalkos Boots");
		this.add(IcariaItems.KASSITEROS_HELMET.get(), "Kassiteros Helmet");
		this.add(IcariaItems.KASSITEROS_CHESTPLATE.get(), "Kassiteros Chestplate");
		this.add(IcariaItems.KASSITEROS_LEGGINGS.get(), "Kassiteros Leggings");
		this.add(IcariaItems.KASSITEROS_BOOTS.get(), "Kassiteros Boots");
		...
		this.add(IcariaItems.VANADIUMSTEEL_HELMET.get(), "Vanadiumsteel Helmet");
		this.add(IcariaItems.VANADIUMSTEEL_CHESTPLATE.get(), "Vanadiumsteel Chestplate");
		this.add(IcariaItems.VANADIUMSTEEL_LEGGINGS.get(), "Vanadiumsteel Leggings");
		this.add(IcariaItems.VANADIUMSTEEL_BOOTS.get(), "Vanadiumsteel Boots");
		...
		this.add(IcariaItems.RAW_BLUE_GRAY_FEESH.get(), "Raw Blue-Gray Feesh");
		this.add(IcariaItems.COOKED_BLUE_GRAY_FEESH.get(), "Cooked Blue-Gray Feesh");
		this.add(IcariaItems.RAW_BROWN_FEESH.get(), "Raw Brown Feesh");
		this.add(IcariaItems.COOKED_BROWN_FEESH.get(), "Cooked Brown Feesh");
		this.add(IcariaItems.RAW_BROWN_ORANGE_FEESH.get(), "Raw Brown-Orange Feesh");
		this.add(IcariaItems.COOKED_BROWN_ORANGE_FEESH.get(), "Cooked Brown-Orange Feesh");
		this.add(IcariaItems.RAW_PINK_RED_FEESH.get(), "Raw Pink-Red Feesh");
		this.add(IcariaItems.COOKED_PINK_RED_FEESH.get(), "Cooked Pink-Red Feesh");
		this.add(IcariaItems.RAW_PURPLE_FEESH.get(), "Raw Purple Feesh");
		this.add(IcariaItems.COOKED_PURPLE_FEESH.get(), "Cooked Purple Feesh");
		this.add(IcariaItems.RAW_RED_FEESH.get(), "Raw Red Feesh");
		this.add(IcariaItems.COOKED_RED_FEESH.get(), "Cooked Red Feesh");
		this.add(IcariaItems.RAW_BLUE_RED_FICHE.get(), "Raw Blue-Red Fiche");
		this.add(IcariaItems.COOKED_BLUE_RED_FICHE.get(), "Cooked Blue-Red Fiche");
		this.add(IcariaItems.RAW_BROWN_CYAN_FICHE.get(), "Raw Brown-Cyan Fiche");
		this.add(IcariaItems.COOKED_BROWN_CYAN_FICHE.get(), "Cooked Brown-Cyan Fiche");
		this.add(IcariaItems.RAW_GRAY_FICHE.get(), "Raw Gray Fiche");
		this.add(IcariaItems.COOKED_GRAY_FICHE.get(), "Cooked Gray Fiche");
		this.add(IcariaItems.RAW_GREEN_MAGENTA_FICHE.get(), "Raw Green-Magenta Fiche");
		this.add(IcariaItems.COOKED_GREEN_MAGENTA_FICHE.get(), "Cooked Green-Magenta Fiche");
		this.add(IcariaItems.RAW_RED_FICHE.get(), "Raw Red Fiche");
		this.add(IcariaItems.COOKED_RED_FICHE.get(), "Cooked Red Fiche");
		this.add(IcariaItems.RAW_WHITE_YELLOW_FICHE.get(), "Raw White-Yellow Fiche");
		this.add(IcariaItems.COOKED_WHITE_YELLOW_FICHE.get(), "Cooked White-Yellow Fiche");
		this.add(IcariaItems.RAW_BLUE_BROWN_FISSHH.get(), "Raw Blue-Brown Fisshh");
		this.add(IcariaItems.COOKED_BLUE_BROWN_FISSHH.get(), "Cooked Blue-Brown Fisshh");
		this.add(IcariaItems.RAW_BLUE_RED_FISSHH.get(), "Raw Blue-Red Fisshh");
		this.add(IcariaItems.COOKED_BLUE_RED_FISSHH.get(), "Cooked Blue-Red Fisshh");
		this.add(IcariaItems.RAW_BLUE_YELLOW_FISSHH.get(), "Raw Blue-Yellow Fisshh");
		this.add(IcariaItems.COOKED_BLUE_YELLOW_FISSHH.get(), "Cooked Blue-Yellow Fisshh");
		this.add(IcariaItems.RAW_BROWN_FISSHH.get(), "Raw Brown Fisshh");
		this.add(IcariaItems.COOKED_BROWN_FISSHH.get(), "Cooked Brown Fisshh");
		this.add(IcariaItems.RAW_GREEN_MAGENTA_FISSHH.get(), "Raw Green-Magenta Fisshh");
		this.add(IcariaItems.COOKED_GREEN_MAGENTA_FISSHH.get(), "Cooked Green-Magenta Fisshh");
		this.add(IcariaItems.RAW_PURPLE_YELLOW_FISSHH.get(), "Raw Purple-Yellow Fisshh");
		this.add(IcariaItems.COOKED_PURPLE_YELLOW_FISSHH.get(), "Cooked Purple-Yellow Fisshh");
		this.add(IcariaItems.RAW_BLUE_FYSH.get(), "Raw Blue Fysh");
		this.add(IcariaItems.COOKED_BLUE_FYSH.get(), "Cooked Blue Fysh");
		this.add(IcariaItems.RAW_BLUE_PURPLE_FYSH.get(), "Raw Blue-Purple Fysh");
		this.add(IcariaItems.COOKED_BLUE_PURPLE_FYSH.get(), "Cooked Blue-Purple Fysh");
		this.add(IcariaItems.RAW_GRAY_FYSH.get(), "Raw Gray Fysh");
		this.add(IcariaItems.COOKED_GRAY_FYSH.get(), "Cooked Gray Fysh");
		this.add(IcariaItems.RAW_RAINBOW_FYSH.get(), "Raw Rainbow Fysh");
		this.add(IcariaItems.COOKED_RAINBOW_FYSH.get(), "Cooked Rainbow Fysh");
		this.add(IcariaItems.RAW_RED_FYSH.get(), "Raw Red Fysh");
		...
		this.add(IcariaItems.FEESH_SPAWN_EGG.get(), "Feesh Spawn Egg");
		this.add(IcariaItems.FICHE_SPAWN_EGG.get(), "Fiche Spawn Egg");
		this.add(IcariaItems.FISSHH_SPAWN_EGG.get(), "Fisshh Spawn Egg");
		this.add(IcariaItems.FYSH_SPAWN_EGG.get(), "Fysh Spawn Egg");
		...
		this.add("itemgroup" + "." + IcariaKeys.ID + "." + "blocks", "Lands of Icaria Blocks");
		this.add("itemgroup" + "." + IcariaKeys.ID + "." + "flora", "Lands of Icaria Flora");
		this.add("itemgroup" + "." + IcariaKeys.ID + "." + "items", "Lands of Icaria Items");

		this.add("menu" + "." + IcariaKeys.ID + "." + "forge", "Forge");
		this.add("menu" + "." + IcariaKeys.ID + "." + "grinder", "Grinder");
		this.add("menu" + "." + IcariaKeys.ID + "." + "kiln", "Kiln");
		this.add("menu" + "." + IcariaKeys.ID + "." + "storage_vase", "Storage Vase");

		this.add("message" + "." + IcariaKeys.ID + "." + "barrel", "Sneak to throw the barrel");
		this.add("message" + "." + IcariaKeys.ID + "." + "loot_vase", "Sneak to throw loot vase");
		...
		this.add("painting" + "." + IcariaKeys.ID + "." + "bridge" + "." + "title", "Bridge");
		this.add("painting" + "." + IcariaKeys.ID + "." + "cactus" + "." + "title", "Cactus");
		this.add("painting" + "." + IcariaKeys.ID + "." + "ender_jellyfish" + "." + "title", "Ender Jellyfish");
		this.add("painting" + "." + IcariaKeys.ID + "." + "moons" + "." + "title", "Moons");
		this.add("painting" + "." + IcariaKeys.ID + "." + "perfection" + "." + "title", "Perfection");
		this.add("painting" + "." + IcariaKeys.ID + "." + "portal" + "." + "title", "Portal");
		this.add("painting" + "." + IcariaKeys.ID + "." + "pyro" + "." + "title", "Pyro");
		this.add("painting" + "." + IcariaKeys.ID + "." + "window" + "." + "title", "Window");

		this.add("screen" + "." + IcariaKeys.ID + "." + "chest_label", "Chest Label");

		this.add("subtitle" + "." + IcariaKeys.ID + "." + "barrel" + "." + "break", "Barrel breaks");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "grinder" + "." + "grind", "Grinder grinds");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "kettle" + "." + "concoct", "Kettle concocts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "kettle" + "." + "consume", "Kettle consumes");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "kettle" + "." + "pop", "Kettle pops");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "lignite" + "." + "crackle", "Lignite crackles");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "pottery" + "." + "break", "Pottery breaks");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "rotten_bone_ladder" + "." + "break", "Rotten Bone Ladder breaks");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "aeternae" + "." + "ambient", "Aeternae moos");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "aeternae" + "." + "death", "Aeternae dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "aeternae" + "." + "hurt", "Aeternae hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "aeternae" + "." + "step", "Aeternae steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne" + "." + "ambient", "Arachne hisses");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne" + "." + "death", "Arachne dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne" + "." + "hurt", "Arachne hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne" + "." + "step", "Arachne steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne_drone" + "." + "ambient", "Arachne Drone hisses");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne_drone" + "." + "death", "Arachne Drone dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne_drone" + "." + "hurt", "Arachne Drone hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "arachne_drone" + "." + "step", "Arachne Drone steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "argan_hound" + "." + "ambient", "Argan Hound pants");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "argan_hound" + "." + "death", "Argan Hound dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "argan_hound" + "." + "hurt", "Argan Hound hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "argan_hound" + "." + "step", "Argan Hound steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "capella" + "." + "ambient", "Capella bleats");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "capella" + "." + "death", "Capella dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "capella" + "." + "hurt", "Capella hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "capella" + "." + "step", "Capella steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "catoblepas" + "." + "ambient", "Catoblepas moos");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "catoblepas" + "." + "death", "Catoblepas dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "catoblepas" + "." + "hurt", "Catoblepas hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "catoblepas" + "." + "milk", "Catoblepas gets milked");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "catoblepas" + "." + "step", "Catoblepas steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "cerver" + "." + "ambient", "Cerver meows");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "cerver" + "." + "death", "Cerver dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "cerver" + "." + "hurt", "Cerver hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "crocotta" + "." + "ambient", "Crocotta laughs");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "crocotta" + "." + "death", "Crocotta dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "crocotta" + "." + "hurt", "Crocotta hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "crocotta" + "." + "step", "Crocotta steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "fish" + "." + "ambient", "Fish swims");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "fish" + "." + "death", "Fish dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "fish" + "." + "hurt", "Fish hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "forest_hag" + "." + "ambient", "Forest Hag whoops");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "forest_hag" + "." + "death", "Forest Hag dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "forest_hag" + "." + "hurt", "Forest Hag hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "forest_hag" + "." + "scream", "Forest Hag screams");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "forest_hag" + "." + "target", "Forest Hag targets");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "hyliaster" + "." + "death", "Hyliaster dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "hyliaster" + "." + "hurt", "Hyliaster hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "hyliaster" + "." + "squish", "Hyliaster squishes");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "jellyfish" + "." + "ambient", "Jellyfish swims");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "jellyfish" + "." + "death", "Jellyfish dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "jellyfish" + "." + "hurt", "Jellyfish hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_drone" + "." + "ambient", "Myrmeke Drone hisses");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_drone" + "." + "death", "Myrmeke Drone dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_drone" + "." + "hurt", "Myrmeke Drone hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_drone" + "." + "step", "Myrmeke Drone steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_soldier" + "." + "ambient", "Myrmeke Soldier hisses");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_soldier" + "." + "death", "Myrmeke Soldier dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_soldier" + "." + "hurt", "Myrmeke Soldier hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_soldier" + "." + "step", "Myrmeke Soldier steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_queen" + "." + "ambient", "Myrmeke Queen hisses");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_queen" + "." + "death", "Myrmeke Queen dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_queen" + "." + "hurt", "Myrmeke Queen hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "myrmeke_queen" + "." + "step", "Myrmeke Queen steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "player" + "." + "sniff", "Player sniffs");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "revenant" + "." + "ambient", "Revenant breathes");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "revenant" + "." + "death", "Revenant dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "revenant" + "." + "hurt", "Revenant hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "revenant" + "." + "step", "Revenant steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "captain_revenant" + "." + "death", "Captain Revenant dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "captain_revenant" + "." + "hurt", "Captain Revenant hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "captain_revenant" + "." + "rally", "Captain Revenant rallies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "captain_revenant" + "." + "step", "Captain Revenant steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "nether_pyromancer_revenant" + "." + "ambient", "Nether Pyromancer Revenant screams");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "soldier_revenant" + "." + "death", "Soldier Revenant dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "soldier_revenant" + "." + "hurt", "Soldier Revenant hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "soldier_revenant" + "." + "step", "Soldier Revenant steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "scorpion" + "." + "ambient", "Scorpion rattles");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "scorpion" + "." + "death", "Scorpion dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "scorpion" + "." + "hurt", "Scorpion hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "scorpion" + "." + "step", "Scorpion steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "slug" + "." + "ambient", "Slug squishes");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "slug" + "." + "death", "Slug dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "slug" + "." + "hurt", "Slug hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "snull" + "." + "ambient", "Snull squishes");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "snull" + "." + "death", "Snull dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "snull" + "." + "hurt", "Snull hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "solifugae" + "." + "ambient", "Solifugae hisses");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "solifugae" + "." + "death", "Solifugae dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "solifugae" + "." + "hurt", "Solifugae hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "solifugae" + "." + "step", "Solifugae steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "thog" + "." + "ambient", "Thog growls");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "thog" + "." + "death", "Thog dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "thog" + "." + "hurt", "Thog hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "thog" + "." + "step", "Thog steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vinegaroon" + "." + "ambient", "Vinegaroon rattles");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vinegaroon" + "." + "death", "Vinegaroon dies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vinegaroon" + "." + "hurt", "Vinegaroon hurts");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vinegaroon" + "." + "shoot", "Vinegaroon shoots");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vinegaroon" + "." + "step", "Vinegaroon steps");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "aeternae_hide_armor" + "." + "equip", "Aeternae Hide Armor equips");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "chalkos_armor" + "." + "equip", "Chalkos Armor equips");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "kassiteros_armor" + "." + "equip", "Kassiteros Armor equips");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "orichalcum_armor" + "." + "equip", "Orichalcum Armor equips");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vanadiumsteel_armor" + "." + "equip", "Vanadiumsteel Armor equips");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "laurel_wreath" + "." + "equip", "Laurel Wreath equips");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "bident" + "." + "hit", "Bident stabs");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "bident" + "." + "hit_ground", "Bident vibrates");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "bident" + "." + "throw", "Bident clangs");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "calcite" + "." + "fertilize", "Calcite fertilizes");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "capella_horn" + "." + "fail", "Capella horn plays");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "carpet" + "." + "apply", "Carpet applies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "carpet" + "." + "clear", "Carpet clears");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "apply", "Chest Label applies");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "clear", "Chest Label clears");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "greek_fire_grenade" + "." + "throw", "Grenade flings");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "olives" + "." + "pop", "Olives pop");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "spell" + "." + "shoot", "Spell shoots");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "bubble_spell" + "." + "pop", "Bubble Spell pops");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "bubble_spell" + "." + "shoot", "Bubble Spell shoots");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "trough" + "." + "empty", "Trough empties");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "trough" + "." + "fill", "Trough fills");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vial" + "." + "empty", "Vial empties");
		this.add("subtitle" + "." + IcariaKeys.ID + "." + "vial" + "." + "fill", "Vial fills");

		this.add(IcariaBiomeTagsProvider.HAS_PORTAL, "Has Portal");

		this.add(IcariaBiomeTagsProvider.IS_FOREST, "Is Forest");
		this.add(IcariaBiomeTagsProvider.IS_SCRUBLAND, "Is Scrubland");
		this.add(IcariaBiomeTagsProvider.IS_STEPPE, "Is Steppe");
		this.add(IcariaBiomeTagsProvider.IS_DESERT, "Is Desert");

		this.add(IcariaBiomeTagsProvider.IS_SURFACE, "Is Surface");
		this.add(IcariaBiomeTagsProvider.IS_LUSH, "Is Lush");
		this.add(IcariaBiomeTagsProvider.IS_LOST, "Is Lost");
		this.add(IcariaBiomeTagsProvider.IS_DEEP, "Is Deep");

		this.add(IcariaBlockTagsProvider.BARRELS_CYPRESS, "Cypress Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_DROUGHTROOT, "Droughtroot Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_FIR, "Fir Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_LAUREL, "Laurel Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_LOADED, "Loaded Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_OLIVE, "Olive Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_PLANE, "Plane Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_POPULUS, "Populus Barrels");
		this.add(IcariaBlockTagsProvider.BARRELS_TAPPED, "Tapped Barrels");

		this.add(IcariaBlockTagsProvider.GRASS_BLOCKS, "Grass Blocks");

		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_CHERT_TOOL, "Incorrect For Chert Tool");
		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_CHALKOS_TOOL, "Incorrect For Chalkos Tool");
		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_KASSITEROS_TOOL, "Incorrect For Kassiteros Tool");
		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_ORICHALCUM_TOOL, "Incorrect For Orichalcum Tool");
		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_VANADIUMSTEEL_TOOL, "Incorrect For Vanadiumsteel Tool");
		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_SIDEROS_TOOL, "Incorrect For Sideros Tool");
		this.add(IcariaBlockTagsProvider.INCORRECT_FOR_MOLYBDENUMSTEEL_TOOL, "Incorrect For Molybdenumsteel Tool");

		this.add(IcariaBlockTagsProvider.MINEABLE_WITH_SCYTHE, "Mineable With Scythe");

		this.add(IcariaBlockTagsProvider.NEEDS_CHERT_TOOL, "Needs Chert Tool");
		this.add(IcariaBlockTagsProvider.NEEDS_CHALKOS_TOOL, "Needs Chalkos Tool");
		this.add(IcariaBlockTagsProvider.NEEDS_KASSITEROS_TOOL, "Needs Kassiteros Tool");
		this.add(IcariaBlockTagsProvider.NEEDS_ORICHALCUM_TOOL, "Needs Orichalcum Tool");
		this.add(IcariaBlockTagsProvider.NEEDS_VANADIUMSTEEL_TOOL, "Needs Vanadiumsteel Tool");
		this.add(IcariaBlockTagsProvider.NEEDS_SIDEROS_TOOL, "Needs Sideros Tool");
		this.add(IcariaBlockTagsProvider.NEEDS_MOLYBDENUMSTEEL_TOOL, "Needs Molybdenumsteel Tool");

		this.add(IcariaBlockTagsProvider.PORTAL_BLOCKS_PILLAR, "Pillar Portal Blocks");
		this.add(IcariaBlockTagsProvider.PORTAL_BLOCKS_PILLAR_HEAD, "Pillar Head Portal Blocks");
		this.add(IcariaBlockTagsProvider.PORTAL_BLOCKS_SLAB, "Slab Portal Blocks");

		this.add(IcariaBlockTagsProvider.RACKS_CYPRESS, "Cypress Racks");
		this.add(IcariaBlockTagsProvider.RACKS_DROUGHTROOT, "Droughtroot Racks");
		this.add(IcariaBlockTagsProvider.RACKS_FIR, "Fir Racks");
		this.add(IcariaBlockTagsProvider.RACKS_LAUREL, "Laurel Racks");
		this.add(IcariaBlockTagsProvider.RACKS_OLIVE, "Olive Racks");
		this.add(IcariaBlockTagsProvider.RACKS_PLANE, "Plane Racks");
		this.add(IcariaBlockTagsProvider.RACKS_POPULUS, "Populus Racks");

		this.add(IcariaBlockTagsProvider.REPLACE_BLOCKS_ERODED_VILLAGE, "Eroded Village Replace Blocks");
		this.add(IcariaBlockTagsProvider.REPLACE_BLOCKS_PRISTINE_VILLAGE, "Pristine Village Replace Blocks");
		this.add(IcariaBlockTagsProvider.REPLACE_BLOCKS_RUINED_VILLAGE, "Ruined Village Replace Blocks");
		...
		this.add(IcariaBlockTagsProvider.LOGS_LAUREL, "Laurel Logs");
		this.add(IcariaBlockTagsProvider.LOGS_OLIVE, "Olive Logs");
		this.add(IcariaBlockTagsProvider.LOGS_PLANE, "Plane Logs");
		this.add(IcariaBlockTagsProvider.LOGS_POPULUS, "Populus Logs");

		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_MARL, "Marl Ore Bearing Grounds");
		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_GRAINEL, "Grainel Ore Bearing Grounds");
		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_YELLOWSTONE, "Yellowstone Ore Bearing Grounds");
		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_SILKSTONE, "Silkstone Ore Bearing Grounds");
		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_SUNSTONE, "Sunstone Ore Bearing Grounds");
		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_VOIDSHALE, "Voidshale Ore Bearing Grounds");
		this.add(IcariaBlockTagsProvider.ORE_BEARING_GROUNDS_BAETYL, "Baetyl Ore Bearing Grounds");

		this.add(IcariaBlockTagsProvider.ORES_CHERT, "Chert Ores");
		this.add(IcariaBlockTagsProvider.ORES_BONES, "Bones Ores");
		this.add(IcariaBlockTagsProvider.ORES_LIGNITE, "Lignite Ores");
		this.add(IcariaBlockTagsProvider.ORES_CHALKOS, "Chalkos Ores");
		this.add(IcariaBlockTagsProvider.ORES_KASSITEROS, "Kassiteros Ores");
		this.add(IcariaBlockTagsProvider.ORES_DOLOMITE, "Dolomite Ores");
		this.add(IcariaBlockTagsProvider.ORES_VANADIUM, "Vanadium Ores");
		this.add(IcariaBlockTagsProvider.ORES_SLIVER, "Sliver Ores");
		this.add(IcariaBlockTagsProvider.ORES_SIDEROS, "Sideros Ores");
		this.add(IcariaBlockTagsProvider.ORES_ANTHRACITE, "Anthracite Ores");
		this.add(IcariaBlockTagsProvider.ORES_MOLYBDENUM, "Molybdenum Ores");
		this.add(IcariaBlockTagsProvider.ORES_HYLIASTRUM, "Hyliastrum Ores");

		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_MARL, "Marl Ores In Ground");
		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_GRAINEL, "Grainel Ores In Ground");
		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_YELLOWSTONE, "Yellowstone Ores In Ground");
		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_SILKSTONE, "Silkstone Ores In Ground");
		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_SUNSTONE, "Sunstone Ores In Ground");
		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_VOIDSHALE, "Voidshale Ores In Ground");
		this.add(IcariaBlockTagsProvider.ORES_IN_GROUND_BAETYL, "Baetyl Ores In Ground");

		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ARISTONE, "Aristone Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ENDER_JELLYFISH_JELLY, "Ender Jellyfish Jelly Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_FIRE_JELLYFISH_JELLY, "Fire Jellyfish Jelly Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_NATURE_JELLYFISH_JELLY, "Nature Jellyfish Jelly Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_VOID_JELLYFISH_JELLY, "Void Jellyfish Jelly Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_WATER_JELLYFISH_JELLY, "Water Jellyfish Jelly Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ARACHNE_STRING, "Arachne String Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_SPELT, "Spelt Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_VINE_REED, "Vine Reed Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ROTTEN_BONES, "Rotten Bones Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_RAW_CHALKOS, "Raw Chalkos Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_RAW_KASSITEROS, "Raw Kassiteros Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_RAW_VANADIUM, "Raw Vanadium Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_RAW_SIDEROS, "Raw Sideros Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_RAW_MOLYBDENUM, "Raw Molybdenum Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_CALCITE, "Calcite Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_HALITE, "Halite Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_JASPER, "Jasper Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ZIRCON, "Zircon Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_CHERT, "Chert Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_LIGNITE, "Lignite Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_CHALKOS, "Chalkos Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_KASSITEROS, "Kassiteros Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ORICHALCUM, "Orichalcum Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_VANADIUM, "Vanadium Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_SLIVER, "Sliver Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_VANADIUMSTEEL, "Vanadiumsteel Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_SIDEROS, "Sideros Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_ANTHRACITE, "Anthracite Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_MOLYBDENUM, "Molybdenum Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_MOLYBDENUMSTEEL, "Molybdenumsteel Storage Blocks");
		this.add(IcariaBlockTagsProvider.STORAGE_BLOCKS_BLURIDIUM, "Bluridium Storage Blocks");

		this.add(IcariaInstrumentTagsProvider.CAPELLA_HORNS, "Capella Horns");

		this.add(IcariaItemTagsProvider.CROPS_SPELT, "Spelt Crops");
		this.add(IcariaItemTagsProvider.CROPS_STRAWBERRIES, "Strawberries Crops");
		this.add(IcariaItemTagsProvider.CROPS_PHYSALIS, "Physalis Crops");
		this.add(IcariaItemTagsProvider.CROPS_ONION, "Onion Crops");

		this.add(IcariaItemTagsProvider.DUSTS_CALCITE, "Calcite Dusts");
		this.add(IcariaItemTagsProvider.DUSTS_HALITE, "Halite Dusts");

		this.add(IcariaItemTagsProvider.GEMS_CHERT, "Chert Gems");
		this.add(IcariaItemTagsProvider.GEMS_CALCITE, "Calcite Gems");
		this.add(IcariaItemTagsProvider.GEMS_HALITE, "Halite Gems");
		this.add(IcariaItemTagsProvider.GEMS_JASPER, "Jasper Gems");
		this.add(IcariaItemTagsProvider.GEMS_ZIRCON, "Zircon Gems");
		this.add(IcariaItemTagsProvider.GEMS_LIGNITE, "Lignite Gems");
		this.add(IcariaItemTagsProvider.GEMS_DOLOMITE, "Dolomite Gems");
		this.add(IcariaItemTagsProvider.GEMS_SLIVER, "Sliver Gems");
		this.add(IcariaItemTagsProvider.GEMS_ANTHRACITE, "Anthracite Gems");

		this.add(IcariaItemTagsProvider.INGOTS_CHALKOS, "Chalkos Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_KASSITEROS, "Kassiteros Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_ORICHALCUM, "Orichalcum Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_VANADIUM, "Vanadium Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_VANADIUMSTEEL, "Vanadiumsteel Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_SIDEROS, "Sideros Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_MOLYBDENUM, "Molybdenum Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_MOLYBDENUMSTEEL, "Molybdenumsteel Ingots");
		this.add(IcariaItemTagsProvider.INGOTS_BLURIDIUM, "Bluridium Ingots");

		this.add(IcariaItemTagsProvider.KETTLE_ITEMS, "Kettle Items");

		this.add(IcariaItemTagsProvider.NUGGETS_CHALKOS, "Chalkos Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_KASSITEROS, "Kassiteros Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_ORICHALCUM, "Orichalcum Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_VANADIUM, "Vanadium Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_VANADIUMSTEEL, "Vanadiumsteel Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_SIDEROS, "Sideros Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_MOLYBDENUM, "Molybdenum Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_MOLYBDENUMSTEEL, "Molybdenumsteel Nuggets");
		this.add(IcariaItemTagsProvider.NUGGETS_BLURIDIUM, "Bluridium Nuggets");

		this.add(IcariaItemTagsProvider.RAW_BLOCKS_CHALKOS, "Raw Chalkos Blocks");
		this.add(IcariaItemTagsProvider.RAW_BLOCKS_KASSITEROS, "Raw Kassiteros Blocks");
		this.add(IcariaItemTagsProvider.RAW_BLOCKS_VANADIUM, "Raw Vanadium Blocks");
		this.add(IcariaItemTagsProvider.RAW_BLOCKS_SIDEROS, "Raw Sideros Blocks");
		this.add(IcariaItemTagsProvider.RAW_BLOCKS_MOLYBDENUM, "Raw Molybdenum Blocks");

		this.add(IcariaItemTagsProvider.RAW_MATERIALS_CHALKOS, "Raw Chalkos Materials");
		this.add(IcariaItemTagsProvider.RAW_MATERIALS_KASSITEROS, "Raw Kassiteros Materials");
		this.add(IcariaItemTagsProvider.RAW_MATERIALS_VANADIUM, "Raw Vanadium Materials");
		this.add(IcariaItemTagsProvider.RAW_MATERIALS_SIDEROS, "Raw Sideros Materials");
		this.add(IcariaItemTagsProvider.RAW_MATERIALS_MOLYBDENUM, "Raw Molybdenum Materials");

		this.add(IcariaItemTagsProvider.REPAIRS_AETERNAE_HIDE_ARMOR, "Repairs Aeternae Hide Armor");
		this.add(IcariaItemTagsProvider.REPAIRS_CHALKOS_ARMOR, "Repairs Chalkos Armor");
		this.add(IcariaItemTagsProvider.REPAIRS_KASSITEROS_ARMOR, "Repairs Kassiteros Armor");
		this.add(IcariaItemTagsProvider.REPAIRS_ORICHALCUM_ARMOR, "Repairs Orichalcum Armor");
		this.add(IcariaItemTagsProvider.REPAIRS_VANADIUMSTEEL_ARMOR, "Repairs Vanadiumsteel Armor");
		this.add(IcariaItemTagsProvider.REPAIRS_LAUREL_WREATH, "Repairs Laurel Wreath");

		this.add(IcariaItemTagsProvider.SEEDS_SPELT, "Spelt Seeds");
		this.add(IcariaItemTagsProvider.SEEDS_STRAWBERRY, "Strawberry Seeds");
		this.add(IcariaItemTagsProvider.SEEDS_PHYSALIS, "Physalis Seeds");
		this.add(IcariaItemTagsProvider.SEEDS_ONION, "Onion Seeds");

		this.add(IcariaItemTagsProvider.TOOL_MATERIALS_CHERT, "Chert Tool Materials");
		this.add(IcariaItemTagsProvider.TOOL_MATERIALS_CHALKOS, "Chalkos Tool Materials");
		this.add(IcariaItemTagsProvider.TOOL_MATERIALS_KASSITEROS, "Kassiteros Tool Materials");
		this.add(IcariaItemTagsProvider.TOOL_MATERIALS_ORICHALCUM, "Orichalcum Tool Materials");
		...
		this.add(IcariaItemTagsProvider.LOGS_FIR, "Fir Logs");
		this.add(IcariaItemTagsProvider.LOGS_LAUREL, "Laurel Logs");
		this.add(IcariaItemTagsProvider.LOGS_OLIVE, "Olive Logs");
		this.add(IcariaItemTagsProvider.LOGS_PLANE, "Plane Logs");
		this.add(IcariaItemTagsProvider.LOGS_POPULUS, "Populus Logs");

		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_MARL, "Marl Ore Bearing Grounds");
		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_GRAINEL, "Grainel Ore Bearing Grounds");
		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_YELLOWSTONE, "Yellowstone Ore Bearing Grounds");
		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_SILKSTONE, "Silkstone Ore Bearing Grounds");
		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_SUNSTONE, "Sunstone Ore Bearing Grounds");
		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_VOIDSHALE, "Voidshale Ore Bearing Grounds");
		this.add(IcariaItemTagsProvider.ORE_BEARING_GROUNDS_BAETYL, "Baetyl Ore Bearing Grounds");

		this.add(IcariaItemTagsProvider.ORES_CHERT, "Chert Ores");
		this.add(IcariaItemTagsProvider.ORES_BONES, "Bones Ores");
		this.add(IcariaItemTagsProvider.ORES_LIGNITE, "Lignite Ores");
		this.add(IcariaItemTagsProvider.ORES_CHALKOS, "Chalkos Ores");
		this.add(IcariaItemTagsProvider.ORES_KASSITEROS, "Kassiteros Ores");
		this.add(IcariaItemTagsProvider.ORES_DOLOMITE, "Dolomite Ores");
		this.add(IcariaItemTagsProvider.ORES_VANADIUM, "Vanadium Ores");
		this.add(IcariaItemTagsProvider.ORES_SLIVER, "Sliver Ores");
		this.add(IcariaItemTagsProvider.ORES_SIDEROS, "Sideros Ores");
		this.add(IcariaItemTagsProvider.ORES_ANTHRACITE, "Anthracite Ores");
		this.add(IcariaItemTagsProvider.ORES_MOLYBDENUM, "Molybdenum Ores");
		this.add(IcariaItemTagsProvider.ORES_HYLIASTRUM, "Hyliastrum Ores");

		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_MARL, "Marl Ores In Ground");
		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_GRAINEL, "Grainel Ores In Ground");
		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_YELLOWSTONE, "Yellowstone Ores In Ground");
		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_SILKSTONE, "Silkstone Ores In Ground");
		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_SUNSTONE, "Sunstone Ores In Ground");
		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_VOIDSHALE, "Voidshale Ores In Ground");
		this.add(IcariaItemTagsProvider.ORES_IN_GROUND_BAETYL, "Baetyl Ores In Ground");

		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ARISTONE, "Aristone Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ENDER_JELLYFISH_JELLY, "Ender Jellyfish Jelly Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_FIRE_JELLYFISH_JELLY, "Fire Jellyfish Jelly Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_NATURE_JELLYFISH_JELLY, "Nature Jellyfish Jelly Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_VOID_JELLYFISH_JELLY, "Void Jellyfish Jelly Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_WATER_JELLYFISH_JELLY, "Water Jellyfish Jelly Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ARACHNE_STRING, "Arachne String Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_SPELT, "Spelt Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_VINE_REED, "Vine Reed Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ROTTEN_BONES, "Rotten Bones Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_RAW_CHALKOS, "Raw Chalkos Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_RAW_KASSITEROS, "Raw Kassiteros Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_RAW_VANADIUM, "Raw Vanadium Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_RAW_SIDEROS, "Raw Sideros Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_RAW_MOLYBDENUM, "Raw Molybdenum Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_CALCITE, "Calcite Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_HALITE, "Halite Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_JASPER, "Jasper Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ZIRCON, "Zircon Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_CHERT, "Chert Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_LIGNITE, "Lignite Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_CHALKOS, "Chalkos Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_KASSITEROS, "Kassiteros Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ORICHALCUM, "Orichalcum Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_VANADIUM, "Vanadium Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_SLIVER, "Sliver Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_VANADIUMSTEEL, "Vanadiumsteel Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_SIDEROS, "Sideros Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_ANTHRACITE, "Anthracite Storage Blocks");
		this.add(IcariaItemTagsProvider.STORAGE_BLOCKS_MOLYBDENUM, "Molybdenum Storage Blocks");
		...
		this.add(IcariaPaintingVariantTagsProvider.BROWN_RUGS, "Brown Rugs");
		this.add(IcariaPaintingVariantTagsProvider.GREEN_RUGS, "Green Rugs");
		this.add(IcariaPaintingVariantTagsProvider.RED_RUGS, "Red Rugs");
		...
		this.add(IcariaStructureTagsProvider.STEPPE_VILLAGES, "Steppe Villages");
		this.add(IcariaStructureTagsProvider.DESERT_VILLAGES, "Desert Villages");

		this.add(IcariaStructureTagsProvider.ERODED_VILLAGES, "Eroded Villages");
		this.add(IcariaStructureTagsProvider.PRISTINE_VILLAGES, "Pristine Villages");
		this.add(IcariaStructureTagsProvider.RUINED_VILLAGES, "Ruined Villages");

		this.add(IcariaStructureTagsProvider.VILLAGES, "Villages");

		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "title", "Right click to edit");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "color", "Color");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "white", "White");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "light_gray", "Light Gray");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "gray", "Gray");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "black", "Black");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "brown", "Brown");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "red", "Red");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "orange", "Orange");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "yellow", "Yellow");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "lime", "Lime");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "green", "Green");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "cyan", "Cyan");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "light_blue", "Light Blue");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "blue", "Blue");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "purple", "Purple");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "magenta", "Magenta");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "pink", "Pink");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "label", "Label");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "style", "Style");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "classic", "Classic");
		this.add("tooltip" + "." + IcariaKeys.ID + "." + "chest_label" + "." + "glowing", "Glowing");
	}
