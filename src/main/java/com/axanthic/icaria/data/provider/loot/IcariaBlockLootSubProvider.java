...
public class IcariaBlockLootSubProvider extends BlockLootSubProvider {
	...
	public void dropCountertop() {
		this.dropCountertop(IcariaBlocks.CYPRESS_COUNTERTOP.get());
		this.dropCountertop(IcariaBlocks.DROUGHTROOT_COUNTERTOP.get());
		this.dropCountertop(IcariaBlocks.FIR_COUNTERTOP.get());
		this.dropCountertop(IcariaBlocks.LAUREL_COUNTERTOP.get());
		this.dropCountertop(IcariaBlocks.OLIVE_COUNTERTOP.get());
		this.dropCountertop(IcariaBlocks.PLANE_COUNTERTOP.get());
		this.dropCountertop(IcariaBlocks.POPULUS_COUNTERTOP.get());
	}
	...
	public void dropElse() {
		...
		this.dropElse(IcariaBlocks.DROUGHTROOT_WALL_HUTCH.get(), IcariaItems.DROUGHTROOT_HUTCH.get());
		...
		this.dropElse(IcariaBlocks.FIR_WALL_HUTCH.get(), IcariaItems.FIR_HUTCH.get());
		...
		this.dropElse(IcariaBlocks.LAUREL_WALL_HUTCH.get(), IcariaItems.LAUREL_HUTCH.get());
		...
		this.dropElse(IcariaBlocks.OLIVE_WALL_HUTCH.get(), IcariaItems.OLIVE_HUTCH.get());
		...
		this.dropElse(IcariaBlocks.PLANE_WALL_HUTCH.get(), IcariaItems.PLANE_HUTCH.get());
		...
		this.dropElse(IcariaBlocks.POPULUS_WALL_HUTCH.get(), IcariaItems.POPULUS_HUTCH.get());
	...
	public void dropThis() {
		...
		this.dropThis(IcariaBlocks.CYPRESS_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.CYPRESS_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.CYPRESS_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.CYPRESS_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.CYPRESS_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_CYPRESS_HOLDER.get());
		this.dropThis(IcariaBlocks.CYPRESS_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.CYPRESS_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.CYPRESS_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.CYPRESS_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.CYPRESS_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.CYPRESS_CUPBOARD.get());
		this.dropThis(IcariaBlocks.CYPRESS_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_CYPRESS_CUPBOARD.get());
		this.dropThis(IcariaBlocks.CYPRESS_HUTCH.get());
		...
		this.dropThis(IcariaBlocks.DROUGHTROOT_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_DROUGHTROOT_HOLDER.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_CUPBOARD.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_DROUGHTROOT_CUPBOARD.get());
		this.dropThis(IcariaBlocks.DROUGHTROOT_HUTCH.get());
		...
		this.dropThis(IcariaBlocks.FIR_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.FIR_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.FIR_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.FIR_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.FIR_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_FIR_HOLDER.get());
		this.dropThis(IcariaBlocks.FIR_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.FIR_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.FIR_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.FIR_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.FIR_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.FIR_CUPBOARD.get());
		this.dropThis(IcariaBlocks.FIR_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_FIR_CUPBOARD.get());
		this.dropThis(IcariaBlocks.FIR_HUTCH.get());
		...
		this.dropThis(IcariaBlocks.LAUREL_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.LAUREL_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.LAUREL_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.LAUREL_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.LAUREL_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_LAUREL_HOLDER.get());
		this.dropThis(IcariaBlocks.LAUREL_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.LAUREL_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.LAUREL_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.LAUREL_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.LAUREL_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.LAUREL_CUPBOARD.get());
		this.dropThis(IcariaBlocks.LAUREL_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_LAUREL_CUPBOARD.get());
		this.dropThis(IcariaBlocks.LAUREL_HUTCH.get());
		...
		this.dropThis(IcariaBlocks.OLIVE_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.OLIVE_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.OLIVE_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.OLIVE_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.OLIVE_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_OLIVE_HOLDER.get());
		this.dropThis(IcariaBlocks.OLIVE_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.OLIVE_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.OLIVE_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.OLIVE_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.OLIVE_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.OLIVE_CUPBOARD.get());
		this.dropThis(IcariaBlocks.OLIVE_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_OLIVE_CUPBOARD.get());
		this.dropThis(IcariaBlocks.OLIVE_HUTCH.get());
		...
		this.dropThis(IcariaBlocks.PLANE_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.PLANE_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.PLANE_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.PLANE_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.PLANE_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_PLANE_HOLDER.get());
		this.dropThis(IcariaBlocks.PLANE_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.PLANE_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.PLANE_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.PLANE_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.PLANE_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.PLANE_CUPBOARD.get());
		this.dropThis(IcariaBlocks.PLANE_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_PLANE_CUPBOARD.get());
		this.dropThis(IcariaBlocks.PLANE_HUTCH.get());
		...
		this.dropThis(IcariaBlocks.POPULUS_CUTTING_BOARD.get());
		this.dropThis(IcariaBlocks.POPULUS_HERB_HOLDER.get());
		this.dropThis(IcariaBlocks.POPULUS_PAN_HOLDER.get());
		this.dropThis(IcariaBlocks.POPULUS_POT_HOLDER.get());
		this.dropThis(IcariaBlocks.POPULUS_SPOON_HOLDER.get());
		this.dropThis(IcariaBlocks.BROKEN_POPULUS_HOLDER.get());
		this.dropThis(IcariaBlocks.POPULUS_FLOWER_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.POPULUS_MORTAR_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.POPULUS_POT_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.POPULUS_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.POPULUS_RAISED_BASINS_COUNTERTOP.get());
		this.dropThis(IcariaBlocks.POPULUS_CUPBOARD.get());
		this.dropThis(IcariaBlocks.POPULUS_DISHES_CUPBOARD.get());
		...
		this.dropThis(IcariaBlocks.BROKEN_POPULUS_CUPBOARD.get());
		this.dropThis(IcariaBlocks.POPULUS_HUTCH.get());
	...
	public void dropCountertop(Block pBlock) {
		this.add(pBlock, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(pBlock))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.WHITE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.WHITE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.WHITE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.WHITE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.WHITE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.WHITE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.WHITE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.WHITE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GRAY_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GRAY_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLACK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLACK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLACK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLACK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLACK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLACK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLACK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLACK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BROWN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BROWN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BROWN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BROWN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BROWN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BROWN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BROWN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BROWN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.RED_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.RED_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.RED_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.RED_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.RED_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.RED_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.RED_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.RED_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.ORANGE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.ORANGE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.ORANGE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.ORANGE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.ORANGE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.ORANGE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.ORANGE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.ORANGE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.YELLOW_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.YELLOW_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.YELLOW_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.YELLOW_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.YELLOW_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.YELLOW_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.YELLOW_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.YELLOW_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIME_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIME_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIME_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIME_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIME_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIME_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIME_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIME_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GREEN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GREEN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GREEN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GREEN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GREEN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GREEN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.GREEN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.GREEN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CYAN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CYAN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CYAN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CYAN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CYAN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CYAN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CYAN_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.CYAN_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.LIGHT_BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.LIGHT_BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.BLUE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.BLUE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PURPLE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PURPLE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PURPLE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PURPLE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PURPLE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PURPLE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PURPLE_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PURPLE_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.MAGENTA_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.MAGENTA_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.MAGENTA_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.MAGENTA_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.MAGENTA_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.MAGENTA_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.MAGENTA_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.MAGENTA_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PINK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PINK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 1)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PINK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PINK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 2)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PINK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(3.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PINK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 3)))).withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.PINK_CANDLE)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE, Candle.PINK_CANDLE))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(pBlock).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(IcariaBlockStateProperties.CANDLE_AMOUNT, 4)))));
	}
