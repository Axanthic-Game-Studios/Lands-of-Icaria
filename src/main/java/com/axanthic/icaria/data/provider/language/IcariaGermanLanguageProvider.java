...
public class IcariaGermanLanguageProvider extends LanguageProvider {
	...
	public void addTranslations() {
		...
		this.add(IcariaItems.RAW_BLUE_GRAY_FEESH.get(), "Roher blau-grauer Feesh");
		this.add(IcariaItems.COOKED_BLUE_GRAY_FEESH.get(), "Gekochter blau-grauer Feesh");
		this.add(IcariaItems.RAW_BROWN_FEESH.get(), "Roher brauner Feesh");
		this.add(IcariaItems.COOKED_BROWN_FEESH.get(), "Gekochter brauner Feesh");
		this.add(IcariaItems.RAW_BROWN_ORANGE_FEESH.get(), "Roher braun-oranger Feesh");
		this.add(IcariaItems.COOKED_BROWN_ORANGE_FEESH.get(), "Gekochter braun-oranger Feesh");
		this.add(IcariaItems.RAW_PINK_RED_FEESH.get(), "Roher rosa-roter Feesh");
		this.add(IcariaItems.COOKED_PINK_RED_FEESH.get(), "Gekochter rosa-roter Feesh");
		this.add(IcariaItems.RAW_PURPLE_FEESH.get(), "Roher violetter Feesh");
		this.add(IcariaItems.COOKED_PURPLE_FEESH.get(), "Gekochter violetter Feesh");
		this.add(IcariaItems.RAW_RED_FEESH.get(), "Roher roter Feesh");
		this.add(IcariaItems.COOKED_RED_FEESH.get(), "Gekochter roter Feesh");
		this.add(IcariaItems.RAW_BLUE_RED_FICHE.get(), "Roher blau-roter Fiche");
		this.add(IcariaItems.COOKED_BLUE_RED_FICHE.get(), "Gekochter blau-roter Fiche");
		this.add(IcariaItems.RAW_BROWN_CYAN_FICHE.get(), "Roher braun-türkiser Fiche");
		this.add(IcariaItems.COOKED_BROWN_CYAN_FICHE.get(), "Gekochter braun-türkiser Fiche");
		this.add(IcariaItems.RAW_GRAY_FICHE.get(), "Roher grauer Fiche");
		this.add(IcariaItems.COOKED_GRAY_FICHE.get(), "Gekochter grauer Fiche");
		this.add(IcariaItems.RAW_GREEN_MAGENTA_FICHE.get(), "Roher grün-magenta Fiche");
		this.add(IcariaItems.COOKED_GREEN_MAGENTA_FICHE.get(), "Gekochter grün-magenta Fiche");
		this.add(IcariaItems.RAW_RED_FICHE.get(), "Roher roter Fiche");
		this.add(IcariaItems.COOKED_RED_FICHE.get(), "Gekochter roter Fiche");
		this.add(IcariaItems.RAW_WHITE_YELLOW_FICHE.get(), "Roher weiß-gelber Fiche");
		this.add(IcariaItems.COOKED_WHITE_YELLOW_FICHE.get(), "Gekochter weiß-gelber Fiche");
		this.add(IcariaItems.RAW_BLUE_BROWN_FISSHH.get(), "Roher blau-brauner Fisshh");
		this.add(IcariaItems.COOKED_BLUE_BROWN_FISSHH.get(), "Gekochter blau-brauner Fisshh");
		this.add(IcariaItems.RAW_BLUE_RED_FISSHH.get(), "Roher blau-roter Fisshh");
		this.add(IcariaItems.COOKED_BLUE_RED_FISSHH.get(), "Gekochter blau-roter Fisshh");
		this.add(IcariaItems.RAW_BLUE_YELLOW_FISSHH.get(), "Roher blau-gelber Fisshh");
		this.add(IcariaItems.COOKED_BLUE_YELLOW_FISSHH.get(), "Gekochter blau-gelber Fisshh");
		this.add(IcariaItems.RAW_BROWN_FISSHH.get(), "Roher brauner Fisshh");
		this.add(IcariaItems.COOKED_BROWN_FISSHH.get(), "Gekochter brauner Fisshh");
		this.add(IcariaItems.RAW_GREEN_MAGENTA_FISSHH.get(), "Roher grün-magenta Fisshh");
		this.add(IcariaItems.COOKED_GREEN_MAGENTA_FISSHH.get(), "Gekochter grün-magenta Fisshh");
		this.add(IcariaItems.RAW_PURPLE_YELLOW_FISSHH.get(), "Roher violett-gelber Fisshh");
		this.add(IcariaItems.COOKED_PURPLE_YELLOW_FISSHH.get(), "Gekochter violett-gelber Fisshh");
		this.add(IcariaItems.RAW_BLUE_FYSH.get(), "Roher blauer Fysh");
		this.add(IcariaItems.COOKED_BLUE_FYSH.get(), "Gekochter blauer Fysh");
		this.add(IcariaItems.RAW_BLUE_PURPLE_FYSH.get(), "Roher blau-violetter Fysh");
		this.add(IcariaItems.COOKED_BLUE_PURPLE_FYSH.get(), "Gekochter blau-violetter Fysh");
		this.add(IcariaItems.RAW_GRAY_FYSH.get(), "Roher grauer Fysh");
		this.add(IcariaItems.COOKED_GRAY_FYSH.get(), "Gekochter grauer Fysh");
		this.add(IcariaItems.RAW_RAINBOW_FYSH.get(), "Roher kunterbunter Fysh");
		this.add(IcariaItems.COOKED_RAINBOW_FYSH.get(), "Gekochter kunterbunter Fysh");
		this.add(IcariaItems.RAW_RED_FYSH.get(), "Roher roter Fysh");
		this.add(IcariaItems.COOKED_RED_FYSH.get(), "Gekochter roter Fysh");
		this.add(IcariaItems.RAW_RED_YELLOW_FYSH.get(), "Roher rot-gelber Fysh");
		this.add(IcariaItems.COOKED_RED_YELLOW_FYSH.get(), "Gekochter rot-gelber Fysh");
		...
		this.add(IcariaItems.FEESH_SPAWN_EGG.get(), "Feesh-Spawn-Ei");
		this.add(IcariaItems.FICHE_SPAWN_EGG.get(), "Fiche-Spawn-Ei");
		this.add(IcariaItems.FISSHH_SPAWN_EGG.get(), "Fisshh-Spawn-Ei");
		this.add(IcariaItems.FYSH_SPAWN_EGG.get(), "Fysh-Spawn-Ei");
