...
public class IcariaGermanLanguageProvider extends LanguageProvider {
	...
	public void addTranslations() {
		...
		this.add("advancement" + "." + IcariaIdents.ID + "." + "fertilized_farmland" + "." + "title", "Pflanzen füttern");
		...
		this.add("advancement" + "." + IcariaIdents.ID + "." + "forge" + "." + "title", "Es geht heiß her");
		...
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_crystal_rays", "Kristallstrahlen rendern");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_crystal_rays" + "." + "tooltip", "Standard: An. Ob ein Kristall Strahlen rendern soll.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_settings", "Renderentfernungseinstellungen");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_settings" + "." + "tooltip", "Renderentfernungseinstellungen");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_crystal_rays", "Renderentfernung Kristallstrahlen");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_crystal_rays" + "." + "tooltip", "Standard: 256. Ob ein Kristall Strahlen basierend auf der Entfernung zu einem Spieler rendern soll.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_fireplace_items", "Renderentfernung Feuerstellengegstände");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_fireplace_items" + "." + "tooltip", "Standard: 256. Ob eine Feuerstelle Gegenstände basierend auf der Entfernung zu einem Spieler rendern soll.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_forge_items", "Renderentfernung Schmelzegegenstände");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_forge_items" + "." + "tooltip", "Standard: 256. Ob eine Schmelze Gegenstände basierend auf der Entfernung zu einem Spieler rendern soll.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_grinder_gears", "Renderentfernung Mühlengegenstände");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_grinder_gears" + "." + "tooltip", "Standard: 256. Ob eine Mühle Zahnräder basierend auf der Entfernung zu einem Spieler rendern soll.");
		this.add("configuration" + "." + IcariaIdents.ID + "." + "render_distance_kettle_items", "Renderentfernung Kesselgegenstände");
