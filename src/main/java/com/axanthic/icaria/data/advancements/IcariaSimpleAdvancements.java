...
public class IcariaSimpleAdvancements implements AdvancementProvider.AdvancementGenerator {
    ...
    public static AdvancementHolder advancement(String pKey, Criterion<?> pTrigger, Consumer<AdvancementHolder> pConsumer, Supplier<Item> pItem, AdvancementType pFrame, boolean pToast, boolean pChat, boolean pHidden) {
        return Advancement.Builder.advancement().addCriterion(pKey, pTrigger).display(pItem.get(), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "title"), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "description"), IcariaResourceLocations.BACKGROUND, pFrame, pToast, pChat, pHidden).save(pConsumer, IcariaIdents.ID + ":" + pKey);
    }
    ...
    public static AdvancementHolder icariaChest(String pKey, Criterion<?> pTrigger, AdvancementHolder pParent, Consumer<AdvancementHolder> pConsumer, Supplier<Item> pItem, AdvancementType pFrame, boolean pToast, boolean pChat, boolean pHidden) {
        return Advancement.Builder.advancement().addCriterion(pKey, pTrigger).addCriterion("trapped_chest", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(IcariaBlocks.TRAPPED_CHEST.get())), ItemPredicate.Builder.item().of(IcariaItems.CHEST_LABEL.get()))).display(pItem.get(), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "title"), Component.translatable("advancement" + "." + IcariaIdents.ID + "." + pKey + "." + "description"), IcariaResourceLocations.BACKGROUND, pFrame, pToast, pChat, pHidden).parent(pParent).requirements(AdvancementRequirements.Strategy.OR).save(pConsumer, IcariaIdents.ID + ":" + pKey);
    }
