...
public class PottedGreenGroundShroomsModel {
	...
	public static ExtendedModelTemplate template() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(7.7500F, 10.0000F, 7.5000F).to(10.7500F, 11.0000F, 10.5000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 45.0000F, 0.0000F).origin(9.2500F, 8.7500F, 9.0000F))
			...
			.element(elementBuilder -> elementBuilder.from(8.7500F, 4.0000F, 8.5000F).to(9.7500F, 10.0000F, 9.5000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 45.0000F, 0.0000F).origin(9.2500F, 8.7500F, 9.0000F))
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 1.0000F, 6.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.EAST, faceBuilder -> faceBuilder.uvs(1.0000F, 0.0000F, 2.0000F, 6.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(2.0000F, 0.0000F, 3.0000F, 6.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.WEST, faceBuilder -> faceBuilder.uvs(3.0000F, 0.0000F, 4.0000F, 6.0000F).texture(IcariaTextureSlots.STEM)))
			.element(elementBuilder -> elementBuilder.from(6.5000F, 8.0000F, 5.2500F).to(9.5000F, 9.0000F, 8.2500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, -22.5000F, 0.0000F).origin(8.0000F, 7.2500F, 6.7500F))
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.EAST, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.WEST, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.UP, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 3.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.DOWN, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 3.0000F).texture(IcariaTextureSlots.SHROOM)))
			.element(elementBuilder -> elementBuilder.from(6.2500F, 4.0000F, 8.7500F).to(7.2500F, 6.0000F, 9.7500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 22.5000F, 0.0000F).origin(6.7500F, 5.7500F, 9.2500F))
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 1.0000F, 2.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.EAST, faceBuilder -> faceBuilder.uvs(1.0000F, 0.0000F, 2.0000F, 2.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(2.0000F, 0.0000F, 3.0000F, 2.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.WEST, faceBuilder -> faceBuilder.uvs(3.0000F, 0.0000F, 4.0000F, 2.0000F).texture(IcariaTextureSlots.STEM)))
			.element(elementBuilder -> elementBuilder.from(5.2500F, 6.0000F, 7.7500F).to(8.2500F, 7.0000F, 10.7500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 22.5000F, 0.0000F).origin(6.7500F, 5.7500F, 9.2500F))
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.EAST, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 1.0000F).texture(IcariaTextureSlots.SHROOM))
				...
				.face(Direction.UP, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 3.0000F).texture(IcariaTextureSlots.SHROOM))
				.face(Direction.DOWN, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 3.0000F, 3.0000F).texture(IcariaTextureSlots.SHROOM)))
			.element(elementBuilder -> elementBuilder.from(7.5000F, 4.0000F, 6.2500F).to(8.5000F, 8.0000F, 7.2500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, -22.5000F, 0.0000F).origin(8.0000F, 7.2500F, 6.7500F))
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(0.0000F, 0.0000F, 1.0000F, 4.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.EAST, faceBuilder -> faceBuilder.uvs(1.0000F, 0.0000F, 2.0000F, 4.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(2.0000F, 0.0000F, 3.0000F, 4.0000F).texture(IcariaTextureSlots.STEM))
				.face(Direction.WEST, faceBuilder -> faceBuilder.uvs(3.0000F, 0.0000F, 4.0000F, 4.0000F).texture(IcariaTextureSlots.STEM)))
			.build();
	}
}
