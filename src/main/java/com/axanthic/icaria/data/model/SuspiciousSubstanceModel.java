	...
	public static ExtendedModelTemplate template0() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(12.0000F, 0.0000F, 5.0000F).to(14.0000F, 2.0000F, 7.0000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 22.5000F, 0.0000F).origin(13.0000F, 1.0000F, 6.0000F))
			...
			.element(elementBuilder -> elementBuilder.from(11.0000F, 0.0000F, 5.0000F).to(12.0000F, 1.0000F, 6.0000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 0.0000F, 0.0000F).origin(11.5000F, 0.5000F, 5.5000F))
	...
	public static ExtendedModelTemplate template1() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(4.0000F, -0.2500F, 4.2500F).to(7.0000F, 0.2500F, 4.7500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(-45.0000F, 0.0000F, 0.0000F).origin(5.5000F, 0.0000F, 4.5000F))
	...
	public static ExtendedModelTemplate template2() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(8.0000F, -0.2500F, 3.7500F).to(11.5000F, 0.2500F, 4.2500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(-45.0000F, 0.0000F, 0.0000F).origin(9.7500F, 0.0000F, 4.0000F))
	...
	public static ExtendedModelTemplate template3() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(5.0000F, -0.2500F, 2.2500F).to(9.0000F, 0.2500F, 2.7500F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(-45.0000F, 0.0000F, 0.0000F).origin(7.0000F, 0.0000F, 2.5000F))
