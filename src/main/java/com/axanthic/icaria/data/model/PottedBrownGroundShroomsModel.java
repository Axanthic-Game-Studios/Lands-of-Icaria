...
public class PottedBrownGroundShroomsModel {
	...
	public static void template(BlockModelBuilder pBuilder, ModelFile.UncheckedModelFile pFile) {
		...
		.element().from(6.0F, 0.0F, 6.0F).to(10.0F, 4.0F, 10.0F).rotation().angle(0.0F).axis(Direction.Axis.Y).origin(0.0F, 0.0F, 0.0F).end()
			...
			.end()
		.element().from(7.75F, 9.0F, 6.5F).to(10.75F, 10.0F, 9.5F).rotation().angle(45.0F).axis(Direction.Axis.Y).origin(9.25F, 7.25F, 8.0F).end()
			...
			.end()
		.element().from(8.75F, 4.0F, 7.5F).to(9.75F, 9.0F, 8.5F).rotation().angle(45.0F).axis(Direction.Axis.Y).origin(9.25F, 7.25F, 8.0F).end()
			...
			.end()
		.element().from(5.5F, 7.0F, 5.25F).to(8.5F, 8.0F, 8.25F).rotation().angle(-22.5F).axis(Direction.Axis.Y).origin(7.0F, 6.5F, 6.75F).end()
			.face(Direction.NORTH).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			.face(Direction.EAST).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			.face(Direction.SOUTH).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			.face(Direction.WEST).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			...
			.face(Direction.DOWN).uvs(0.0F, 0.0F, 3.0F, 3.0F).texture("#shroom").end()
			.end()
		.element().from(6.25F, 4.0F, 8.75F).to(7.25F, 10.0F, 9.75F).rotation().angle(22.5F).axis(Direction.Axis.Y).origin(6.75F, 5.75F, 9.25F).end()
			...
			.end()
		.element().from(5.25F, 10.0F, 7.75F).to(8.25F, 11.0F, 10.75F).rotation().angle(22.5F).axis(Direction.Axis.Y).origin(6.75F, 5.75F, 9.25F).end()
			.face(Direction.NORTH).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			.face(Direction.EAST).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			.face(Direction.SOUTH).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			.face(Direction.WEST).uvs(0.0F, 0.0F, 3.0F, 1.0F).texture("#shroom").end()
			...
			.face(Direction.DOWN).uvs(0.0F, 0.0F, 3.0F, 3.0F).texture("#shroom").end()
			.end()
		.element().from(6.5F, 4.0F, 6.25F).to(7.5F, 7.0F, 7.25F).rotation().angle(-22.5F).axis(Direction.Axis.Y).origin(7.0F, 6.5F, 6.75F).end()
