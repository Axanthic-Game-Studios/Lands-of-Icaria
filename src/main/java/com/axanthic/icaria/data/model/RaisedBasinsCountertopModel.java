...
public class RaisedBasinsCountertopModel {
	...
	public static ExtendedModelTemplate template() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaIdents.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(6.8750F, 3.5000F, 5.0000F).to(7.1250F, 6.5000F, 11.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(22.5000F).axis(Direction.Axis.X).origin(7.0000F, 3.5000F, 11.0000F))
			...
			.element(elementBuilder -> elementBuilder.from(6.5000F, 5.7500F, 0.0000F).to(7.5000F, 6.7500F, 7.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(22.5000F).axis(Direction.Axis.X).origin(7.0000F, 3.5000F, 11.0000F))
