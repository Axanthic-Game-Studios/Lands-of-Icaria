	...
	public static ExtendedModelTemplate template() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(13.0000F, 11.0000F, 3.0000F).to(16.0000F, 12.0000F, 13.0000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 0.0000F, 0.0000F).origin(-1.0000F, 0.0000F, 1.0000F))
			...
			.element(elementBuilder -> elementBuilder.from(0.0000F, 11.0000F, 13.0000F).to(16.0000F, 12.0000F, 16.0000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 0.0000F, 0.0000F).origin(-0.5000F, -1.0000F, -0.5000F))
			...
			.element(elementBuilder -> elementBuilder.from(0.0000F, 11.0000F, 3.0000F).to(3.0000F, 12.0000F, 13.0000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 0.0000F, 0.0000F).origin(0.0000F, 0.0000F, 1.0000F))
