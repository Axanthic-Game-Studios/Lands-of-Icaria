	...
	public static ExtendedModelTemplate template() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaIdents.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(1.5F, 0.0F, 7.0F).to(7.5F, 2.0F, 9.0F)
				...
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(0.0F, 5.0F, 1.0F, 8.0F).rotation(Quadrant.R90).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				.face(Direction.EAST, faceBuilder -> faceBuilder.uvs(4.0F, 5.0F, 5.0F, 6.0F).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(2.0F, 5.0F, 3.0F, 8.0F).rotation(Quadrant.R270).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				.face(Direction.WEST, faceBuilder -> faceBuilder.uvs(4.0F, 5.0F, 5.0F, 6.0F).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				.face(Direction.UP, faceBuilder -> faceBuilder.uvs(1.0F, 5.0F, 2.0F, 8.0F).rotation(Quadrant.R270).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				.face(Direction.DOWN, faceBuilder -> faceBuilder.uvs(3.0F, 5.0F, 4.0F, 8.0F).rotation(Quadrant.R270).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15)))
			...
			.element(elementBuilder -> elementBuilder.from(6.0F, 0.0F, 6.0F).to(12.0F, 2.0F, 8.0F)
				.rotation(rotationBuilder -> rotationBuilder.angle(22.5F).axis(Direction.Axis.Z).origin(8.0F, 8.0F, 8.0F))
				.face(Direction.NORTH, faceBuilder -> faceBuilder.uvs(10.0F, 12.0F, 11.0F, 16.0F).rotation(Quadrant.R270).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				...
				.face(Direction.SOUTH, faceBuilder -> faceBuilder.uvs(11.0F, 12.0F, 12.0F, 16.0F).rotation(Quadrant.R90).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				...
				.face(Direction.UP, faceBuilder -> faceBuilder.uvs(12.0F, 12.0F, 13.0F, 16.0F).rotation(Quadrant.R90).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15))
				.face(Direction.DOWN, faceBuilder -> faceBuilder.uvs(13.0F, 12.0F, 14.0F, 16.0F).rotation(Quadrant.R90).texture(IcariaTextureSlots.TEXTURE).emissivity(15, 15)))
			.build();
	}
}
