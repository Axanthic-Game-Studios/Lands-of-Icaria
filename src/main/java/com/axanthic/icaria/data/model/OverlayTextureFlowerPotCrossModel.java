...
public class OverlayTextureFlowerPotCrossModel {
	...
	public static ExtendedModelTemplate template() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaKeys.MC, "block"))
			...
			.element(elementBuilder -> elementBuilder.from(2.6000F, 4.0000F, 8.0000F).to(13.4000F, 16.0000F, 8.0000F)
			...
			.element(elementBuilder -> elementBuilder.from(8.0000F, 4.0000F, 2.6000F).to(8.0000F, 16.0000F, 13.4000F)
				.rotation(rotationBuilder -> rotationBuilder.eulerXYZ(0.0000F, 45.0000F, 0.0000F).origin(8.0000F, 8.0000F, 8.0000F).rescale(true))
