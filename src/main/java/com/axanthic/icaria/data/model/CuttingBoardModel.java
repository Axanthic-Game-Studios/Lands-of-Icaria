	...
	public static ExtendedModelTemplate template() {
		return ExtendedModelTemplateBuilder.builder().parent(IcariaModelProvider.blockFile(IcariaIdents.MC, "block"))
			.element(elementBuilder -> elementBuilder.from(7.1250F, 2.7500F, -3.0000F).to(8.1250F, 3.7500F, 4.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(22.5000F).axis(Direction.Axis.X).origin(7.6250F, 0.5000F, 8.0000F))
			...
			.element(elementBuilder -> elementBuilder.from(4.0000F, 0.5000F, 5.0000F).to(7.0000F, 1.5000F, 6.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(45.0000F).axis(Direction.Axis.X).origin(5.5000F, 1.0000F, 5.5000F))
			...
			.element(elementBuilder -> elementBuilder.from(8.5000F, 0.5000F, 5.0000F).to(9.0000F, 1.5000F, 6.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(45.0000F).axis(Direction.Axis.X).origin(8.7500F, 1.0000F, 5.5000F))
			...
			.element(elementBuilder -> elementBuilder.from(9.5000F, 0.5000F, 5.0000F).to(10.0000F, 1.5000F, 6.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(45.0000F).axis(Direction.Axis.X).origin(9.7500F, 1.0000F, 5.5000F))
			...
			.element(elementBuilder -> elementBuilder.from(10.5000F, 0.5000F, 5.0000F).to(11.0000F, 1.5000F, 6.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(45.0000F).axis(Direction.Axis.X).origin(10.7500F, 1.0000F, 5.5000F))
			...
			.element(elementBuilder -> elementBuilder.from(11.5000F, 0.5000F, 5.0000F).to(12.0000F, 1.5000F, 6.0000F)
				.rotation(rotationBuilder -> rotationBuilder.angle(45.0000F).axis(Direction.Axis.X).origin(11.7500F, 1.0000F, 5.5000F))
