...
public class IcariaProcessorLists {
	...
	public static StructureProcessorList ruin() {
		return new StructureProcessorList(ImmutableList.of(
			...
			IcariaProcessorLists.stairs(IcariaBlocks.RELICSTONE_TILE_STAIRS.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_TILE_STAIRS.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_TILE_STAIRS.get()),
			IcariaProcessorLists.slab(IcariaBlocks.RELICSTONE_TILE_SLAB.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_TILE_SLAB.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_TILE_SLAB.get()),
	...
	public static StructureProcessorList temple() {
		return new StructureProcessorList(ImmutableList.of(
			...
			IcariaProcessorLists.stairs(IcariaBlocks.RELICSTONE_BRICK_STAIRS.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_BRICK_STAIRS.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_BRICK_STAIRS.get()),
			IcariaProcessorLists.slab(IcariaBlocks.RELICSTONE_BRICK_SLAB.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_BRICK_SLAB.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_BRICK_SLAB.get()),
			IcariaProcessorLists.block(IcariaBlocks.RELICSTONE_TILES.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_TILES.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_TILES.get()),
			IcariaProcessorLists.stairs(IcariaBlocks.RELICSTONE_TILE_STAIRS.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_TILE_STAIRS.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_TILE_STAIRS.get()),
			IcariaProcessorLists.slab(IcariaBlocks.RELICSTONE_TILE_SLAB.get(), 0.25F, IcariaBlocks.CRACKED_RELICSTONE_TILE_SLAB.get(), 0.25F, IcariaBlocks.MOSSY_RELICSTONE_TILE_SLAB.get()),
	...
	public static StructureProcessorList erodedForestVillage(Block pAdobeBlock, Block pAdobeStairs, Block pAdobeSlab) {
		return IcariaProcessorLists.erodedVillage(pAdobeBlock, pAdobeStairs, pAdobeSlab,
			...
			IcariaBlocks.POPULUS_STAIRS.get(),
			IcariaBlocks.POPULUS_SLAB.get(),
			...
			IcariaBlocks.FIR_SLAB.get(),
			IcariaBlocks.FIR_FENCE.get(),
	...
	public static StructureProcessorList erodedScrublandVillage(Block pAdobeBlock, Block pAdobeStairs, Block pAdobeSlab) {
		return IcariaProcessorLists.erodedVillage(pAdobeBlock, pAdobeStairs, pAdobeSlab,
			...
			IcariaBlocks.LAUREL_STAIRS.get(),
			IcariaBlocks.LAUREL_SLAB.get(),
			...
			IcariaBlocks.PLANE_SLAB.get(),
			IcariaBlocks.PLANE_FENCE.get(),
	...
	public static StructureProcessorList erodedSteppeVillage(Block pAdobeBlock, Block pAdobeStairs, Block pAdobeSlab) {
		return IcariaProcessorLists.erodedVillage(pAdobeBlock, pAdobeStairs, pAdobeSlab,
			...
			IcariaBlocks.CYPRESS_STAIRS.get(),
			IcariaBlocks.CYPRESS_SLAB.get(),
			...
			IcariaBlocks.OLIVE_SLAB.get(),
			IcariaBlocks.OLIVE_FENCE.get(),
	...
	public static StructureProcessorList erodedDesertVillage(Block pAdobeBlock, Block pAdobeStairs, Block pAdobeSlab) {
		return IcariaProcessorLists.erodedVillage(pAdobeBlock, pAdobeStairs, pAdobeSlab,
			...
			IcariaBlocks.DROUGHTROOT_SLAB.get(),
			IcariaBlocks.DROUGHTROOT_FENCE.get(),
	...
	public static StructureProcessorList erodedVillage(Block pAdobeBlock, Block pAdobeStairs, Block pAdobeSlab, Block pStrippedLog, Block pLaurelStairs, Block pLaurelSlab, Block pSimpleRack, Block pRack, Block pBarrel, Block pLoadedBarrel, Block pTappedBarrel, Block pTripleBarrel, Block pWallSign, Block pPlanePlanks, Block pPlaneSlab, Block pPlaneFence, Block pCraftingTable, Block pDoor, Block pTrapdoor, Block pLadder) {
		return new StructureProcessorList(ImmutableList.of(
			...
			IcariaProcessorLists.stairs(IcariaBlocks.YELLOWSTONE_ADOBE_STAIRS.get(), pAdobeStairs),
			IcariaProcessorLists.slab(IcariaBlocks.YELLOWSTONE_ADOBE_SLAB.get(), pAdobeSlab),
			...
			IcariaProcessorLists.stairs(IcariaBlocks.LAUREL_STAIRS.get(), pLaurelStairs),
			IcariaProcessorLists.slab(IcariaBlocks.LAUREL_SLAB.get(), pLaurelSlab),
			...
			IcariaProcessorLists.slab(IcariaBlocks.PLANE_SLAB.get(), pPlaneSlab),
			IcariaProcessorLists.fence(IcariaBlocks.PLANE_FENCE.get(), pPlaneFence),
	...
	public static StructureProcessorList ruinedVillage(Block pAdobeBlock) {
		return new StructureProcessorList(ImmutableList.of(
			...
			IcariaProcessorLists.block(IcariaBlocks.LAUREL_STAIRS.get(), Blocks.AIR),
			IcariaProcessorLists.block(IcariaBlocks.LAUREL_SLAB.get(), Blocks.AIR),
			...
			IcariaProcessorLists.block(IcariaBlocks.PLANE_SLAB.get(), Blocks.AIR),
			IcariaProcessorLists.block(IcariaBlocks.PLANE_FENCE.get(), Blocks.AIR),
	...
	public static RuleProcessor barrel(Block pOld, Block pNew) {
		return new RuleProcessor(ImmutableList.of(
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).setValue(IcariaBlockStateProperties.STANDING_BARREL, false)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)),
			new ProcessorRule(new BlockStateMatchTest(pOld.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).setValue(IcariaBlockStateProperties.STANDING_BARREL, true)), AlwaysTrueTest.INSTANCE, pNew.defaultBlockState().setValue(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST).setValue(IcariaBlockStateProperties.STANDING_BARREL, true))
		));
	}
