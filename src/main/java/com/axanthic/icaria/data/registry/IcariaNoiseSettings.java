...
public class IcariaNoiseSettings {
	...
	public static void bootstrap(BootstrapContext<NoiseGeneratorSettings> pBootstrapContext) {
		pBootstrapContext.register(IcariaNoiseSettings.ICARIA, new NoiseGeneratorSettings(new NoiseSettings(0, 96, 1, 1), Blocks.STONE.defaultBlockState(), Blocks.AIR.defaultBlockState(), IcariaNoiseSettings.noiseRouter(pBootstrapContext), IcariaNoiseSettings.ruleSource(), List.of(new Climate.ParameterPoint(Climate.Parameter.span(-1.0F, 1.0F), IcariaNoiseSettings.NIL, IcariaNoiseSettings.ONE, IcariaNoiseSettings.NIL, IcariaNoiseSettings.ONE, IcariaNoiseSettings.NIL, 0L)), -1, false, false, false, false));
	}
	...
	public static SurfaceRules.RuleSource ruleSource() {
		...
		var ruleSourceF = SurfaceRules.ifTrue(SurfaceRules.yBlockCheck(VerticalAnchor.absolute(0), 0), SurfaceRules.ifTrue(SurfaceRules.isBiome(IcariaBiomes.VOID), SurfaceRules.state(Blocks.AIR.defaultBlockState())));
