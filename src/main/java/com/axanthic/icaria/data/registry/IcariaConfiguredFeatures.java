...
public class IcariaConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> pBootstrapContext) {
		...
		pBootstrapContext.register(IcariaConfiguredFeatures.BLUE_GROUND_FLOWERS, new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(64, 8, 8, PlacementUtils.filtered(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(IcariaBlocks.BLUE_GROUND_FLOWERS.get())), BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), IcariaBlocks.GRASSY_MARL.get()), BlockPredicate.matchesBlocks(Blocks.AIR))))));
		pBootstrapContext.register(IcariaConfiguredFeatures.CYAN_GROUND_FLOWERS, new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(64, 8, 8, PlacementUtils.filtered(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(IcariaBlocks.CYAN_GROUND_FLOWERS.get())), BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), IcariaBlocks.GRASSY_MARL.get()), BlockPredicate.matchesBlocks(Blocks.AIR))))));
		pBootstrapContext.register(IcariaConfiguredFeatures.PINK_GROUND_FLOWERS, new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(64, 8, 8, PlacementUtils.filtered(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(IcariaBlocks.PINK_GROUND_FLOWERS.get())), BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), IcariaBlocks.GRASSY_MARL.get()), BlockPredicate.matchesBlocks(Blocks.AIR))))));
		pBootstrapContext.register(IcariaConfiguredFeatures.PURPLE_GROUND_FLOWERS, new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(64, 8, 8, PlacementUtils.filtered(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(IcariaBlocks.PURPLE_GROUND_FLOWERS.get())), BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), IcariaBlocks.GRASSY_MARL.get()), BlockPredicate.matchesBlocks(Blocks.AIR))))));
		pBootstrapContext.register(IcariaConfiguredFeatures.RED_GROUND_FLOWERS, new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(64, 8, 8, PlacementUtils.filtered(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(IcariaBlocks.RED_GROUND_FLOWERS.get())), BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), IcariaBlocks.GRASSY_MARL.get()), BlockPredicate.matchesBlocks(Blocks.AIR))))));
		pBootstrapContext.register(IcariaConfiguredFeatures.WHITE_GROUND_FLOWERS, new ConfiguredFeature<>(Feature.RANDOM_PATCH, new RandomPatchConfiguration(64, 8, 8, PlacementUtils.filtered(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(IcariaBlocks.WHITE_GROUND_FLOWERS.get())), BlockPredicate.allOf(BlockPredicate.matchesBlocks(Direction.DOWN.getUnitVec3i(), IcariaBlocks.GRASSY_MARL.get()), BlockPredicate.matchesBlocks(Blocks.AIR))))));
