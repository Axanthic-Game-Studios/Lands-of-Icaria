...
public class BlockCustomWall extends BlockWall implements IBlockMaterial {

	public String name;
	public Block modelBlock;
	public IBlockState modelState;

	public BlockCustomWall(IBlockState modelState, String name) {
		...
		if (modelBlock instanceof IBlockMaterial)
			this.setRegistryName(ModInformation.ID, "wall_" + modelState.getBlock().getRegistryName().getResourcePath() + "_" + ((IBlockMaterial) modelBlock).getName());
		else if (modelBlock instanceof IBlockMeta)
			this.setRegistryName(ModInformation.ID, "wall_" + modelState.getBlock().getRegistryName().getResourcePath() + "_" + ((IBlockMeta) modelBlock).getNameForMeta(modelBlock.getMetaFromState(modelState)));
		else
			this.setRegistryName(ModInformation.ID, "wall_" + modelState.getBlock().getRegistryName().getResourcePath());
	}
