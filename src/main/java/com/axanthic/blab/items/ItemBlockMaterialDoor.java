...
public class ItemBlockMaterialDoor extends ItemBlockMaterial {

	public final BlockCustomDoor block;

	public ItemBlockMaterialDoor(IBlockMaterial block) {
		super(block);
		this.block = (BlockCustomDoor) block;
	}
