...
public class ItemResource extends ItemMeta {
	...
	public ItemResource() {
		super("resource", new String[]{"lignite", "dolomite", "anthracite", "abyssal_essence", "silkstone_powder", "calcite", "jasper", "zircon", "calcite_powder",  "polished_zircon", "loam_lump", "raw_vase"});
	}
