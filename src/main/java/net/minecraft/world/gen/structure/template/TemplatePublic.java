...
//copy of Template with a bunch of stuff made public
public class TemplatePublic extends Template
{
	 ...
	 * takes blocks from the world and puts the data them into this template
	 */
	public void takeEntitiesFromWorld(World worldIn, BlockPos startPos, BlockPos endPos)
	{
	...
	{
		TemplatePublic.BasicPalette template$basicpalette = new TemplatePublic.BasicPalette();
		NBTTagList nbttaglist = new NBTTagList();
	...
	public NBTTagList writeInts(int... values)
	{
		NBTTagList nbttaglist = new NBTTagList();
	...
	public NBTTagList writeDoubles(double... values)
	{
		NBTTagList nbttaglist = new NBTTagList();
	...
	public static class BasicPalette implements Iterable<IBlockState>
	{
		...
		public final ObjectIntIdentityMap<IBlockState> ids;
		public int lastId;
