...
public class custom_model extends ModelBase {
	...
	public custom_model() {
		...
		BODY1.cubeList.add(new ModelBox(BODY1, 42, 5, -1.5F, -1.7F, -1.0F, 3, 4, 1, 0.0F, false));
		...
		HEAD.cubeList.add(new ModelBox(HEAD, 42, 21, -3.0F, -1.0F, -2.0F, 6, 3, 2, 0.0F, false));
		HEAD.cubeList.add(new ModelBox(HEAD, 42, 15, -2.99F, 0.0F, -6.0F, 6, 2, 4, 0.0F, false));
		HEAD.cubeList.add(new ModelBox(HEAD, 40, 26, -3.5F, -0.5F, -4.0F, 7, 1, 2, 0.0F, false));

		HEAD4TEETH1 = new ModelRenderer(this);
		HEAD4TEETH1.setRotationPoint(3.0F, 1.3F, -6.0F);
		HEAD.addChild(HEAD4TEETH1);
		setRotationAngle(HEAD4TEETH1, 0.0F, 0.1309F, 0.0F);
		HEAD4TEETH1.cubeList.add(new ModelBox(HEAD4TEETH1, 23, 37, -0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F, false));

		HEAD5TEETH2 = new ModelRenderer(this);
		HEAD5TEETH2.setRotationPoint(-3.0F, 1.3F, -6.0F);
		HEAD.addChild(HEAD5TEETH2);
		setRotationAngle(HEAD5TEETH2, 0.0F, -0.1309F, 0.0F);
		HEAD5TEETH2.cubeList.add(new ModelBox(HEAD5TEETH2, 36, 27, -0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F, false));
		...
		HEAD2ANTHENNA2.cubeList.add(new ModelBox(HEAD2ANTHENNA2, 19, 37, -0.5F, -4.5F, -1.5F, 1, 5, 1, 0.0F, false));
		HEAD2ANTHENNA2.cubeList.add(new ModelBox(HEAD2ANTHENNA2, 26, 17, -0.5F, -4.5F, -5.5F, 1, 1, 4, 0.0F, false));
		...
		HEAD6ANTHENNA1.cubeList.add(new ModelBox(HEAD6ANTHENNA1, 15, 37, -0.5F, -4.5F, -1.5F, 1, 5, 1, 0.0F, false));
		HEAD6ANTHENNA1.cubeList.add(new ModelBox(HEAD6ANTHENNA1, 8, 26, -0.5F, -4.5F, -5.5F, 1, 1, 4, 0.0F, false));

		head3 = new ModelRenderer(this);
		head3.setRotationPoint(0.0F, 0.3033F, -3.6881F);
		HEAD.addChild(head3);
		setRotationAngle(head3, -1.3526F, 0.0F, 0.0F);
		head3.cubeList.add(new ModelBox(head3, 44, 10, -3.01F, -1.9201F, -0.897F, 6, 4, 1, 0.01F, false));
		head3.cubeList.add(new ModelBox(head3, 50, 5, -1.0F, -1.9093F, -1.3681F, 2, 2, 1, 0.01F, false));

		BODY2 = new ModelRenderer(this);
		BODY2.setRotationPoint(0.0F, 19.3571F, -2.0F);
		BODY2.cubeList.add(new ModelBox(BODY2, 37, 36, -2.0F, -2.3571F, -2.0F, 4, 5, 4, 0.0F, false));
		...
		BODY2S4.cubeList.add(new ModelBox(BODY2S4, 57, 0, -2.9517F, -2.5942F, -5.2266F, 1, 4, 1, 0.0F, false));
		...
		BODY2S6.cubeList.add(new ModelBox(BODY2S6, 41, 0, -6.6527F, -2.5942F, -0.8316F, 2, 4, 1, 0.0F, false));
		...
		BODY2S7.cubeList.add(new ModelBox(BODY2S7, 47, 0, 0.9597F, -2.5942F, 6.2627F, 2, 4, 1, 0.0F, false));
		...
		BODY2S8.cubeList.add(new ModelBox(BODY2S8, 53, 0, -1.7414F, -2.5942F, 1.8677F, 1, 4, 1, 0.0F, false));

		BODY3 = new ModelRenderer(this);
		BODY3.setRotationPoint(0.0F, 19.5F, 0.0F);
		BODY3.cubeList.add(new ModelBox(BODY3, 40, 29, -1.5F, -2.0F, 0.0F, 3, 4, 3, 0.0F, false));
		...
		BODY3S2.cubeList.add(new ModelBox(BODY3S2, 21, 23, -1.499F, -5.8955F, -6.9095F, 3, 1, 3, 0.0F, false));
		...
		TAIL2.cubeList.add(new ModelBox(TAIL2, 0, 43, -3.0F, -1.6142F, -0.4F, 6, 4, 9, 0.0F, false));
		TAIL2.cubeList.add(new ModelBox(TAIL2, 30, 46, -3.001F, 2.0929F, 0.5929F, 6, 1, 8, 0.0F, false));

		TAIL4 = new ModelRenderer(this);
		TAIL4.setRotationPoint(0.0F, 2.3F, 1.8F);
		TAIL2.addChild(TAIL4);
		setRotationAngle(TAIL4, -0.7854F, 0.0F, 0.0F);
		TAIL4.cubeList.add(new ModelBox(TAIL4, 23, 41, -3.002F, 0.4142F, -1.2929F, 6, 1, 1, 0.0F, false));

		TAIL3 = new ModelRenderer(this);
		TAIL3.setRotationPoint(0.0F, 1.3F, 4.8F);
		TAIL2.addChild(TAIL3);
		setRotationAngle(TAIL3, -0.48F, 0.0F, 0.0F);
		TAIL3.cubeList.add(new ModelBox(TAIL3, 21, 47, -2.997F, -4.3F, 2.1922F, 6, 3, 2, 0.0F, false));

		TAIL5 = new ModelRenderer(this);
		TAIL5.setRotationPoint(-0.02F, 1.4921F, 3.8831F);
		TAIL2.addChild(TAIL5);
		setRotationAngle(TAIL5, -0.3491F, 0.0F, 0.0F);
		TAIL5.cubeList.add(new ModelBox(TAIL5, 21, 43, -2.978F, -2.0698F, 3.0742F, 6, 2, 2, 0.0F, false));
